...
defun15 <- read_csv("data/data_sim/defun15.csv")

# base de datos de CONAPO http://www.conapo.gob.mx/es/CONAPO/Proyecciones_Datos
baseprymunMX <- read_csv("data/data_sim/baseprymunMX.csv")
...
decatcausa <- read_csv("data/data_sim/decatcausa.csv")
deedad <- read_csv("data/data_sim/deedad.csv")
...
write_csv(tasas_diabetes$defun_entidad, "data/data_sim/tasas_diabetes.csv")
```
...
tasas_diabetes <- read.csv("data/data_sim/tasas_diabetes.csv")
set.seed(74872)
nulos <- lineup(null_permute("tasa_causa"), tasas_diabetes, n = 6)
edo_shp <- st_read("data/data_sim/shapes/Mex_Edos.shp", stringsAsFactors = FALSE, 
    quiet = TRUE)
nulos_map <- edo_shp %>% 
...
```{r, fig.height=3, fig.width=3.3, out.width="350px",warning=FALSE, message=FALSE}
