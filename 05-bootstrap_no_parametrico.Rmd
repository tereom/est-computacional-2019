...
```{r, message=FALSE, fig.width=8.5, fig.height=4}
library(gridExtra)
...
Usaremos un ejempo de @efron con datos de una prueba espacial, la muestra es
chica, se tienen mediciones de $n=26$ niños con discapacidad neurológica, cada
uno tomó dos pruebas de percepción espacial, en este ejemplo nos interesa 
construir un intervalo de $90%$ de confianza para $\theta=var(A)$
...
```{r, out.width = "400px",echo = FALSE, fig.cap= "Extracto de estimación de errores de muestreo, ENIGH 2018."}
knitr::include_graphics("img/inegi_metodologia_razon.png")
```
