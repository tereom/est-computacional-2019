...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "21", "12", "12", "11", "30", "24", "09", "07", "09",…
#> $ NOM_ENT    <chr> "PUEBLA", "GUERRERO", "GUERRERO", "GUANAJUATO", "VERA…
#> $ CCT        <chr> "21DPR3419Y", "12DPR1073A", "12EPR0379K", "11DPR2802G…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "LEONA VICARIO", "HERMENEGILDO GALEANA", "MIGUEL HIDA…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL"…
#> $ CVE_MUN    <chr> "197", "021", "018", "030", "091", "053", "014", "059…
#> $ NOM_MUN    <chr> "XICOTEPEC", "COYUCA DE BENITEZ", "COPALA", "SAN FELI…
#> $ CVE_LOC    <chr> "0016", "0029", "0001", "0408", "0046", "0044", "0024…
#> $ NOM_LOC    <chr> "RANCHO NUEVO", "LA FELICIDAD", "COPALA", "LAS PALOMA…
#> $ PUNT_ESP_3 <dbl> 500, 682, 531, 455, 488, 472, 700, 407, 596, 507, 562…
#> $ PUNT_MAT_3 <dbl> 596, 798, 624, 449, 420, 468, 782, 389, 673, 519, 625…
#> $ PUNT_FCE_3 <dbl> 497, 626, 514, 403, 418, 431, 643, 388, 565, 508, 523…
#> $ PUNT_ESP_4 <dbl> 455, 757, 548, 470, 444, 474, 663, 377, 660, 628, 495…
#> $ PUNT_MAT_4 <dbl> 539, 839, 626, 463, 494, 498, 699, 390, 638, 683, 534…
#> $ PUNT_FCE_4 <dbl> 430, 675, 516, 510, 415, 414, 565, 391, 604, 602, 430…
#> $ PUNT_ESP_5 <dbl> 488, 617, 669, 442, 525, 461, NA, 364, 596, 609, 559,…
#> $ PUNT_MAT_5 <dbl> 543, 545, 675, 440, 525, 471, NA, 380, 632, 646, 617,…
#> $ PUNT_FCE_5 <dbl> 475, 514, 568, 374, 481, 473, NA, 364, 580, 546, 536,…
#> $ PUNT_ESP_6 <dbl> 469, 690, 690, 449, 588, 435, 410, 376, NA, 439, 569,…
#> $ PUNT_MAT_6 <dbl> 580, 673, 736, 505, 659, 374, 535, 431, NA, 485, 595,…
#> $ PUNT_FCE_6 <dbl> 484, 427, 604, 468, 498, 417, 401, 392, NA, 429, 552,…
```
...
#>  1 21      PUEBLA  21DP… MATU… LEONA … GENE… 197     XICOTE… 0016   
#>  2 21      PUEBLA  21DP… MATU… LEONA … GENE… 197     XICOTE… 0016   
#>  3 21      PUEBLA  21DP… MATU… LEONA … GENE… 197     XICOTE… 0016   
#>  4 21      PUEBLA  21DP… MATU… LEONA … GENE… 197     XICOTE… 0016   
#>  5 21      PUEBLA  21DP… MATU… LEONA … GENE… 197     XICOTE… 0016   
#>  6 21      PUEBLA  21DP… MATU… LEONA … GENE… 197     XICOTE… 0016   
#>  7 21      PUEBLA  21DP… MATU… LEONA … GENE… 197     XICOTE… 0016   
#>  8 21      PUEBLA  21DP… MATU… LEONA … GENE… 197     XICOTE… 0016   
#>  9 21      PUEBLA  21DP… MATU… LEONA … GENE… 197     XICOTE… 0016   
#> 10 21      PUEBLA  21DP… MATU… LEONA … GENE… 197     XICOTE… 0016   
...
#> $ CCT     <chr> "21DPR3419Y", "21DPR3419Y", "21DPR3419Y", "21DPR3419Y", …
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA <chr> "LEONA VICARIO", "LEONA VICARIO", "LEONA VICARIO", "LEON…
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "…
#> $ CVE_MUN <chr> "197", "197", "197", "197", "197", "197", "197", "197", …
#> $ NOM_MUN <chr> "XICOTEPEC", "XICOTEPEC", "XICOTEPEC", "XICOTEPEC", "XIC…
#> $ CVE_LOC <chr> "0016", "0016", "0016", "0016", "0016", "0016", "0016", …
#> $ NOM_LOC <chr> "RANCHO NUEVO", "RANCHO NUEVO", "RANCHO NUEVO", "RANCHO …
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", …
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5,…
#> $ PUNTAJE <dbl> 500, 596, 497, 455, 539, 430, 488, 543, 475, 469, 580, 4…
```
...
#> $ CCT        <chr> "21DPR3419Y", "21DPR3419Y", "21DPR3419Y", "21DPR3419Y…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "LEONA VICARIO", "LEONA VICARIO", "LEONA VICARIO", "L…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL"…
#> $ CVE_MUN    <chr> "197", "197", "197", "197", "197", "197", "197", "197…
#> $ NOM_MUN    <chr> "XICOTEPEC", "XICOTEPEC", "XICOTEPEC", "XICOTEPEC", "…
#> $ CVE_LOC    <chr> "0016", "0016", "0016", "0016", "0016", "0016", "0016…
#> $ NOM_LOC    <chr> "RANCHO NUEVO", "RANCHO NUEVO", "RANCHO NUEVO", "RANC…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4",…
#> $ PUNTAJE    <dbl> 500, 596, 497, 455, 539, 430, 488, 543, 475, 469, 580…
```
