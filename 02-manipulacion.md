...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "15", "10", "21", "15", "32", "07", "30", "11", "21",…
#> $ NOM_ENT    <chr> "MEXICO", "DURANGO", "PUEBLA", "MEXICO", "ZACATECAS",…
#> $ CCT        <chr> "15DPR1982X", "10KPR0897H", "21DPR1312S", "15EPR5026N…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "VESPERTINO", "MA…
#> $ ESCUELA    <chr> "LAZARO CARDENAS", "SAN JERONIMO", "LEANDRO VALLE", "…
#> $ TIPO       <chr> "GENERAL", "CONAFE", "GENERAL", "GENERAL", "GENERAL",…
#> $ CVE_MUN    <chr> "005", "034", "032", "035", "054", "057", "157", "020…
#> $ NOM_MUN    <chr> "ALMOLOYA DE JUAREZ", "TAMAZULA", "COHETZALA", "HUEHU…
#> $ CVE_LOC    <chr> "0029", "0411", "0003", "0001", "0029", "0094", "0026…
#> $ NOM_LOC    <chr> "SAN ANTONIO BUENAVISTA", "SAN JERONIMO", "EL PLATANA…
#> $ PUNT_ESP_3 <dbl> 620, 538, 511, 561, 517, 696, 505, 588, 527, 521, 586…
#> $ PUNT_MAT_3 <dbl> 596, 627, 658, 566, 559, 751, 518, 645, 639, 524, 622…
#> $ PUNT_FCE_3 <dbl> 550, 506, 422, 504, 417, 616, 445, 542, 508, 473, 536…
#> $ PUNT_ESP_4 <dbl> 726, NA, 399, 506, 668, 720, 489, 619, 438, 441, 614,…
#> $ PUNT_MAT_4 <dbl> 768, NA, 402, 525, 797, 778, 547, 637, 542, 478, 615,…
#> $ PUNT_FCE_4 <dbl> 677, NA, 365, 459, 641, 669, 470, 546, 414, 433, 540,…
#> $ PUNT_ESP_5 <dbl> 698, 555, 463, 523, 503, 737, 546, 610, 485, 453, 600…
#> $ PUNT_MAT_5 <dbl> 700, 639, 665, 537, 582, 735, 601, 635, 502, 458, 638…
#> $ PUNT_FCE_5 <dbl> 638, 549, 423, 478, 434, 561, 429, 571, 450, 418, 539…
#> $ PUNT_ESP_6 <dbl> 656, 370, 454, 491, 653, 584, 469, 614, 440, 438, 627…
#> $ PUNT_MAT_6 <dbl> 718, 659, 649, 500, 731, 615, 624, 611, 546, 457, 648…
#> $ PUNT_FCE_6 <dbl> 615, 450, 422, 474, 590, 506, 463, 566, 522, 423, 556…
```
...
enlacep_tidy
#> # A tibble: 11,317 x 13
#>    CVE_ENT NOM_ENT CCT   TURNO ESCUELA TIPO  CVE_MUN NOM_MUN CVE_LOC
#>    <chr>   <chr>   <chr> <chr> <chr>   <chr> <chr>   <chr>   <chr>  
#>  1 15      MEXICO  15DP… MATU… LAZARO… GENE… 005     ALMOLO… 0029   
#>  2 10      DURANGO 10KP… MATU… SAN JE… CONA… 034     TAMAZU… 0411   
#>  3 21      PUEBLA  21DP… MATU… LEANDR… GENE… 032     COHETZ… 0003   
#>  4 15      MEXICO  15EP… VESP… AGUSTI… GENE… 035     HUEHUE… 0001   
#>  5 32      ZACATE… 32DP… MATU… RAMON … GENE… 054     VILLA … 0029   
#>  6 07      CHIAPAS 07DP… MATU… JOSE M… GENE… 057     MOTOZI… 0094   
#>  7 30      VERACR… 30DP… MATU… MELCHO… GENE… 157     CASTIL… 0026   
#>  8 11      GUANAJ… 11PP… MATU… "LA SA… PART… 020     LEON    0001   
#>  9 21      PUEBLA  21DP… MATU… "MARTI… GENE… 075     HUEYAP… 0009   
#> 10 31      YUCATAN 31DP… MATU… FELIPE… GENE… 090     TIMUCUY 0003   
#> # … with 11,307 more rows, and 4 more variables: NOM_LOC <chr>,
...
#> Observations: 11,317
#> Variables: 13
#> $ cve_ent <chr> "15", "10", "21", "15", "32", "07", "30", "11", "21", "3…
#> $ nom_ent <chr> "MEXICO", "DURANGO", "PUEBLA", "MEXICO", "ZACATECAS", "C…
#> $ cct     <chr> "15DPR1982X", "10KPR0897H", "21DPR1312S", "15EPR5026N", …
#> $ turno   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "VESPERTINO", "MATUT…
#> $ escuela <chr> "LAZARO CARDENAS", "SAN JERONIMO", "LEANDRO VALLE", "AGU…
#> $ tipo    <chr> "GENERAL", "CONAFE", "GENERAL", "GENERAL", "GENERAL", "G…
#> $ cve_mun <chr> "005", "034", "032", "035", "054", "057", "157", "020", …
#> $ nom_mun <chr> "ALMOLOYA DE JUAREZ", "TAMAZULA", "COHETZALA", "HUEHUETO…
#> $ cve_loc <chr> "0029", "0411", "0003", "0001", "0029", "0094", "0026", …
#> $ nom_loc <chr> "SAN ANTONIO BUENAVISTA", "SAN JERONIMO", "EL PLATANAR (…
#> $ area    <chr> "ESP", "ESP", "ESP", "ESP", "ESP", "ESP", "ESP", "ESP", …
#> $ grado   <dbl> 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3,…
#> $ puntaje <dbl> 620, 538, 511, 561, 517, 696, 505, 588, 527, 521, 586, 5…
```
