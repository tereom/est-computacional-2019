...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "01", "31", "29", "11", "11", "14", "14", "30", "07",…
#> $ NOM_ENT    <chr> "AGUASCALIENTES", "YUCATAN", "TLAXCALA", "GUANAJUATO"…
#> $ CCT        <chr> "01DPR0560F", "31DPR0555O", "29EPR0178N", "11PPR0298G…
#> $ TURNO      <chr> "VESPERTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MA…
#> $ ESCUELA    <chr> "MAURICIO MAGDALENO", "FELIPE CARRILLO PUERTO", "TLAH…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "PARTICULAR", "GENER…
#> $ CVE_MUN    <chr> "001", "052", "028", "033", "023", "120", "096", "102…
#> $ NOM_MUN    <chr> "AGUASCALIENTES", "MOTUL", "TEOLOCHOLCO", "SAN LUIS D…
#> $ CVE_LOC    <chr> "0001", "0016", "0001", "0001", "0397", "0001", "0013…
#> $ NOM_LOC    <chr> "AGUASCALIENTES", "SAN PEDRO CAMARA", "TEOLOCHOLCO", …
#> $ PUNT_ESP_3 <dbl> 474, 545, 543, 585, 423, 519, NA, 476, 600, 570, 435,…
#> $ PUNT_MAT_3 <dbl> 489, 590, 602, 623, 443, 506, NA, 475, 697, 632, 441,…
#> $ PUNT_FCE_3 <dbl> 426, 442, 428, 510, 388, 454, NA, 434, 589, 513, 398,…
#> $ PUNT_ESP_4 <dbl> 449, 575, 543, 654, 490, 520, 461, 452, 754, 586, 669…
#> $ PUNT_MAT_4 <dbl> 456, 616, 628, 684, 426, 523, 496, 435, 783, 622, 790…
#> $ PUNT_FCE_4 <dbl> 420, 525, 500, 573, 448, 463, 432, 437, 679, 510, 601…
#> $ PUNT_ESP_5 <dbl> 519, 507, 529, 593, 444, 499, 446, 445, 764, 625, 496…
#> $ PUNT_MAT_5 <dbl> 519, 521, 532, 610, 420, 514, 490, 478, 791, 649, 551…
#> $ PUNT_FCE_5 <dbl> 459, 497, 441, 546, 414, 461, 401, 425, 694, 562, 452…
#> $ PUNT_ESP_6 <dbl> 479, 523, 461, 665, 468, 548, 376, 511, 743, 651, NA,…
#> $ PUNT_MAT_6 <dbl> 498, 543, 639, 681, 476, 565, 391, 504, 773, 715, NA,…
#> $ PUNT_FCE_6 <dbl> 447, 537, 476, 604, 437, 502, 425, 483, 632, 577, NA,…
```
...
#>  1 01      AGUASC… 01DP… VESP… MAURIC… GENE… 001     AGUASC… 0001   
#>  2 01      AGUASC… 01DP… VESP… MAURIC… GENE… 001     AGUASC… 0001   
#>  3 01      AGUASC… 01DP… VESP… MAURIC… GENE… 001     AGUASC… 0001   
#>  4 01      AGUASC… 01DP… VESP… MAURIC… GENE… 001     AGUASC… 0001   
#>  5 01      AGUASC… 01DP… VESP… MAURIC… GENE… 001     AGUASC… 0001   
#>  6 01      AGUASC… 01DP… VESP… MAURIC… GENE… 001     AGUASC… 0001   
#>  7 01      AGUASC… 01DP… VESP… MAURIC… GENE… 001     AGUASC… 0001   
#>  8 01      AGUASC… 01DP… VESP… MAURIC… GENE… 001     AGUASC… 0001   
#>  9 01      AGUASC… 01DP… VESP… MAURIC… GENE… 001     AGUASC… 0001   
#> 10 01      AGUASC… 01DP… VESP… MAURIC… GENE… 001     AGUASC… 0001   
...
#> $ CCT     <chr> "01DPR0560F", "01DPR0560F", "01DPR0560F", "01DPR0560F", …
#> $ TURNO   <chr> "VESPERTINO", "VESPERTINO", "VESPERTINO", "VESPERTINO", …
#> $ ESCUELA <chr> "MAURICIO MAGDALENO", "MAURICIO MAGDALENO", "MAURICIO MA…
...
#> $ PUNTAJE <dbl> 474, 489, 426, 449, 456, 420, 519, 519, 459, 479, 498, 4…
```
...
#> $ CCT        <chr> "01DPR0560F", "01DPR0560F", "01DPR0560F", "01DPR0560F…
#> $ TURNO      <chr> "VESPERTINO", "VESPERTINO", "VESPERTINO", "VESPERTINO…
#> $ ESCUELA    <chr> "MAURICIO MAGDALENO", "MAURICIO MAGDALENO", "MAURICIO…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL"…
#> $ CVE_MUN    <chr> "001", "001", "001", "001", "001", "001", "001", "001…
...
#> $ PUNTAJE    <dbl> 474, 489, 426, 449, 456, 420, 519, 519, 459, 479, 498…
```
