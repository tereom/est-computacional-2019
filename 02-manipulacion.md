...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "10", "09", "14", "32", "31", "15", "30", "07", "22",…
#> $ NOM_ENT    <chr> "DURANGO", "DISTRITO FEDERAL", "JALISCO", "ZACATECAS"…
#> $ CCT        <chr> "10KPB0066V", "09DPR2355B", "14DPR2847Z", "32DPR0580M…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "RANCHO DE LA PE\u0084A", "ESTADO DE QUINTANA ROO", "…
#> $ TIPO       <chr> "CONAFE", "GENERAL", "GENERAL", "GENERAL", "GENERAL",…
#> $ CVE_MUN    <chr> "033", "016", "052", "044", "008", "104", "087", "040…
#> $ NOM_MUN    <chr> "SUCHIL", "MIGUEL HIDALGO", "JUCHITLAN", "TABASCO", "…
#> $ CVE_LOC    <chr> "0025", "0041", "0033", "0011", "0001", "0001", "0001…
#> $ NOM_LOC    <chr> "RANCHO DE LA PE\u0084A", "PENSIL", "SANTA MARIA", "C…
#> $ PUNT_ESP_3 <dbl> 527, 549, 493, 556, 650, 553, 600, 622, 591, 420, 633…
#> $ PUNT_MAT_3 <dbl> 760, 565, 555, 568, 679, 564, 586, 680, 637, 375, 625…
#> $ PUNT_FCE_3 <dbl> 488, 516, 439, 469, 569, 497, 486, 568, 545, 428, 569…
#> $ PUNT_ESP_4 <dbl> 511, 551, 454, 526, 415, 540, 763, NA, 631, 367, 750,…
#> $ PUNT_MAT_4 <dbl> 702, 569, 506, 565, 418, 545, 814, NA, 672, 459, 771,…
#> $ PUNT_FCE_4 <dbl> 590, 514, 448, 450, 393, 478, 675, NA, 555, 382, 654,…
#> $ PUNT_ESP_5 <dbl> 482, 550, 535, 464, 465, 538, 577, NA, 563, 469, 691,…
#> $ PUNT_MAT_5 <dbl> 606, 567, 527, 517, 465, 557, 624, NA, 578, 419, 762,…
#> $ PUNT_FCE_5 <dbl> 502, 502, 486, 431, 463, 480, 497, NA, 530, 409, 608,…
#> $ PUNT_ESP_6 <dbl> NA, 569, 513, 493, 602, 535, 674, 548, 580, NA, 632, …
#> $ PUNT_MAT_6 <dbl> NA, 594, 586, 575, 661, 557, 700, 722, 616, NA, 708, …
#> $ PUNT_FCE_6 <dbl> NA, 558, 445, 464, 535, 475, 596, 589, 524, NA, 563, …
```
...
#>  1 10      DURANGO 10KP… MATU… "RANCH… CONA… 033     SUCHIL  0025   
#>  2 10      DURANGO 10KP… MATU… "RANCH… CONA… 033     SUCHIL  0025   
#>  3 10      DURANGO 10KP… MATU… "RANCH… CONA… 033     SUCHIL  0025   
#>  4 10      DURANGO 10KP… MATU… "RANCH… CONA… 033     SUCHIL  0025   
#>  5 10      DURANGO 10KP… MATU… "RANCH… CONA… 033     SUCHIL  0025   
#>  6 10      DURANGO 10KP… MATU… "RANCH… CONA… 033     SUCHIL  0025   
#>  7 10      DURANGO 10KP… MATU… "RANCH… CONA… 033     SUCHIL  0025   
#>  8 10      DURANGO 10KP… MATU… "RANCH… CONA… 033     SUCHIL  0025   
#>  9 10      DURANGO 10KP… MATU… "RANCH… CONA… 033     SUCHIL  0025   
#> 10 10      DURANGO 10KP… MATU… "RANCH… CONA… 033     SUCHIL  0025   
...
#> Observations: 12,000
#> Variables: 13
#> $ CVE_ENT <chr> "10", "10", "10", "10", "10", "10", "10", "10", "10", "1…
#> $ NOM_ENT <chr> "DURANGO", "DURANGO", "DURANGO", "DURANGO", "DURANGO", "…
#> $ CCT     <chr> "10KPB0066V", "10KPB0066V", "10KPB0066V", "10KPB0066V", …
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA <chr> "RANCHO DE LA PE\u0084A", "RANCHO DE LA PE\u0084A", "RAN…
#> $ TIPO    <chr> "CONAFE", "CONAFE", "CONAFE", "CONAFE", "CONAFE", "CONAF…
#> $ CVE_MUN <chr> "033", "033", "033", "033", "033", "033", "033", "033", …
#> $ NOM_MUN <chr> "SUCHIL", "SUCHIL", "SUCHIL", "SUCHIL", "SUCHIL", "SUCHI…
#> $ CVE_LOC <chr> "0025", "0025", "0025", "0025", "0025", "0025", "0025", …
#> $ NOM_LOC <chr> "RANCHO DE LA PE\u0084A", "RANCHO DE LA PE\u0084A", "RAN…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", …
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5,…
#> $ PUNTAJE <dbl> 527, 760, 488, 511, 702, 590, 482, 606, 502, NA, NA, NA,…
```
...
#> Observations: 12,000
#> Variables: 12
#> $ CVE_ENT    <chr> "10", "10", "10", "10", "10", "10", "10", "10", "10",…
#> $ NOM_ENT    <chr> "DURANGO", "DURANGO", "DURANGO", "DURANGO", "DURANGO"…
#> $ CCT        <chr> "10KPB0066V", "10KPB0066V", "10KPB0066V", "10KPB0066V…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "RANCHO DE LA PE\u0084A", "RANCHO DE LA PE\u0084A", "…
#> $ TIPO       <chr> "CONAFE", "CONAFE", "CONAFE", "CONAFE", "CONAFE", "CO…
#> $ CVE_MUN    <chr> "033", "033", "033", "033", "033", "033", "033", "033…
#> $ NOM_MUN    <chr> "SUCHIL", "SUCHIL", "SUCHIL", "SUCHIL", "SUCHIL", "SU…
#> $ CVE_LOC    <chr> "0025", "0025", "0025", "0025", "0025", "0025", "0025…
#> $ NOM_LOC    <chr> "RANCHO DE LA PE\u0084A", "RANCHO DE LA PE\u0084A", "…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4",…
#> $ PUNTAJE    <dbl> 527, 760, 488, 511, 702, 590, 482, 606, 502, NA, NA, …
```
