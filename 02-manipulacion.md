...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "21", "07", "12", "11", "15", "26", "02", "30", "25",…
#> $ NOM_ENT    <chr> "PUEBLA", "CHIAPAS", "GUERRERO", "GUANAJUATO", "MEXIC…
#> $ CCT        <chr> "21PPR0635Y", "07DPB1422D", "12KPR0182K", "11DPR0721I…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "COLEGIO DEL VALLE DE TEHUACAN, A.C.", "NARCISO BASSO…
#> $ TIPO       <chr> "PARTICULAR", "INDêGENA", "CONAFE", "GENERAL", "GENER…
#> $ CVE_MUN    <chr> "156", "023", "048", "035", "058", "002", "002", "027…
#> $ NOM_MUN    <chr> "TEHUACAN", "CHAMULA", "PETATLAN", "SANTA CRUZ DE JUV…
#> $ CVE_LOC    <chr> "0001", "0008", "0018", "0047", "0001", "0001", "0001…
#> $ NOM_LOC    <chr> "TEHUACAN", "BAUTISTA CHICO", "LA BOLSA", "POZOS", "C…
#> $ PUNT_ESP_3 <dbl> 546, 494, NA, 563, 569, 677, 577, 614, 453, 478, 621,…
#> $ PUNT_MAT_3 <dbl> 545, 600, NA, 560, 591, 721, 598, 641, 490, 481, 520,…
#> $ PUNT_FCE_3 <dbl> 497, 435, NA, 502, 520, 636, 511, 534, 427, 423, 520,…
#> $ PUNT_ESP_4 <dbl> 560, 430, NA, 607, 584, 644, 631, 375, NA, 471, 622, …
#> $ PUNT_MAT_4 <dbl> 505, 515, NA, 614, 591, 626, 647, 429, 506, 483, 680,…
#> $ PUNT_FCE_4 <dbl> 506, 414, NA, 561, 510, 599, 556, 380, NA, 449, 551, …
#> $ PUNT_ESP_5 <dbl> 542, 361, NA, 544, 518, 600, 605, 412, NA, 532, 425, …
#> $ PUNT_MAT_5 <dbl> 544, 665, NA, 578, 528, 619, 664, 424, 469, 583, 444,…
#> $ PUNT_FCE_5 <dbl> 481, 463, NA, 447, 488, 574, 534, 388, 404, 487, 391,…
#> $ PUNT_ESP_6 <dbl> 483, 458, 463, 492, 573, 508, 652, 424, NA, 479, 439,…
#> $ PUNT_MAT_6 <dbl> 527, 478, 557, 485, 626, 518, 651, 510, NA, 482, 444,…
#> $ PUNT_FCE_6 <dbl> 431, 438, 446, 428, 504, 489, 573, 477, NA, 459, 421,…
```
...
#>  1 21      PUEBLA  21PP… MATU… COLEGI… PART… 156     TEHUAC… 0001   
#>  2 21      PUEBLA  21PP… MATU… COLEGI… PART… 156     TEHUAC… 0001   
#>  3 21      PUEBLA  21PP… MATU… COLEGI… PART… 156     TEHUAC… 0001   
#>  4 21      PUEBLA  21PP… MATU… COLEGI… PART… 156     TEHUAC… 0001   
#>  5 21      PUEBLA  21PP… MATU… COLEGI… PART… 156     TEHUAC… 0001   
#>  6 21      PUEBLA  21PP… MATU… COLEGI… PART… 156     TEHUAC… 0001   
#>  7 21      PUEBLA  21PP… MATU… COLEGI… PART… 156     TEHUAC… 0001   
#>  8 21      PUEBLA  21PP… MATU… COLEGI… PART… 156     TEHUAC… 0001   
#>  9 21      PUEBLA  21PP… MATU… COLEGI… PART… 156     TEHUAC… 0001   
#> 10 21      PUEBLA  21PP… MATU… COLEGI… PART… 156     TEHUAC… 0001   
...
#> $ CCT     <chr> "21PPR0635Y", "21PPR0635Y", "21PPR0635Y", "21PPR0635Y", …
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA <chr> "COLEGIO DEL VALLE DE TEHUACAN, A.C.", "COLEGIO DEL VALL…
#> $ TIPO    <chr> "PARTICULAR", "PARTICULAR", "PARTICULAR", "PARTICULAR", …
#> $ CVE_MUN <chr> "156", "156", "156", "156", "156", "156", "156", "156", …
#> $ NOM_MUN <chr> "TEHUACAN", "TEHUACAN", "TEHUACAN", "TEHUACAN", "TEHUACA…
#> $ CVE_LOC <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001", …
#> $ NOM_LOC <chr> "TEHUACAN", "TEHUACAN", "TEHUACAN", "TEHUACAN", "TEHUACA…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", …
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5,…
#> $ PUNTAJE <dbl> 546, 545, 497, 560, 505, 506, 542, 544, 481, 483, 527, 4…
```
...
#> $ CCT        <chr> "21PPR0635Y", "21PPR0635Y", "21PPR0635Y", "21PPR0635Y…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "COLEGIO DEL VALLE DE TEHUACAN, A.C.", "COLEGIO DEL V…
#> $ TIPO       <chr> "PARTICULAR", "PARTICULAR", "PARTICULAR", "PARTICULAR…
#> $ CVE_MUN    <chr> "156", "156", "156", "156", "156", "156", "156", "156…
#> $ NOM_MUN    <chr> "TEHUACAN", "TEHUACAN", "TEHUACAN", "TEHUACAN", "TEHU…
#> $ CVE_LOC    <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001…
#> $ NOM_LOC    <chr> "TEHUACAN", "TEHUACAN", "TEHUACAN", "TEHUACAN", "TEHU…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4",…
#> $ PUNTAJE    <dbl> 546, 545, 497, 560, 505, 506, 542, 544, 481, 483, 527…
```
