...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "30", "31", "22", "30", "18", "30", "17", "08", "19",…
#> $ NOM_ENT    <chr> "VERACRUZ", "YUCATAN", "QUERETARO", "VERACRUZ", "NAYA…
#> $ CCT        <chr> "30EPR1569Y", "31PPR0007O", "22KPR0389I", "30EPR0340O…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "IGNACIO ZARAGOZA", "COLEGIO JARDINES", "SUR DEL TEPO…
#> $ TIPO       <chr> "GENERAL", "PARTICULAR", "CONAFE", "GENERAL", "GENERA…
#> $ CVE_MUN    <chr> "121", "050", "001", "024", "001", "108", "029", "037…
#> $ NOM_MUN    <chr> "OZULUAMA DE MASCARE\u0084AS", "MERIDA", "AMEALCO DE …
#> $ CVE_LOC    <chr> "0087", "0001", "0054", "0004", "0089", "0001", "0001…
#> $ NOM_LOC    <chr> "VIJARRAS", "MERIDA", "TEPOZAN EL", "COETZALA", "SAN …
#> $ PUNT_ESP_3 <dbl> 639, 606, 408, 548, 541, 600, 615, 541, 498, 502, 466…
#> $ PUNT_MAT_3 <dbl> 702, 570, 455, 517, 629, 642, 661, 619, 517, 557, 500…
#> $ PUNT_FCE_3 <dbl> 553, 566, 404, 454, 509, 551, 513, 483, 451, 475, 428…
#> $ PUNT_ESP_4 <dbl> NA, 619, NA, 530, 596, 707, 457, 498, 514, 478, 551, …
#> $ PUNT_MAT_4 <dbl> NA, 647, NA, 495, 583, 676, 463, 527, 537, 518, 593, …
#> $ PUNT_FCE_4 <dbl> NA, 546, NA, 448, 526, 538, 449, 465, 469, 458, 550, …
#> $ PUNT_ESP_5 <dbl> 604, 298, NA, 490, 516, 615, 559, 479, 514, 500, 591,…
#> $ PUNT_MAT_5 <dbl> 612, 288, NA, 522, 572, 625, 625, 499, 573, 543, 582,…
#> $ PUNT_FCE_5 <dbl> 578, 321, NA, 476, 420, 578, 496, 428, 482, 456, 530,…
#> $ PUNT_ESP_6 <dbl> 576, 564, 426, 510, NA, 596, 692, 500, 541, 550, 535,…
#> $ PUNT_MAT_6 <dbl> 520, 554, 488, 576, NA, 662, 737, 545, 557, 583, 610,…
#> $ PUNT_FCE_6 <dbl> 488, 520, 443, 511, NA, 558, 624, 456, 495, 517, 544,…
```
...
#>  1 30      VERACR… 30EP… MATU… IGNACI… GENE… 121     "OZULU… 0087   
#>  2 30      VERACR… 30EP… MATU… IGNACI… GENE… 121     "OZULU… 0087   
#>  3 30      VERACR… 30EP… MATU… IGNACI… GENE… 121     "OZULU… 0087   
#>  4 30      VERACR… 30EP… MATU… IGNACI… GENE… 121     "OZULU… 0087   
#>  5 30      VERACR… 30EP… MATU… IGNACI… GENE… 121     "OZULU… 0087   
#>  6 30      VERACR… 30EP… MATU… IGNACI… GENE… 121     "OZULU… 0087   
#>  7 30      VERACR… 30EP… MATU… IGNACI… GENE… 121     "OZULU… 0087   
#>  8 30      VERACR… 30EP… MATU… IGNACI… GENE… 121     "OZULU… 0087   
#>  9 30      VERACR… 30EP… MATU… IGNACI… GENE… 121     "OZULU… 0087   
#> 10 30      VERACR… 30EP… MATU… IGNACI… GENE… 121     "OZULU… 0087   
...
#> Observations: 12,000
#> Variables: 13
#> $ CVE_ENT <chr> "30", "30", "30", "30", "30", "30", "30", "30", "30", "3…
#> $ NOM_ENT <chr> "VERACRUZ", "VERACRUZ", "VERACRUZ", "VERACRUZ", "VERACRU…
#> $ CCT     <chr> "30EPR1569Y", "30EPR1569Y", "30EPR1569Y", "30EPR1569Y", …
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA <chr> "IGNACIO ZARAGOZA", "IGNACIO ZARAGOZA", "IGNACIO ZARAGOZ…
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "…
#> $ CVE_MUN <chr> "121", "121", "121", "121", "121", "121", "121", "121", …
#> $ NOM_MUN <chr> "OZULUAMA DE MASCARE\u0084AS", "OZULUAMA DE MASCARE\u008…
#> $ CVE_LOC <chr> "0087", "0087", "0087", "0087", "0087", "0087", "0087", …
#> $ NOM_LOC <chr> "VIJARRAS", "VIJARRAS", "VIJARRAS", "VIJARRAS", "VIJARRA…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", …
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5,…
#> $ PUNTAJE <dbl> 639, 702, 553, NA, NA, NA, 604, 612, 578, 576, 520, 488,…
```
...
#> Observations: 12,000
#> Variables: 12
#> $ CVE_ENT    <chr> "30", "30", "30", "30", "30", "30", "30", "30", "30",…
#> $ NOM_ENT    <chr> "VERACRUZ", "VERACRUZ", "VERACRUZ", "VERACRUZ", "VERA…
#> $ CCT        <chr> "30EPR1569Y", "30EPR1569Y", "30EPR1569Y", "30EPR1569Y…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "IGNACIO ZARAGOZA", "IGNACIO ZARAGOZA", "IGNACIO ZARA…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL"…
#> $ CVE_MUN    <chr> "121", "121", "121", "121", "121", "121", "121", "121…
#> $ NOM_MUN    <chr> "OZULUAMA DE MASCARE\u0084AS", "OZULUAMA DE MASCARE\u…
#> $ CVE_LOC    <chr> "0087", "0087", "0087", "0087", "0087", "0087", "0087…
#> $ NOM_LOC    <chr> "VIJARRAS", "VIJARRAS", "VIJARRAS", "VIJARRAS", "VIJA…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4",…
#> $ PUNTAJE    <dbl> 639, 702, 553, NA, NA, NA, 604, 612, 578, 576, 520, 4…
```
