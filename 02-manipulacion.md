...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "08", "22", "27", "30", "07", "28", "30", "12", "05",…
#> $ NOM_ENT    <chr> "CHIHUAHUA", "QUERETARO", "TABASCO", "VERACRUZ", "CHI…
#> $ CCT        <chr> "08EPR0594O", "22DPR0259F", "27PPR0043G", "30KPR1226N…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "CUITLAHUAC 2334", "PROFR DANIEL ORTIZ ESQUIVEL", "OL…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "PARTICULAR", "CONAFE", "CONAFE…
#> $ CVE_MUN    <chr> "011", "005", "002", "061", "092", "035", "003", "034…
#> $ NOM_MUN    <chr> "CAMARGO", "COLON", "CARDENAS", "LAS CHOAPAS", "TECPA…
#> $ CVE_LOC    <chr> "0001", "0058", "0001", "1009", "0418", "0435", "0001…
#> $ NOM_LOC    <chr> "SANTA ROSALIA DE CAMARGO", "VISTA HERMOSA", "CARDENA…
#> $ PUNT_ESP_3 <dbl> 572, 482, 567, NA, 507, 606, 520, 497, 515, 545, 535,…
#> $ PUNT_MAT_3 <dbl> 630, 526, 565, NA, 541, 680, 549, 499, 531, 568, 557,…
#> $ PUNT_FCE_3 <dbl> 514, 441, 499, NA, 388, 535, 459, 420, 456, 510, 470,…
#> $ PUNT_ESP_4 <dbl> 606, 500, 539, 363, 434, 503, 546, 465, 531, 528, 515…
#> $ PUNT_MAT_4 <dbl> 664, 515, 494, 392, 376, 499, 567, 481, 521, 525, 580…
#> $ PUNT_FCE_4 <dbl> 541, 428, 463, 378, 396, 466, 507, 425, 480, 493, 530…
#> $ PUNT_ESP_5 <dbl> 544, 466, 527, NA, NA, 397, 501, 423, 555, 579, 458, …
#> $ PUNT_MAT_5 <dbl> 558, 458, 529, NA, NA, 401, 504, 421, 554, 592, 572, …
#> $ PUNT_FCE_5 <dbl> 481, 451, 482, NA, NA, 478, 457, 427, 495, 538, 474, …
#> $ PUNT_ESP_6 <dbl> 581, 489, 611, NA, 344, NA, 428, 511, 536, 558, 425, …
#> $ PUNT_MAT_6 <dbl> 627, 464, 685, NA, 384, NA, 493, 533, 519, 596, 395, …
#> $ PUNT_FCE_6 <dbl> 535, 469, 526, NA, 282, NA, 415, 474, 498, 488, 432, …
```
...
#>  1 08      CHIHUA… 08EP… MATU… CUITLA… GENE… 011     CAMARGO 0001   
#>  2 08      CHIHUA… 08EP… MATU… CUITLA… GENE… 011     CAMARGO 0001   
#>  3 08      CHIHUA… 08EP… MATU… CUITLA… GENE… 011     CAMARGO 0001   
#>  4 08      CHIHUA… 08EP… MATU… CUITLA… GENE… 011     CAMARGO 0001   
#>  5 08      CHIHUA… 08EP… MATU… CUITLA… GENE… 011     CAMARGO 0001   
#>  6 08      CHIHUA… 08EP… MATU… CUITLA… GENE… 011     CAMARGO 0001   
#>  7 08      CHIHUA… 08EP… MATU… CUITLA… GENE… 011     CAMARGO 0001   
#>  8 08      CHIHUA… 08EP… MATU… CUITLA… GENE… 011     CAMARGO 0001   
#>  9 08      CHIHUA… 08EP… MATU… CUITLA… GENE… 011     CAMARGO 0001   
#> 10 08      CHIHUA… 08EP… MATU… CUITLA… GENE… 011     CAMARGO 0001   
...
#> $ CCT     <chr> "08EPR0594O", "08EPR0594O", "08EPR0594O", "08EPR0594O", …
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA <chr> "CUITLAHUAC 2334", "CUITLAHUAC 2334", "CUITLAHUAC 2334",…
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "…
#> $ CVE_MUN <chr> "011", "011", "011", "011", "011", "011", "011", "011", …
#> $ NOM_MUN <chr> "CAMARGO", "CAMARGO", "CAMARGO", "CAMARGO", "CAMARGO", "…
#> $ CVE_LOC <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001", …
#> $ NOM_LOC <chr> "SANTA ROSALIA DE CAMARGO", "SANTA ROSALIA DE CAMARGO", …
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", …
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5,…
#> $ PUNTAJE <dbl> 572, 630, 514, 606, 664, 541, 544, 558, 481, 581, 627, 5…
```
...
#> $ CCT        <chr> "08EPR0594O", "08EPR0594O", "08EPR0594O", "08EPR0594O…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "CUITLAHUAC 2334", "CUITLAHUAC 2334", "CUITLAHUAC 233…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL"…
#> $ CVE_MUN    <chr> "011", "011", "011", "011", "011", "011", "011", "011…
#> $ NOM_MUN    <chr> "CAMARGO", "CAMARGO", "CAMARGO", "CAMARGO", "CAMARGO"…
#> $ CVE_LOC    <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001…
...
#> $ PUNTAJE    <dbl> 572, 630, 514, 606, 664, 541, 544, 558, 481, 581, 627…
```
