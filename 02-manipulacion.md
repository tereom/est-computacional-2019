...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "25", "30", "27", "30", "29", "07", "11", "21", "07",…
#> $ NOM_ENT    <chr> "SINALOA", "VERACRUZ", "TABASCO", "VERACRUZ", "TLAXCA…
#> $ CCT        <chr> "25DPR1261Y", "30DPB0148I", "27PPR0035Y", "30EPR2948O…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "ADOLFO RUIZ CORTINES", "PROFR. MATIAS LOPEZ", "GRAL …
#> $ TIPO       <chr> "GENERAL", "INDêGENA", "PARTICULAR", "GENERAL", "CONA…
#> $ CVE_MUN    <chr> "006", "173", "006", "087", "010", "080", "007", "150…
#> $ NOM_MUN    <chr> "CULIACAN", "TEZONAPA", "CUNDUACAN", "XALAPA", "CHIAU…
#> $ CVE_LOC    <chr> "0341", "0157", "0095", "0001", "0005", "0001", "0001…
#> $ NOM_LOC    <chr> "ELDORADO", "COLONIA IGNACIO ALLENDE", "LIBERTAD 4TA.…
#> $ PUNT_ESP_3 <dbl> 510, 397, 497, 549, 398, 696, 535, 541, 405, 672, 493…
#> $ PUNT_MAT_3 <dbl> 524, 371, 486, 587, 502, 758, 633, 545, 408, 783, 494…
#> $ PUNT_FCE_3 <dbl> 452, 361, 427, 499, 424, 592, 534, 413, 373, 626, 437…
#> $ PUNT_ESP_4 <dbl> 494, 441, 442, 531, 422, 632, NA, 597, 406, 678, 489,…
#> $ PUNT_MAT_4 <dbl> 514, 375, 445, 581, 677, 710, NA, 655, 400, 757, 505,…
#> $ PUNT_FCE_4 <dbl> 460, 414, 404, 492, 387, 682, NA, 519, 409, 636, 446,…
#> $ PUNT_ESP_5 <dbl> 487, 554, 511, 511, 501, 790, NA, 555, NA, 765, 515, …
#> $ PUNT_MAT_5 <dbl> 498, 511, 501, 533, 530, 776, NA, 565, NA, 694, 549, …
#> $ PUNT_FCE_5 <dbl> 439, 485, 448, 475, 503, 610, NA, 541, NA, 603, 472, …
#> $ PUNT_ESP_6 <dbl> 533, 472, 557, 547, NA, 675, NA, 549, 325, 735, 511, …
#> $ PUNT_MAT_6 <dbl> 627, 506, 614, 566, NA, 703, NA, 665, 326, 796, 566, …
#> $ PUNT_FCE_6 <dbl> 483, 519, 478, 490, NA, 669, NA, 622, 320, 580, 481, …
```
...
#>  1 25      SINALOA 25DP… MATU… ADOLFO… GENE… 006     CULIAC… 0341   
#>  2 25      SINALOA 25DP… MATU… ADOLFO… GENE… 006     CULIAC… 0341   
#>  3 25      SINALOA 25DP… MATU… ADOLFO… GENE… 006     CULIAC… 0341   
#>  4 25      SINALOA 25DP… MATU… ADOLFO… GENE… 006     CULIAC… 0341   
#>  5 25      SINALOA 25DP… MATU… ADOLFO… GENE… 006     CULIAC… 0341   
#>  6 25      SINALOA 25DP… MATU… ADOLFO… GENE… 006     CULIAC… 0341   
#>  7 25      SINALOA 25DP… MATU… ADOLFO… GENE… 006     CULIAC… 0341   
#>  8 25      SINALOA 25DP… MATU… ADOLFO… GENE… 006     CULIAC… 0341   
#>  9 25      SINALOA 25DP… MATU… ADOLFO… GENE… 006     CULIAC… 0341   
#> 10 25      SINALOA 25DP… MATU… ADOLFO… GENE… 006     CULIAC… 0341   
...
#> Observations: 12,000
#> Variables: 13
#> $ CVE_ENT <chr> "25", "25", "25", "25", "25", "25", "25", "25", "25", "2…
#> $ NOM_ENT <chr> "SINALOA", "SINALOA", "SINALOA", "SINALOA", "SINALOA", "…
#> $ CCT     <chr> "25DPR1261Y", "25DPR1261Y", "25DPR1261Y", "25DPR1261Y", …
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA <chr> "ADOLFO RUIZ CORTINES", "ADOLFO RUIZ CORTINES", "ADOLFO …
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "…
#> $ CVE_MUN <chr> "006", "006", "006", "006", "006", "006", "006", "006", …
#> $ NOM_MUN <chr> "CULIACAN", "CULIACAN", "CULIACAN", "CULIACAN", "CULIACA…
#> $ CVE_LOC <chr> "0341", "0341", "0341", "0341", "0341", "0341", "0341", …
#> $ NOM_LOC <chr> "ELDORADO", "ELDORADO", "ELDORADO", "ELDORADO", "ELDORAD…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", …
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5,…
#> $ PUNTAJE <dbl> 510, 524, 452, 494, 514, 460, 487, 498, 439, 533, 627, 4…
```
...
#> Observations: 12,000
#> Variables: 12
#> $ CVE_ENT    <chr> "25", "25", "25", "25", "25", "25", "25", "25", "25",…
#> $ NOM_ENT    <chr> "SINALOA", "SINALOA", "SINALOA", "SINALOA", "SINALOA"…
#> $ CCT        <chr> "25DPR1261Y", "25DPR1261Y", "25DPR1261Y", "25DPR1261Y…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "ADOLFO RUIZ CORTINES", "ADOLFO RUIZ CORTINES", "ADOL…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL"…
#> $ CVE_MUN    <chr> "006", "006", "006", "006", "006", "006", "006", "006…
#> $ NOM_MUN    <chr> "CULIACAN", "CULIACAN", "CULIACAN", "CULIACAN", "CULI…
#> $ CVE_LOC    <chr> "0341", "0341", "0341", "0341", "0341", "0341", "0341…
#> $ NOM_LOC    <chr> "ELDORADO", "ELDORADO", "ELDORADO", "ELDORADO", "ELDO…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4",…
#> $ PUNTAJE    <dbl> 510, 524, 452, 494, 514, 460, 487, 498, 439, 533, 627…
```
