...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "07", "30", "23", "13", "12", "13", "09", "30", "24",…
#> $ NOM_ENT    <chr> "CHIAPAS", "VERACRUZ", "QUINTANA ROO", "HIDALGO", "GU…
#> $ CCT        <chr> "07KPB0429Z", "30DPR0960X", "23DPR0072A", "13DPR0563H…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "NUEVO ORIZABA", "LIC. ANGEL CARVAJAL", "21 DE MARZO"…
#> $ TIPO       <chr> "CONAFE", "GENERAL", "GENERAL", "GENERAL", "GENERAL",…
#> $ CVE_MUN    <chr> "059", "158", "009", "061", "057", "029", "017", "055…
#> $ NOM_MUN    <chr> "OCOSINGO", "TECOLUTLA", "TULUM", "TEPEAPULCO", "TECP…
#> $ CVE_LOC    <chr> "1568", "0024", "0057", "0014", "0201", "0008", "0038…
#> $ NOM_LOC    <chr> "NUEVO ORIZABA", "MONTE GORDO", "COBA", "SAN BARTOLOM…
#> $ PUNT_ESP_3 <dbl> 393, 647, 489, 496, 477, 535, 610, 607, 411, 465, 482…
#> $ PUNT_MAT_3 <dbl> 453, 685, 520, 541, 526, 731, 660, 710, 491, 498, 494…
#> $ PUNT_FCE_3 <dbl> 408, 574, 436, 421, 409, 512, 562, 595, 387, 416, 445…
#> $ PUNT_ESP_4 <dbl> 399, 584, 492, 553, 427, 563, 607, 482, 411, 442, 488…
#> $ PUNT_MAT_4 <dbl> 432, 610, 547, 563, 521, 684, 656, 603, 441, 485, 464…
#> $ PUNT_FCE_4 <dbl> 409, 522, 444, 488, 460, 499, 585, 528, 436, 443, 445…
#> $ PUNT_ESP_5 <dbl> 387, 517, 595, 570, 303, 489, 578, 556, 434, 454, 485…
#> $ PUNT_MAT_5 <dbl> 423, 524, 611, 574, 358, 518, 575, 666, 441, 491, 511…
#> $ PUNT_FCE_5 <dbl> 341, 494, 537, 526, 306, 408, 541, 528, 406, 441, 466…
#> $ PUNT_ESP_6 <dbl> NA, NA, 553, 540, 418, 395, 582, 364, 437, 473, 517, …
#> $ PUNT_MAT_6 <dbl> NA, NA, 558, 517, 518, 577, 649, 423, 439, 533, 569, …
#> $ PUNT_FCE_6 <dbl> NA, NA, 507, 522, 480, 373, 548, 437, 404, 436, 478, …
```
...
#>  1 07      CHIAPAS 07KP… MATU… NUEVO … CONA… 059     OCOSIN… 1568   
#>  2 07      CHIAPAS 07KP… MATU… NUEVO … CONA… 059     OCOSIN… 1568   
#>  3 07      CHIAPAS 07KP… MATU… NUEVO … CONA… 059     OCOSIN… 1568   
#>  4 07      CHIAPAS 07KP… MATU… NUEVO … CONA… 059     OCOSIN… 1568   
#>  5 07      CHIAPAS 07KP… MATU… NUEVO … CONA… 059     OCOSIN… 1568   
#>  6 07      CHIAPAS 07KP… MATU… NUEVO … CONA… 059     OCOSIN… 1568   
#>  7 07      CHIAPAS 07KP… MATU… NUEVO … CONA… 059     OCOSIN… 1568   
#>  8 07      CHIAPAS 07KP… MATU… NUEVO … CONA… 059     OCOSIN… 1568   
#>  9 07      CHIAPAS 07KP… MATU… NUEVO … CONA… 059     OCOSIN… 1568   
#> 10 07      CHIAPAS 07KP… MATU… NUEVO … CONA… 059     OCOSIN… 1568   
...
#> Observations: 12,000
#> Variables: 13
#> $ CVE_ENT <chr> "07", "07", "07", "07", "07", "07", "07", "07", "07", "0…
#> $ NOM_ENT <chr> "CHIAPAS", "CHIAPAS", "CHIAPAS", "CHIAPAS", "CHIAPAS", "…
#> $ CCT     <chr> "07KPB0429Z", "07KPB0429Z", "07KPB0429Z", "07KPB0429Z", …
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA <chr> "NUEVO ORIZABA", "NUEVO ORIZABA", "NUEVO ORIZABA", "NUEV…
#> $ TIPO    <chr> "CONAFE", "CONAFE", "CONAFE", "CONAFE", "CONAFE", "CONAF…
#> $ CVE_MUN <chr> "059", "059", "059", "059", "059", "059", "059", "059", …
#> $ NOM_MUN <chr> "OCOSINGO", "OCOSINGO", "OCOSINGO", "OCOSINGO", "OCOSING…
#> $ CVE_LOC <chr> "1568", "1568", "1568", "1568", "1568", "1568", "1568", …
#> $ NOM_LOC <chr> "NUEVO ORIZABA", "NUEVO ORIZABA", "NUEVO ORIZABA", "NUEV…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", …
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5,…
#> $ PUNTAJE <dbl> 393, 453, 408, 399, 432, 409, 387, 423, 341, NA, NA, NA,…
```
...
#> Observations: 12,000
#> Variables: 12
#> $ CVE_ENT    <chr> "07", "07", "07", "07", "07", "07", "07", "07", "07",…
#> $ NOM_ENT    <chr> "CHIAPAS", "CHIAPAS", "CHIAPAS", "CHIAPAS", "CHIAPAS"…
#> $ CCT        <chr> "07KPB0429Z", "07KPB0429Z", "07KPB0429Z", "07KPB0429Z…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "NUEVO ORIZABA", "NUEVO ORIZABA", "NUEVO ORIZABA", "N…
#> $ TIPO       <chr> "CONAFE", "CONAFE", "CONAFE", "CONAFE", "CONAFE", "CO…
#> $ CVE_MUN    <chr> "059", "059", "059", "059", "059", "059", "059", "059…
#> $ NOM_MUN    <chr> "OCOSINGO", "OCOSINGO", "OCOSINGO", "OCOSINGO", "OCOS…
#> $ CVE_LOC    <chr> "1568", "1568", "1568", "1568", "1568", "1568", "1568…
#> $ NOM_LOC    <chr> "NUEVO ORIZABA", "NUEVO ORIZABA", "NUEVO ORIZABA", "N…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4",…
#> $ PUNTAJE    <dbl> 393, 453, 408, 399, 432, 409, 387, 423, 341, NA, NA, …
```
