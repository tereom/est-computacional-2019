...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "13", "29", "11", "04", "16", "23", "30", "15", "26",…
#> $ NOM_ENT    <chr> "HIDALGO", "TLAXCALA", "GUANAJUATO", "CAMPECHE", "MIC…
#> $ CCT        <chr> "13DPB0209P", "29KPB0004G", "11PPR0256H", "04DPR0132K…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "EMILIANO ZAPATA", "RANCHO MARIA", "JOSEFA ORTIZ DE D…
#> $ TIPO       <chr> "INDêGENA", "CONAFE", "PARTICULAR", "GENERAL", "GENER…
#> $ CVE_MUN    <chr> "030", "025", "027", "011", "110", "004", "109", "074…
#> $ NOM_MUN    <chr> "IXMIQUILPAN", "SAN PABLO DEL MONTE", "SALAMANCA", "C…
#> $ CVE_LOC    <chr> "0096", "0002", "0001", "0412", "0044", "0319", "0020…
#> $ NOM_LOC    <chr> "EX-HACIENDA DE OCOTZA", "SAN ISIDRO BUEN SUCESO", "S…
#> $ PUNT_ESP_3 <dbl> 501, 546, 555, 514, 503, 420, 443, 575, NA, 571, 563,…
#> $ PUNT_MAT_3 <dbl> 611, 655, 587, 489, 545, 536, 459, 556, NA, 585, 603,…
#> $ PUNT_FCE_3 <dbl> 415, 549, 507, 428, 425, 388, 409, 452, NA, 503, 414,…
#> $ PUNT_ESP_4 <dbl> 549, 561, 621, 430, 651, 396, NA, 463, 634, 591, 391,…
#> $ PUNT_MAT_4 <dbl> 599, 680, 620, 401, 713, NA, NA, 550, 674, 579, 435, …
#> $ PUNT_FCE_4 <dbl> 473, 554, 517, 409, 559, 430, NA, 416, 516, 525, 447,…
#> $ PUNT_ESP_5 <dbl> 529, 436, 610, 542, 650, 395, 440, 631, 597, 532, 372…
#> $ PUNT_MAT_5 <dbl> 624, 555, 647, 500, 810, 418, 490, 721, 654, 530, 433…
#> $ PUNT_FCE_5 <dbl> 514, 523, 553, 474, 554, 343, 445, 568, 469, 514, 413…
#> $ PUNT_ESP_6 <dbl> 560, 479, 620, 444, 475, 369, 400, 645, 451, 578, 368…
#> $ PUNT_MAT_6 <dbl> 596, 482, 682, 462, 521, 443, 444, 720, 427, 579, 375…
#> $ PUNT_FCE_6 <dbl> 451, 436, 554, 418, 452, 327, 346, 549, 392, 525, 359…
```
...
#>  1 13      HIDALGO 13DP… MATU… EMILIA… INDê… 030     IXMIQU… 0096   
#>  2 13      HIDALGO 13DP… MATU… EMILIA… INDê… 030     IXMIQU… 0096   
#>  3 13      HIDALGO 13DP… MATU… EMILIA… INDê… 030     IXMIQU… 0096   
#>  4 13      HIDALGO 13DP… MATU… EMILIA… INDê… 030     IXMIQU… 0096   
#>  5 13      HIDALGO 13DP… MATU… EMILIA… INDê… 030     IXMIQU… 0096   
#>  6 13      HIDALGO 13DP… MATU… EMILIA… INDê… 030     IXMIQU… 0096   
#>  7 13      HIDALGO 13DP… MATU… EMILIA… INDê… 030     IXMIQU… 0096   
#>  8 13      HIDALGO 13DP… MATU… EMILIA… INDê… 030     IXMIQU… 0096   
#>  9 13      HIDALGO 13DP… MATU… EMILIA… INDê… 030     IXMIQU… 0096   
#> 10 13      HIDALGO 13DP… MATU… EMILIA… INDê… 030     IXMIQU… 0096   
...
#> Observations: 12,000
#> Variables: 13
#> $ CVE_ENT <chr> "13", "13", "13", "13", "13", "13", "13", "13", "13", "1…
#> $ NOM_ENT <chr> "HIDALGO", "HIDALGO", "HIDALGO", "HIDALGO", "HIDALGO", "…
#> $ CCT     <chr> "13DPB0209P", "13DPB0209P", "13DPB0209P", "13DPB0209P", …
...
#> $ CVE_MUN <chr> "030", "030", "030", "030", "030", "030", "030", "030", …
#> $ NOM_MUN <chr> "IXMIQUILPAN", "IXMIQUILPAN", "IXMIQUILPAN", "IXMIQUILPA…
#> $ CVE_LOC <chr> "0096", "0096", "0096", "0096", "0096", "0096", "0096", …
#> $ NOM_LOC <chr> "EX-HACIENDA DE OCOTZA", "EX-HACIENDA DE OCOTZA", "EX-HA…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", …
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5,…
#> $ PUNTAJE <dbl> 501, 611, 415, 549, 599, 473, 529, 624, 514, 560, 596, 4…
```
...
#> Observations: 12,000
#> Variables: 12
#> $ CVE_ENT    <chr> "13", "13", "13", "13", "13", "13", "13", "13", "13",…
#> $ NOM_ENT    <chr> "HIDALGO", "HIDALGO", "HIDALGO", "HIDALGO", "HIDALGO"…
#> $ CCT        <chr> "13DPB0209P", "13DPB0209P", "13DPB0209P", "13DPB0209P…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
...
#> $ CVE_MUN    <chr> "030", "030", "030", "030", "030", "030", "030", "030…
#> $ NOM_MUN    <chr> "IXMIQUILPAN", "IXMIQUILPAN", "IXMIQUILPAN", "IXMIQUI…
#> $ CVE_LOC    <chr> "0096", "0096", "0096", "0096", "0096", "0096", "0096…
#> $ NOM_LOC    <chr> "EX-HACIENDA DE OCOTZA", "EX-HACIENDA DE OCOTZA", "EX…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4",…
#> $ PUNTAJE    <dbl> 501, 611, 415, 549, 599, 473, 529, 624, 514, 560, 596…
```
