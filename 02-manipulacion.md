...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "14", "30", "15", "05", "15", "15", "30", "30", "11", "07"…
#> $ NOM_ENT    <chr> "JALISCO", "VERACRUZ", "MEXICO", "COAHUILA", "MEXICO", "ME…
#> $ CCT        <chr> "14EPR1024P", "30EPR3550N", "15EPR1741Y", "05DPR0297S", "1…
#> $ TURNO      <chr> "MATUTINO", "VESPERTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA    <chr> "REPUBLICA DE FILIPINAS", "PATRIA", "MARIANO MATAMOROS", "…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GE…
#> $ CVE_MUN    <chr> "039", "087", "078", "038", "103", "122", "086", "048", "0…
#> $ NOM_MUN    <chr> "GUADALAJARA", "XALAPA", "SANTO TOMAS DE LOS PLATANOS", "Z…
#> $ CVE_LOC    <chr> "0001", "0001", "0014", "0001", "0002", "0001", "0006", "0…
#> $ NOM_LOC    <chr> "GUADALAJARA", "XALAPA-ENRIQUEZ", "SAN PEDRO EL GRANDE", "…
#> $ PUNT_ESP_3 <dbl> 564, 509, 606, 544, 545, 495, 523, 513, 643, 421, 559, 532…
#> $ PUNT_MAT_3 <dbl> 594, 559, 398, 575, 545, 502, 574, 569, 655, 513, 584, 526…
#> $ PUNT_FCE_3 <dbl> 514, 452, 445, 543, 472, 455, 522, 441, 530, 423, 449, 450…
#> $ PUNT_ESP_4 <dbl> 528, 558, NA, 519, 520, 536, 524, 531, 527, 367, 526, 587,…
#> $ PUNT_MAT_4 <dbl> 523, 586, NA, 594, 529, 539, 583, 558, 548, 407, 527, 658,…
#> $ PUNT_FCE_4 <dbl> 463, 506, NA, 465, 453, 472, 489, 462, 460, 386, 476, 526,…
#> $ PUNT_ESP_5 <dbl> 546, 557, 545, 551, 463, 475, 490, 505, 461, 390, 517, 490…
#> $ PUNT_MAT_5 <dbl> 544, 549, 442, 598, 504, 471, 586, 547, 492, 324, 537, 517…
#> $ PUNT_FCE_5 <dbl> 492, 502, 510, 476, 417, 462, 487, 469, 438, 418, 430, 442…
#> $ PUNT_ESP_6 <dbl> 585, 548, 565, 583, 477, 514, 556, 493, 730, 406, 552, 506…
#> $ PUNT_MAT_6 <dbl> 600, 567, 555, 615, 509, 515, 621, 509, 683, 383, 568, 554…
#> $ PUNT_FCE_6 <dbl> 531, 524, 477, 511, 441, 470, 505, 457, 533, 375, 523, 476…
```
...
#>  1 14      JALISCO 14EP… MATU… REPUBL… GENE… 039     GUADAL… 0001    GUADAL…
#>  2 14      JALISCO 14EP… MATU… REPUBL… GENE… 039     GUADAL… 0001    GUADAL…
#>  3 14      JALISCO 14EP… MATU… REPUBL… GENE… 039     GUADAL… 0001    GUADAL…
#>  4 14      JALISCO 14EP… MATU… REPUBL… GENE… 039     GUADAL… 0001    GUADAL…
#>  5 14      JALISCO 14EP… MATU… REPUBL… GENE… 039     GUADAL… 0001    GUADAL…
#>  6 14      JALISCO 14EP… MATU… REPUBL… GENE… 039     GUADAL… 0001    GUADAL…
#>  7 14      JALISCO 14EP… MATU… REPUBL… GENE… 039     GUADAL… 0001    GUADAL…
#>  8 14      JALISCO 14EP… MATU… REPUBL… GENE… 039     GUADAL… 0001    GUADAL…
#>  9 14      JALISCO 14EP… MATU… REPUBL… GENE… 039     GUADAL… 0001    GUADAL…
#> 10 14      JALISCO 14EP… MATU… REPUBL… GENE… 039     GUADAL… 0001    GUADAL…
...
#> $ CCT     <chr> "14EPR1024P", "14EPR1024P", "14EPR1024P", "14EPR1024P", "14EP…
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "…
#> $ ESCUELA <chr> "REPUBLICA DE FILIPINAS", "REPUBLICA DE FILIPINAS", "REPUBLIC…
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENER…
#> $ CVE_MUN <chr> "039", "039", "039", "039", "039", "039", "039", "039", "039"…
#> $ NOM_MUN <chr> "GUADALAJARA", "GUADALAJARA", "GUADALAJARA", "GUADALAJARA", "…
#> $ CVE_LOC <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001", "0001…
#> $ NOM_LOC <chr> "GUADALAJARA", "GUADALAJARA", "GUADALAJARA", "GUADALAJARA", "…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", "FCE"…
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5, 5, 5…
#> $ PUNTAJE <dbl> 564, 594, 514, 528, 523, 463, 546, 544, 492, 585, 600, 531, 5…
```
...
#> $ CCT        <chr> "14EPR1024P", "14EPR1024P", "14EPR1024P", "14EPR1024P", "1…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO"…
#> $ ESCUELA    <chr> "REPUBLICA DE FILIPINAS", "REPUBLICA DE FILIPINAS", "REPUB…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GE…
#> $ CVE_MUN    <chr> "039", "039", "039", "039", "039", "039", "039", "039", "0…
#> $ NOM_MUN    <chr> "GUADALAJARA", "GUADALAJARA", "GUADALAJARA", "GUADALAJARA"…
#> $ CVE_LOC    <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001", "0…
#> $ NOM_LOC    <chr> "GUADALAJARA", "GUADALAJARA", "GUADALAJARA", "GUADALAJARA"…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4", "ESP…
#> $ PUNTAJE    <dbl> 564, 594, 514, 528, 523, 463, 546, 544, 492, 585, 600, 531…
```
