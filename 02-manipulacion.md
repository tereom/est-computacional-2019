...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "12", "18", "26", "14", "30", "07", "14", "22", "05", "30"…
#> $ NOM_ENT    <chr> "GUERRERO", "NAYARIT", "SONORA", "JALISCO", "VERACRUZ", "C…
#> $ CCT        <chr> "12DPR1925I", "18DPR0477G", "26DPR1426P", "14EPR1422N", "3…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "VESPERTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA    <chr> "IGNACIO M. ALTAMIRANO", "FRANCISCO VILLA", "DIANA LAURA R…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "IN…
#> $ CVE_MUN    <chr> "055", "011", "033", "039", "108", "026", "052", "013", "0…
#> $ NOM_MUN    <chr> "TAXCO DE ALARCON", "RUIZ", "HUATABAMPO", "GUADALAJARA", "…
#> $ CVE_LOC    <chr> "0001", "0001", "0001", "0001", "0028", "0071", "0005", "0…
#> $ NOM_LOC    <chr> "TAXCO DE ALARCON", "RUIZ", "HUATABAMPO", "GUADALAJARA", "…
#> $ PUNT_ESP_3 <dbl> 524, 513, 606, 598, 445, 410, 503, NA, 405, 435, 598, 556,…
#> $ PUNT_MAT_3 <dbl> 597, 574, 779, 617, 495, 574, 490, NA, 397, 430, 666, 589,…
#> $ PUNT_FCE_3 <dbl> 460, 487, 605, 573, 405, 438, 468, NA, 397, 374, 580, 491,…
#> $ PUNT_ESP_4 <dbl> 635, 470, 420, 607, 322, 449, 796, 407, 339, 451, 437, 509…
#> $ PUNT_MAT_4 <dbl> 684, 489, 434, 618, 425, 670, 697, 373, 378, 488, 393, 522…
#> $ PUNT_FCE_4 <dbl> 562, 421, 411, 542, 402, 392, 621, 366, 317, 447, 457, 469…
#> $ PUNT_ESP_5 <dbl> 664, 474, 604, 577, 427, 474, 505, NA, NA, 458, 348, 613, …
#> $ PUNT_MAT_5 <dbl> 714, 478, 607, 602, 452, 624, 558, NA, NA, 440, 371, 595, …
#> $ PUNT_FCE_5 <dbl> 594, 501, 542, 536, 444, 441, 475, NA, NA, 416, 458, 567, …
#> $ PUNT_ESP_6 <dbl> 533, 514, 485, 586, 448, 355, 697, 489, 433, 447, 441, 542…
#> $ PUNT_MAT_6 <dbl> 578, 547, 495, 669, 514, 541, 753, 519, 364, 483, 406, 544…
#> $ PUNT_FCE_6 <dbl> 478, 474, 470, 545, 446, 345, 568, 468, 310, 465, 503, 510…
```
...
#>  1 12      GUERRE… 12DP… MATU… IGNACI… GENE… 055     TAXCO … 0001    TAXCO …
#>  2 12      GUERRE… 12DP… MATU… IGNACI… GENE… 055     TAXCO … 0001    TAXCO …
#>  3 12      GUERRE… 12DP… MATU… IGNACI… GENE… 055     TAXCO … 0001    TAXCO …
#>  4 12      GUERRE… 12DP… MATU… IGNACI… GENE… 055     TAXCO … 0001    TAXCO …
#>  5 12      GUERRE… 12DP… MATU… IGNACI… GENE… 055     TAXCO … 0001    TAXCO …
#>  6 12      GUERRE… 12DP… MATU… IGNACI… GENE… 055     TAXCO … 0001    TAXCO …
#>  7 12      GUERRE… 12DP… MATU… IGNACI… GENE… 055     TAXCO … 0001    TAXCO …
#>  8 12      GUERRE… 12DP… MATU… IGNACI… GENE… 055     TAXCO … 0001    TAXCO …
#>  9 12      GUERRE… 12DP… MATU… IGNACI… GENE… 055     TAXCO … 0001    TAXCO …
#> 10 12      GUERRE… 12DP… MATU… IGNACI… GENE… 055     TAXCO … 0001    TAXCO …
...
#> $ CCT     <chr> "12DPR1925I", "12DPR1925I", "12DPR1925I", "12DPR1925I", "12DP…
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "…
#> $ ESCUELA <chr> "IGNACIO M. ALTAMIRANO", "IGNACIO M. ALTAMIRANO", "IGNACIO M.…
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENER…
#> $ CVE_MUN <chr> "055", "055", "055", "055", "055", "055", "055", "055", "055"…
#> $ NOM_MUN <chr> "TAXCO DE ALARCON", "TAXCO DE ALARCON", "TAXCO DE ALARCON", "…
#> $ CVE_LOC <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001", "0001…
#> $ NOM_LOC <chr> "TAXCO DE ALARCON", "TAXCO DE ALARCON", "TAXCO DE ALARCON", "…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", "FCE"…
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5, 5, 5…
#> $ PUNTAJE <dbl> 524, 597, 460, 635, 684, 562, 664, 714, 594, 533, 578, 478, 5…
```
...
#> $ CVE_ENT    <chr> "12", "12", "12", "12", "12", "12", "12", "12", "12", "12"…
#> $ NOM_ENT    <chr> "GUERRERO", "GUERRERO", "GUERRERO", "GUERRERO", "GUERRERO"…
#> $ CCT        <chr> "12DPR1925I", "12DPR1925I", "12DPR1925I", "12DPR1925I", "1…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO"…
#> $ ESCUELA    <chr> "IGNACIO M. ALTAMIRANO", "IGNACIO M. ALTAMIRANO", "IGNACIO…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GE…
#> $ CVE_MUN    <chr> "055", "055", "055", "055", "055", "055", "055", "055", "0…
#> $ NOM_MUN    <chr> "TAXCO DE ALARCON", "TAXCO DE ALARCON", "TAXCO DE ALARCON"…
#> $ CVE_LOC    <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001", "0…
#> $ NOM_LOC    <chr> "TAXCO DE ALARCON", "TAXCO DE ALARCON", "TAXCO DE ALARCON"…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4", "ESP…
#> $ PUNTAJE    <dbl> 524, 597, 460, 635, 684, 562, 664, 714, 594, 533, 578, 478…
```
