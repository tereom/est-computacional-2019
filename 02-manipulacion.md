...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "12", "17", "20", "07", "30", "14", "02", "02", "07",…
#> $ NOM_ENT    <chr> "GUERRERO", "MORELOS", "OAXACA", "CHIAPAS", "VERACRUZ…
#> $ CCT        <chr> "12DPR5951H", "17DPR0410Z", "20KPR0057V", "07KPR4086X…
#> $ TURNO      <chr> "MATUTINO", "VESPERTINO", "MATUTINO", "MATUTINO", "MA…
#> $ ESCUELA    <chr> "GREGORIO TORRES QUINTERO", "PROFR MANUEL M CERNA", "…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "CONAFE", "CONAFE", "GENERAL", …
#> $ CVE_MUN    <chr> "029", "008", "159", "079", "143", "053", "002", "004…
#> $ NOM_MUN    <chr> "CHILPANCINGO DE LOS BRAVO", "EMILIANO ZAPATA", "SAN …
#> $ CVE_LOC    <chr> "0001", "0001", "0012", "0029", "0068", "0380", "0282…
#> $ NOM_LOC    <chr> "CHILPANCINGO DE LOS BRAVO", "EMILIANO ZAPATA", "EL M…
#> $ PUNT_ESP_3 <dbl> 520, 506, 427, NA, 547, 395, 475, 498, 381, 374, 599,…
#> $ PUNT_MAT_3 <dbl> 545, 521, 417, NA, 588, 339, 500, 500, 399, 373, 582,…
#> $ PUNT_FCE_3 <dbl> 484, 454, 381, NA, 453, 354, 393, 447, 324, 423, 558,…
#> $ PUNT_ESP_4 <dbl> 446, 492, 445, 391, 514, 489, 398, 493, 377, 498, 592…
#> $ PUNT_MAT_4 <dbl> 469, 508, 498, 393, 577, 465, 438, 463, 396, 542, 544…
#> $ PUNT_FCE_4 <dbl> 404, 427, 425, 356, 451, 412, 415, 457, 412, 557, 554…
#> $ PUNT_ESP_5 <dbl> 556, 555, 388, NA, 591, NA, 422, 511, 441, 449, 658, …
#> $ PUNT_MAT_5 <dbl> 632, 629, 484, NA, 631, NA, 410, 505, 422, 402, 607, …
#> $ PUNT_FCE_5 <dbl> 495, 522, 371, NA, 555, NA, 416, 464, 423, 371, 581, …
#> $ PUNT_ESP_6 <dbl> 498, 470, 403, 383, 580, 545, 487, 491, NA, 430, 548,…
#> $ PUNT_MAT_6 <dbl> 617, 619, 470, 340, 669, 517, 492, 498, NA, 432, 691,…
#> $ PUNT_FCE_6 <dbl> 472, 436, 426, 368, 464, 496, 443, 484, NA, 448, 497,…
```
...
#>  1 12      GUERRE… 12DP… MATU… GREGOR… GENE… 029     CHILPA… 0001   
#>  2 12      GUERRE… 12DP… MATU… GREGOR… GENE… 029     CHILPA… 0001   
#>  3 12      GUERRE… 12DP… MATU… GREGOR… GENE… 029     CHILPA… 0001   
#>  4 12      GUERRE… 12DP… MATU… GREGOR… GENE… 029     CHILPA… 0001   
#>  5 12      GUERRE… 12DP… MATU… GREGOR… GENE… 029     CHILPA… 0001   
#>  6 12      GUERRE… 12DP… MATU… GREGOR… GENE… 029     CHILPA… 0001   
#>  7 12      GUERRE… 12DP… MATU… GREGOR… GENE… 029     CHILPA… 0001   
#>  8 12      GUERRE… 12DP… MATU… GREGOR… GENE… 029     CHILPA… 0001   
#>  9 12      GUERRE… 12DP… MATU… GREGOR… GENE… 029     CHILPA… 0001   
#> 10 12      GUERRE… 12DP… MATU… GREGOR… GENE… 029     CHILPA… 0001   
...
#> $ CCT     <chr> "12DPR5951H", "12DPR5951H", "12DPR5951H", "12DPR5951H", …
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA <chr> "GREGORIO TORRES QUINTERO", "GREGORIO TORRES QUINTERO", …
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "…
#> $ CVE_MUN <chr> "029", "029", "029", "029", "029", "029", "029", "029", …
#> $ NOM_MUN <chr> "CHILPANCINGO DE LOS BRAVO", "CHILPANCINGO DE LOS BRAVO"…
#> $ CVE_LOC <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001", …
#> $ NOM_LOC <chr> "CHILPANCINGO DE LOS BRAVO", "CHILPANCINGO DE LOS BRAVO"…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", …
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5,…
#> $ PUNTAJE <dbl> 520, 545, 484, 446, 469, 404, 556, 632, 495, 498, 617, 4…
```
...
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL"…
#> $ CVE_MUN    <chr> "029", "029", "029", "029", "029", "029", "029", "029…
#> $ NOM_MUN    <chr> "CHILPANCINGO DE LOS BRAVO", "CHILPANCINGO DE LOS BRA…
#> $ CVE_LOC    <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001…
#> $ NOM_LOC    <chr> "CHILPANCINGO DE LOS BRAVO", "CHILPANCINGO DE LOS BRA…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4",…
#> $ PUNTAJE    <dbl> 520, 545, 484, 446, 469, 404, 556, 632, 495, 498, 617…
```
