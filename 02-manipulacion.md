...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "12", "30", "26", "21", "02", "07", "09", "26", "30",…
#> $ NOM_ENT    <chr> "GUERRERO", "VERACRUZ", "SONORA", "PUEBLA", "BAJA CAL…
#> $ CCT        <chr> "12EPR0695Z", "30DPR3934T", "26EPR0052J", "21DPR1941H…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "MOCTEZUMA ILHUICAMINA", "REVOLUCION SOCIAL", "CLOTIL…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "PARTICUL…
#> $ CVE_MUN    <chr> "057", "160", "018", "043", "004", "026", "012", "042…
#> $ NOM_MUN    <chr> "TECPAN DE GALEANA", "TEMAPACHE", "CAJEME", "CUETZALA…
#> $ CVE_LOC    <chr> "0114", "0073", "0284", "0015", "0001", "0126", "0099…
#> $ NOM_LOC    <chr> "EL PORVENIR", "LOMAS DE VINAZCO", "COCORIT", "PEPEXT…
#> $ PUNT_ESP_3 <dbl> 534, 573, 535, 632, 622, 370, 548, 658, 422, 549, 485…
#> $ PUNT_MAT_3 <dbl> 558, 593, 537, 687, 666, 404, 573, 689, 459, 569, 547…
#> $ PUNT_FCE_3 <dbl> 488, 499, 474, 493, 577, 409, 489, 608, 375, 475, 419…
#> $ PUNT_ESP_4 <dbl> 518, 546, 624, 541, 638, 385, 530, 696, 504, 486, 469…
#> $ PUNT_MAT_4 <dbl> 536, 569, 655, 604, 665, 393, 585, 799, 527, 505, 480…
#> $ PUNT_FCE_4 <dbl> 482, 487, 574, 501, 563, 366, 476, 656, 484, 431, 446…
#> $ PUNT_ESP_5 <dbl> 386, 600, 510, 562, 630, 351, 569, 538, 456, 433, 498…
#> $ PUNT_MAT_5 <dbl> 423, 660, 539, 564, 661, 330, 607, 531, 558, 483, 536…
#> $ PUNT_FCE_5 <dbl> 373, 556, 485, 455, 583, 340, 512, 470, 414, 428, 432…
#> $ PUNT_ESP_6 <dbl> 451, 587, 507, 522, 673, 365, 492, 712, 484, 469, 452…
#> $ PUNT_MAT_6 <dbl> 500, 652, 509, 675, 677, 339, 512, 776, 525, 503, 432…
#> $ PUNT_FCE_6 <dbl> 425, 556, 459, 533, 582, 322, 432, 588, 455, 433, 367…
```
...
#>  1 12      GUERRE… 12EP… MATU… MOCTEZ… GENE… 057     TECPAN… 0114   
#>  2 12      GUERRE… 12EP… MATU… MOCTEZ… GENE… 057     TECPAN… 0114   
#>  3 12      GUERRE… 12EP… MATU… MOCTEZ… GENE… 057     TECPAN… 0114   
#>  4 12      GUERRE… 12EP… MATU… MOCTEZ… GENE… 057     TECPAN… 0114   
#>  5 12      GUERRE… 12EP… MATU… MOCTEZ… GENE… 057     TECPAN… 0114   
#>  6 12      GUERRE… 12EP… MATU… MOCTEZ… GENE… 057     TECPAN… 0114   
#>  7 12      GUERRE… 12EP… MATU… MOCTEZ… GENE… 057     TECPAN… 0114   
#>  8 12      GUERRE… 12EP… MATU… MOCTEZ… GENE… 057     TECPAN… 0114   
#>  9 12      GUERRE… 12EP… MATU… MOCTEZ… GENE… 057     TECPAN… 0114   
#> 10 12      GUERRE… 12EP… MATU… MOCTEZ… GENE… 057     TECPAN… 0114   
...
#> Observations: 12,000
#> Variables: 13
#> $ CVE_ENT <chr> "12", "12", "12", "12", "12", "12", "12", "12", "12", "1…
#> $ NOM_ENT <chr> "GUERRERO", "GUERRERO", "GUERRERO", "GUERRERO", "GUERRER…
#> $ CCT     <chr> "12EPR0695Z", "12EPR0695Z", "12EPR0695Z", "12EPR0695Z", …
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA <chr> "MOCTEZUMA ILHUICAMINA", "MOCTEZUMA ILHUICAMINA", "MOCTE…
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "…
#> $ CVE_MUN <chr> "057", "057", "057", "057", "057", "057", "057", "057", …
#> $ NOM_MUN <chr> "TECPAN DE GALEANA", "TECPAN DE GALEANA", "TECPAN DE GAL…
#> $ CVE_LOC <chr> "0114", "0114", "0114", "0114", "0114", "0114", "0114", …
#> $ NOM_LOC <chr> "EL PORVENIR", "EL PORVENIR", "EL PORVENIR", "EL PORVENI…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", …
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5,…
#> $ PUNTAJE <dbl> 534, 558, 488, 518, 536, 482, 386, 423, 373, 451, 500, 4…
```
...
#> Observations: 12,000
#> Variables: 12
#> $ CVE_ENT    <chr> "12", "12", "12", "12", "12", "12", "12", "12", "12",…
#> $ NOM_ENT    <chr> "GUERRERO", "GUERRERO", "GUERRERO", "GUERRERO", "GUER…
#> $ CCT        <chr> "12EPR0695Z", "12EPR0695Z", "12EPR0695Z", "12EPR0695Z…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "MOCTEZUMA ILHUICAMINA", "MOCTEZUMA ILHUICAMINA", "MO…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL"…
#> $ CVE_MUN    <chr> "057", "057", "057", "057", "057", "057", "057", "057…
#> $ NOM_MUN    <chr> "TECPAN DE GALEANA", "TECPAN DE GALEANA", "TECPAN DE …
#> $ CVE_LOC    <chr> "0114", "0114", "0114", "0114", "0114", "0114", "0114…
#> $ NOM_LOC    <chr> "EL PORVENIR", "EL PORVENIR", "EL PORVENIR", "EL PORV…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4",…
#> $ PUNTAJE    <dbl> 534, 558, 488, 518, 536, 482, 386, 423, 373, 451, 500…
```
