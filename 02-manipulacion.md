...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "14", "21", "07", "30", "13", "07", "19", "15", "11",…
#> $ NOM_ENT    <chr> "JALISCO", "PUEBLA", "CHIAPAS", "VERACRUZ", "HIDALGO"…
#> $ CCT        <chr> "14DPR2806Z", "21DPR2096Z", "07KPB0136M", "30DPR2027L…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "20 DE NOVIEMBRE", "MARIANO ANTONIO TAPIA", "LUQUILHO…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "CONAFE", "GENERAL", "GENERAL",…
#> $ CVE_MUN    <chr> "098", "047", "049", "175", "068", "026", "006", "096…
#> $ NOM_MUN    <chr> "SAN PEDRO TLAQUEPAQUE", "CHIAUTLA", "LARRAINZAR", "T…
#> $ CVE_LOC    <chr> "0017", "0001", "0023", "0096", "0033", "0158", "0384…
#> $ NOM_LOC    <chr> "SAN MARTIN DE LAS FLORES DE ABAJO", "CHIAUTLA DE TAP…
#> $ PUNT_ESP_3 <dbl> 579, 502, 361, 471, 484, 450, 599, 538, 599, 614, NA,…
#> $ PUNT_MAT_3 <dbl> 631, 509, 396, 495, 510, 521, 684, 580, 575, 735, NA,…
#> $ PUNT_FCE_3 <dbl> 525, 473, 379, 445, 419, 351, 574, 457, 539, 563, NA,…
#> $ PUNT_ESP_4 <dbl> 607, 450, 381, 491, 435, 401, 546, 498, 578, 680, 409…
#> $ PUNT_MAT_4 <dbl> 685, 484, 436, 481, 477, 387, 581, 497, 577, 774, 379…
#> $ PUNT_FCE_4 <dbl> 565, 429, 397, 418, 383, 381, 508, 425, 500, 679, 433…
#> $ PUNT_ESP_5 <dbl> 543, 509, 470, 499, 417, NA, 644, 511, 536, 469, 500,…
#> $ PUNT_MAT_5 <dbl> 629, 527, 459, 509, 444, NA, 663, 519, 593, 423, 456,…
#> $ PUNT_FCE_5 <dbl> 500, 477, 409, 440, 404, NA, 585, 460, 526, 380, 418,…
#> $ PUNT_ESP_6 <dbl> 520, 475, 379, 548, 434, NA, 619, 515, 593, 642, NA, …
#> $ PUNT_MAT_6 <dbl> 620, 545, 406, 555, 450, NA, 665, 570, 630, 648, NA, …
#> $ PUNT_FCE_6 <dbl> 473, 450, 338, 536, 454, NA, 568, 461, 503, 609, NA, …
```
...
#>  1 14      JALISCO 14DP… MATU… 20 DE … GENE… 098     SAN PE… 0017   
#>  2 14      JALISCO 14DP… MATU… 20 DE … GENE… 098     SAN PE… 0017   
#>  3 14      JALISCO 14DP… MATU… 20 DE … GENE… 098     SAN PE… 0017   
#>  4 14      JALISCO 14DP… MATU… 20 DE … GENE… 098     SAN PE… 0017   
#>  5 14      JALISCO 14DP… MATU… 20 DE … GENE… 098     SAN PE… 0017   
#>  6 14      JALISCO 14DP… MATU… 20 DE … GENE… 098     SAN PE… 0017   
#>  7 14      JALISCO 14DP… MATU… 20 DE … GENE… 098     SAN PE… 0017   
#>  8 14      JALISCO 14DP… MATU… 20 DE … GENE… 098     SAN PE… 0017   
#>  9 14      JALISCO 14DP… MATU… 20 DE … GENE… 098     SAN PE… 0017   
#> 10 14      JALISCO 14DP… MATU… 20 DE … GENE… 098     SAN PE… 0017   
...
#> Observations: 12,000
#> Variables: 13
#> $ CVE_ENT <chr> "14", "14", "14", "14", "14", "14", "14", "14", "14", "1…
#> $ NOM_ENT <chr> "JALISCO", "JALISCO", "JALISCO", "JALISCO", "JALISCO", "…
#> $ CCT     <chr> "14DPR2806Z", "14DPR2806Z", "14DPR2806Z", "14DPR2806Z", …
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA <chr> "20 DE NOVIEMBRE", "20 DE NOVIEMBRE", "20 DE NOVIEMBRE",…
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "…
#> $ CVE_MUN <chr> "098", "098", "098", "098", "098", "098", "098", "098", …
#> $ NOM_MUN <chr> "SAN PEDRO TLAQUEPAQUE", "SAN PEDRO TLAQUEPAQUE", "SAN P…
#> $ CVE_LOC <chr> "0017", "0017", "0017", "0017", "0017", "0017", "0017", …
#> $ NOM_LOC <chr> "SAN MARTIN DE LAS FLORES DE ABAJO", "SAN MARTIN DE LAS …
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", …
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5,…
#> $ PUNTAJE <dbl> 579, 631, 525, 607, 685, 565, 543, 629, 500, 520, 620, 4…
```
...
#> Observations: 12,000
#> Variables: 12
#> $ CVE_ENT    <chr> "14", "14", "14", "14", "14", "14", "14", "14", "14",…
#> $ NOM_ENT    <chr> "JALISCO", "JALISCO", "JALISCO", "JALISCO", "JALISCO"…
#> $ CCT        <chr> "14DPR2806Z", "14DPR2806Z", "14DPR2806Z", "14DPR2806Z…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "20 DE NOVIEMBRE", "20 DE NOVIEMBRE", "20 DE NOVIEMBR…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL"…
#> $ CVE_MUN    <chr> "098", "098", "098", "098", "098", "098", "098", "098…
#> $ NOM_MUN    <chr> "SAN PEDRO TLAQUEPAQUE", "SAN PEDRO TLAQUEPAQUE", "SA…
#> $ CVE_LOC    <chr> "0017", "0017", "0017", "0017", "0017", "0017", "0017…
#> $ NOM_LOC    <chr> "SAN MARTIN DE LAS FLORES DE ABAJO", "SAN MARTIN DE L…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4",…
#> $ PUNTAJE    <dbl> 579, 631, 525, 607, 685, 565, 543, 629, 500, 520, 620…
```
