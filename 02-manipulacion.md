...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "21", "07", "16", "15", "26", "14", "13", "12", "12",…
#> $ NOM_ENT    <chr> "PUEBLA", "CHIAPAS", "MICHOACAN", "MEXICO", "SONORA",…
#> $ CCT        <chr> "21DPB0859Z", "07DPR0943F", "16KPR1277A", "15DPR0795W…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "RICARDO FLORES MAGON", "FRANCISCO INDALECIO MADERO",…
#> $ TIPO       <chr> "INDêGENA", "GENERAL", "CONAFE", "GENERAL", "GENERAL"…
#> $ CVE_MUN    <chr> "186", "020", "057", "070", "018", "044", "024", "052…
#> $ NOM_MUN    <chr> "TLATLAUQUITEPEC", "LA CONCORDIA", "NOCUPETARO", "LA …
#> $ CVE_LOC    <chr> "0024", "0158", "0010", "0001", "0404", "0005", "0006…
#> $ NOM_LOC    <chr> "OCOTLAN", "EL ESPINAL", "APARANDAN", "LOS REYES ACAQ…
#> $ PUNT_ESP_3 <dbl> 552, 628, 451, 573, 612, 474, 472, 520, 718, 491, 477…
#> $ PUNT_MAT_3 <dbl> 646, 734, 604, 616, 647, 515, 451, 630, 693, 540, 507…
#> $ PUNT_FCE_3 <dbl> 472, 574, 351, 497, 472, 412, 414, 506, 633, 458, 414…
#> $ PUNT_ESP_4 <dbl> 491, 347, 539, 553, 441, 519, 416, 367, 655, 434, 434…
#> $ PUNT_MAT_4 <dbl> 526, 428, 673, 585, 480, 527, 428, 404, 706, 455, 477…
#> $ PUNT_FCE_4 <dbl> 484, 390, 535, 506, 418, 428, 402, 385, 650, 403, 407…
#> $ PUNT_ESP_5 <dbl> 516, 457, NA, 551, 564, 480, 491, 366, 448, 483, 462,…
#> $ PUNT_MAT_5 <dbl> 528, 486, NA, 582, 583, 499, 494, 428, 432, 484, 511,…
#> $ PUNT_FCE_5 <dbl> 464, 461, NA, 496, 505, 413, 475, 382, 424, 467, 496,…
#> $ PUNT_ESP_6 <dbl> 466, 452, 601, 549, 539, 476, 482, 448, 664, 460, 408…
#> $ PUNT_MAT_6 <dbl> 586, 415, 698, 628, 629, 456, 469, 514, 790, 467, 471…
#> $ PUNT_FCE_6 <dbl> 491, 430, 464, 519, 515, 451, 456, 487, 502, 429, 453…
```
...
#>  1 21      PUEBLA  21DP… MATU… RICARD… INDê… 186     TLATLA… 0024   
#>  2 21      PUEBLA  21DP… MATU… RICARD… INDê… 186     TLATLA… 0024   
#>  3 21      PUEBLA  21DP… MATU… RICARD… INDê… 186     TLATLA… 0024   
#>  4 21      PUEBLA  21DP… MATU… RICARD… INDê… 186     TLATLA… 0024   
#>  5 21      PUEBLA  21DP… MATU… RICARD… INDê… 186     TLATLA… 0024   
#>  6 21      PUEBLA  21DP… MATU… RICARD… INDê… 186     TLATLA… 0024   
#>  7 21      PUEBLA  21DP… MATU… RICARD… INDê… 186     TLATLA… 0024   
#>  8 21      PUEBLA  21DP… MATU… RICARD… INDê… 186     TLATLA… 0024   
#>  9 21      PUEBLA  21DP… MATU… RICARD… INDê… 186     TLATLA… 0024   
#> 10 21      PUEBLA  21DP… MATU… RICARD… INDê… 186     TLATLA… 0024   
...
#> Observations: 12,000
#> Variables: 13
#> $ CVE_ENT <chr> "21", "21", "21", "21", "21", "21", "21", "21", "21", "2…
#> $ NOM_ENT <chr> "PUEBLA", "PUEBLA", "PUEBLA", "PUEBLA", "PUEBLA", "PUEBL…
#> $ CCT     <chr> "21DPB0859Z", "21DPB0859Z", "21DPB0859Z", "21DPB0859Z", …
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA <chr> "RICARDO FLORES MAGON", "RICARDO FLORES MAGON", "RICARDO…
#> $ TIPO    <chr> "INDêGENA", "INDêGENA", "INDêGENA", "INDêGENA", "INDêGEN…
#> $ CVE_MUN <chr> "186", "186", "186", "186", "186", "186", "186", "186", …
#> $ NOM_MUN <chr> "TLATLAUQUITEPEC", "TLATLAUQUITEPEC", "TLATLAUQUITEPEC",…
#> $ CVE_LOC <chr> "0024", "0024", "0024", "0024", "0024", "0024", "0024", …
#> $ NOM_LOC <chr> "OCOTLAN", "OCOTLAN", "OCOTLAN", "OCOTLAN", "OCOTLAN", "…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", …
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5,…
#> $ PUNTAJE <dbl> 552, 646, 472, 491, 526, 484, 516, 528, 464, 466, 586, 4…
```
...
#> Observations: 12,000
#> Variables: 12
#> $ CVE_ENT    <chr> "21", "21", "21", "21", "21", "21", "21", "21", "21",…
#> $ NOM_ENT    <chr> "PUEBLA", "PUEBLA", "PUEBLA", "PUEBLA", "PUEBLA", "PU…
#> $ CCT        <chr> "21DPB0859Z", "21DPB0859Z", "21DPB0859Z", "21DPB0859Z…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "RICARDO FLORES MAGON", "RICARDO FLORES MAGON", "RICA…
#> $ TIPO       <chr> "INDêGENA", "INDêGENA", "INDêGENA", "INDêGENA", "INDê…
#> $ CVE_MUN    <chr> "186", "186", "186", "186", "186", "186", "186", "186…
#> $ NOM_MUN    <chr> "TLATLAUQUITEPEC", "TLATLAUQUITEPEC", "TLATLAUQUITEPE…
#> $ CVE_LOC    <chr> "0024", "0024", "0024", "0024", "0024", "0024", "0024…
#> $ NOM_LOC    <chr> "OCOTLAN", "OCOTLAN", "OCOTLAN", "OCOTLAN", "OCOTLAN"…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4",…
#> $ PUNTAJE    <dbl> 552, 646, 472, 491, 526, 484, 516, 528, 464, 466, 586…
```
