...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "30", "11", "12", "14", "17", "22", "13", "13", "09", "14"…
#> $ NOM_ENT    <chr> "VERACRUZ", "GUANAJUATO", "GUERRERO", "JALISCO", "MORELOS"…
#> $ CCT        <chr> "30DPR3137Y", "11DPR0287W", "12DPR3020J", "14EPR0760G", "1…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "VESPERTINO", "MATUTIN…
#> $ ESCUELA    <chr> "CONSTITUCION", "MORELOS", "16 DE SEPTIEMBRE", "MIGUEL HID…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GE…
#> $ CVE_MUN    <chr> "059", "033", "031", "039", "022", "001", "035", "028", "0…
#> $ NOM_MUN    <chr> "CHINAMECA", "SAN LUIS DE LA PAZ", "GENERAL CANUTO A. NERI…
#> $ CVE_LOC    <chr> "0010", "0037", "0001", "0001", "9999", "0034", "0003", "0…
#> $ NOM_LOC    <chr> "LOS CERRITOS", "COVADONGA", "ACAPETLAHUAYA", "GUADALAJARA…
#> $ PUNT_ESP_3 <dbl> 513, 551, 685, 541, 438, 686, 477, 466, 594, 535, 504, NA,…
#> $ PUNT_MAT_3 <dbl> 533, 606, 799, 547, 443, 767, 518, 477, 649, 621, 539, NA,…
#> $ PUNT_FCE_3 <dbl> 437, 482, 603, 474, 359, 620, 460, 436, 528, 461, 403, NA,…
#> $ PUNT_ESP_4 <dbl> 529, 466, 585, 719, 459, 442, 441, 465, 593, 540, 424, NA,…
#> $ PUNT_MAT_4 <dbl> 596, 514, 606, 770, 472, 534, 494, 511, 576, 583, 422, NA,…
#> $ PUNT_FCE_4 <dbl> 451, 407, 562, 617, 444, 383, 442, 459, 510, 489, 396, NA,…
#> $ PUNT_ESP_5 <dbl> 466, 489, 592, 651, 448, 469, 423, 459, 602, 556, 334, 481…
#> $ PUNT_MAT_5 <dbl> 463, 511, 653, 686, 480, 460, 509, 537, 613, 597, 414, 602…
#> $ PUNT_FCE_5 <dbl> 441, 410, 537, 577, 435, 388, 443, 488, 553, 463, 348, 501…
#> $ PUNT_ESP_6 <dbl> 458, 519, 592, 811, 527, 457, 433, 408, 537, 573, 454, NA,…
#> $ PUNT_MAT_6 <dbl> 476, 560, 686, 811, 510, 517, 438, 433, 568, 676, 401, NA,…
#> $ PUNT_FCE_6 <dbl> 392, 476, 548, 604, 454, 464, 360, 427, 495, 539, 392, NA,…
```
...
#>  1 30      VERACR… 30DP… MATU… CONSTI… GENE… 059     CHINAM… 0010    LOS CE…
#>  2 30      VERACR… 30DP… MATU… CONSTI… GENE… 059     CHINAM… 0010    LOS CE…
#>  3 30      VERACR… 30DP… MATU… CONSTI… GENE… 059     CHINAM… 0010    LOS CE…
#>  4 30      VERACR… 30DP… MATU… CONSTI… GENE… 059     CHINAM… 0010    LOS CE…
#>  5 30      VERACR… 30DP… MATU… CONSTI… GENE… 059     CHINAM… 0010    LOS CE…
#>  6 30      VERACR… 30DP… MATU… CONSTI… GENE… 059     CHINAM… 0010    LOS CE…
#>  7 30      VERACR… 30DP… MATU… CONSTI… GENE… 059     CHINAM… 0010    LOS CE…
#>  8 30      VERACR… 30DP… MATU… CONSTI… GENE… 059     CHINAM… 0010    LOS CE…
#>  9 30      VERACR… 30DP… MATU… CONSTI… GENE… 059     CHINAM… 0010    LOS CE…
#> 10 30      VERACR… 30DP… MATU… CONSTI… GENE… 059     CHINAM… 0010    LOS CE…
...
#> $ CCT     <chr> "30DPR3137Y", "30DPR3137Y", "30DPR3137Y", "30DPR3137Y", "30DP…
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "…
#> $ ESCUELA <chr> "CONSTITUCION", "CONSTITUCION", "CONSTITUCION", "CONSTITUCION…
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENER…
#> $ CVE_MUN <chr> "059", "059", "059", "059", "059", "059", "059", "059", "059"…
#> $ NOM_MUN <chr> "CHINAMECA", "CHINAMECA", "CHINAMECA", "CHINAMECA", "CHINAMEC…
#> $ CVE_LOC <chr> "0010", "0010", "0010", "0010", "0010", "0010", "0010", "0010…
#> $ NOM_LOC <chr> "LOS CERRITOS", "LOS CERRITOS", "LOS CERRITOS", "LOS CERRITOS…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", "FCE"…
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5, 5, 5…
#> $ PUNTAJE <dbl> 513, 533, 437, 529, 596, 451, 466, 463, 441, 458, 476, 392, 5…
```
...
#> $ CVE_ENT    <chr> "30", "30", "30", "30", "30", "30", "30", "30", "30", "30"…
#> $ NOM_ENT    <chr> "VERACRUZ", "VERACRUZ", "VERACRUZ", "VERACRUZ", "VERACRUZ"…
#> $ CCT        <chr> "30DPR3137Y", "30DPR3137Y", "30DPR3137Y", "30DPR3137Y", "3…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO"…
#> $ ESCUELA    <chr> "CONSTITUCION", "CONSTITUCION", "CONSTITUCION", "CONSTITUC…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GE…
#> $ CVE_MUN    <chr> "059", "059", "059", "059", "059", "059", "059", "059", "0…
#> $ NOM_MUN    <chr> "CHINAMECA", "CHINAMECA", "CHINAMECA", "CHINAMECA", "CHINA…
#> $ CVE_LOC    <chr> "0010", "0010", "0010", "0010", "0010", "0010", "0010", "0…
#> $ NOM_LOC    <chr> "LOS CERRITOS", "LOS CERRITOS", "LOS CERRITOS", "LOS CERRI…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4", "ESP…
#> $ PUNTAJE    <dbl> 513, 533, 437, 529, 596, 451, 466, 463, 441, 458, 476, 392…
```
