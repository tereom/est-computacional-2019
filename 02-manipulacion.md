...
funcionalidad menor limitada y son menos intutivas. Para instalar la versión 
de GitHub corre:
...
[Aquí](https://tereom.github.io/tutoriales/datos_limpios.html) puedes
encontrar una versión de las notas usando `gather()` y `spread()`.
...
<img src="02-manipulacion_files/figure-html/unnamed-chunk-58-1.png" width="672" style="display: block; margin: auto;" />
...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "27", "14", "31", "21", "21", "16", "10", "13", "15",…
#> $ NOM_ENT    <chr> "TABASCO", "JALISCO", "YUCATAN", "PUEBLA", "PUEBLA", …
#> $ CCT        <chr> "27DPR1144G", "14DPR0238K", "31PPR0009M", "21PPR0704D…
#> $ TURNO      <chr> "MATUTINO", "VESPERTINO", "MATUTINO", "MATUTINO", "MA…
#> $ ESCUELA    <chr> "PROFR. ALCIDES FLOTA OROPEZA", "PEDRO L OGAZON", "CE…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "PARTICULAR", "PARTICULAR", "GE…
#> $ CVE_MUN    <chr> "004", "039", "050", "114", "208", "076", "026", "028…
#> $ NOM_MUN    <chr> "CENTRO", "GUADALAJARA", "MERIDA", "PUEBLA", "ZACATLA…
#> $ CVE_LOC    <chr> "0214", "0001", "0001", "0001", "0021", "0001", "9968…
#> $ NOM_LOC    <chr> "OCUILTZAPOTLAN", "GUADALAJARA", "MERIDA", "HEROICA P…
#> $ PUNT_ESP_3 <dbl> 523, 509, 683, 665, 477, 500, 567, 755, 513, 525, 489…
#> $ PUNT_MAT_3 <dbl> 543, 519, 715, 686, 475, 489, 644, 740, 557, 545, 534…
#> $ PUNT_FCE_3 <dbl> 520, 431, 619, 619, 468, 447, 511, 709, 472, 458, 441…
#> $ PUNT_ESP_4 <dbl> 594, 482, 692, 552, 388, 545, 501, 658, 487, 548, 449…
#> $ PUNT_MAT_4 <dbl> 634, 495, 690, 530, 397, 533, 513, 752, 521, 578, 470…
#> $ PUNT_FCE_4 <dbl> 547, 436, 609, 512, 389, 486, 423, 632, 451, 477, 450…
#> $ PUNT_ESP_5 <dbl> 509, 527, 669, 585, 452, 490, 557, 726, 547, 553, 554…
#> $ PUNT_MAT_5 <dbl> 545, 546, 697, 603, 443, 526, 621, 637, 558, 579, 501…
#> $ PUNT_FCE_5 <dbl> 457, 468, 601, 554, 427, 424, 465, 528, 520, 516, 607…
#> $ PUNT_ESP_6 <dbl> 536, 505, 689, 663, 404, 454, 573, 652, 503, 547, 399…
#> $ PUNT_MAT_6 <dbl> 573, 541, 689, 705, 367, 499, 617, 703, 562, 578, 427…
#> $ PUNT_FCE_6 <dbl> 464, 469, 576, 582, 361, 423, 509, 610, 485, 516, 411…
```
...
#>  1 27      TABASCO 27DP… MATU… PROFR.… GENE… 004     CENTRO  0214   
#>  2 27      TABASCO 27DP… MATU… PROFR.… GENE… 004     CENTRO  0214   
#>  3 27      TABASCO 27DP… MATU… PROFR.… GENE… 004     CENTRO  0214   
#>  4 27      TABASCO 27DP… MATU… PROFR.… GENE… 004     CENTRO  0214   
#>  5 27      TABASCO 27DP… MATU… PROFR.… GENE… 004     CENTRO  0214   
#>  6 27      TABASCO 27DP… MATU… PROFR.… GENE… 004     CENTRO  0214   
#>  7 27      TABASCO 27DP… MATU… PROFR.… GENE… 004     CENTRO  0214   
#>  8 27      TABASCO 27DP… MATU… PROFR.… GENE… 004     CENTRO  0214   
#>  9 27      TABASCO 27DP… MATU… PROFR.… GENE… 004     CENTRO  0214   
#> 10 27      TABASCO 27DP… MATU… PROFR.… GENE… 004     CENTRO  0214   
...
#> Observations: 12,000
#> Variables: 13
#> $ CVE_ENT <chr> "27", "27", "27", "27", "27", "27", "27", "27", "27", "2…
#> $ NOM_ENT <chr> "TABASCO", "TABASCO", "TABASCO", "TABASCO", "TABASCO", "…
#> $ CCT     <chr> "27DPR1144G", "27DPR1144G", "27DPR1144G", "27DPR1144G", …
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA <chr> "PROFR. ALCIDES FLOTA OROPEZA", "PROFR. ALCIDES FLOTA OR…
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "…
#> $ CVE_MUN <chr> "004", "004", "004", "004", "004", "004", "004", "004", …
#> $ NOM_MUN <chr> "CENTRO", "CENTRO", "CENTRO", "CENTRO", "CENTRO", "CENTR…
#> $ CVE_LOC <chr> "0214", "0214", "0214", "0214", "0214", "0214", "0214", …
#> $ NOM_LOC <chr> "OCUILTZAPOTLAN", "OCUILTZAPOTLAN", "OCUILTZAPOTLAN", "O…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", …
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5,…
#> $ PUNTAJE <dbl> 523, 543, 520, 594, 634, 547, 509, 545, 457, 536, 573, 4…
```
...
#> Observations: 12,000
#> Variables: 12
#> $ CVE_ENT    <chr> "27", "27", "27", "27", "27", "27", "27", "27", "27",…
#> $ NOM_ENT    <chr> "TABASCO", "TABASCO", "TABASCO", "TABASCO", "TABASCO"…
#> $ CCT        <chr> "27DPR1144G", "27DPR1144G", "27DPR1144G", "27DPR1144G…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "PROFR. ALCIDES FLOTA OROPEZA", "PROFR. ALCIDES FLOTA…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL"…
#> $ CVE_MUN    <chr> "004", "004", "004", "004", "004", "004", "004", "004…
#> $ NOM_MUN    <chr> "CENTRO", "CENTRO", "CENTRO", "CENTRO", "CENTRO", "CE…
#> $ CVE_LOC    <chr> "0214", "0214", "0214", "0214", "0214", "0214", "0214…
#> $ NOM_LOC    <chr> "OCUILTZAPOTLAN", "OCUILTZAPOTLAN", "OCUILTZAPOTLAN",…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4",…
#> $ PUNTAJE    <dbl> 523, 543, 520, 594, 634, 547, 509, 545, 457, 536, 573…
```
