...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "10", "30", "15", "30", "15", "07", "15", "31", "13",…
#> $ NOM_ENT    <chr> "DURANGO", "VERACRUZ", "MEXICO", "VERACRUZ", "MEXICO"…
#> $ CCT        <chr> "10DPR0530T", "30DPR0511S", "15DPR2698H", "30EPR0874Z…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "VESP…
#> $ ESCUELA    <chr> "LIC. MARINO CASTILLO NAJERA", "LIC. MIGUEL ALEMAN", …
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL"…
#> $ CVE_MUN    <chr> "007", "123", "033", "065", "081", "003", "104", "103…
#> $ NOM_MUN    <chr> "GOMEZ PALACIO", "PANUCO", "ECATEPEC DE MORELOS", "EM…
#> $ CVE_LOC    <chr> "0001", "0012", "0001", "0001", "0001", "0103", "0001…
#> $ NOM_LOC    <chr> "GOMEZ PALACIO", "TAMBOYOCHE Y TOPILA", "ECATEPEC DE …
#> $ PUNT_ESP_3 <dbl> 452, 593, 501, 574, 551, 695, 625, 569, 664, 491, 527…
#> $ PUNT_MAT_3 <dbl> 479, 516, 542, 617, 590, 710, 697, 590, 776, 513, 540…
#> $ PUNT_FCE_3 <dbl> 417, 516, 452, 474, 487, 580, 566, 504, 557, 420, 473…
#> $ PUNT_ESP_4 <dbl> 458, 492, 501, 548, 564, 809, 741, 501, 656, 456, 550…
#> $ PUNT_MAT_4 <dbl> 475, 506, 503, 570, 579, 795, 779, 482, 743, 483, 545…
#> $ PUNT_FCE_4 <dbl> 450, 467, 446, 504, 510, 691, 603, 459, 584, 433, 477…
#> $ PUNT_ESP_5 <dbl> 450, NA, 501, 580, 578, 740, 681, 574, 731, 540, 576,…
#> $ PUNT_MAT_5 <dbl> 461, NA, 557, 611, 601, 821, 703, 602, 795, 547, 583,…
#> $ PUNT_FCE_5 <dbl> 434, NA, 468, 534, 513, 649, 615, 523, 668, 486, 497,…
#> $ PUNT_ESP_6 <dbl> 496, 320, 520, 579, 523, 766, 617, 653, 743, 427, 554…
#> $ PUNT_MAT_6 <dbl> 476, 352, 557, 640, 526, 769, 724, 653, 838, 437, 586…
#> $ PUNT_FCE_6 <dbl> 461, 327, 463, 513, 493, 599, 589, 546, 647, 440, 494…
```
...
#>  1 10      DURANGO 10DP… MATU… LIC. M… GENE… 007     GOMEZ … 0001   
#>  2 10      DURANGO 10DP… MATU… LIC. M… GENE… 007     GOMEZ … 0001   
#>  3 10      DURANGO 10DP… MATU… LIC. M… GENE… 007     GOMEZ … 0001   
#>  4 10      DURANGO 10DP… MATU… LIC. M… GENE… 007     GOMEZ … 0001   
#>  5 10      DURANGO 10DP… MATU… LIC. M… GENE… 007     GOMEZ … 0001   
#>  6 10      DURANGO 10DP… MATU… LIC. M… GENE… 007     GOMEZ … 0001   
#>  7 10      DURANGO 10DP… MATU… LIC. M… GENE… 007     GOMEZ … 0001   
#>  8 10      DURANGO 10DP… MATU… LIC. M… GENE… 007     GOMEZ … 0001   
#>  9 10      DURANGO 10DP… MATU… LIC. M… GENE… 007     GOMEZ … 0001   
#> 10 10      DURANGO 10DP… MATU… LIC. M… GENE… 007     GOMEZ … 0001   
...
#> $ CCT     <chr> "10DPR0530T", "10DPR0530T", "10DPR0530T", "10DPR0530T", …
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA <chr> "LIC. MARINO CASTILLO NAJERA", "LIC. MARINO CASTILLO NAJ…
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "…
#> $ CVE_MUN <chr> "007", "007", "007", "007", "007", "007", "007", "007", …
#> $ NOM_MUN <chr> "GOMEZ PALACIO", "GOMEZ PALACIO", "GOMEZ PALACIO", "GOME…
#> $ CVE_LOC <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001", …
#> $ NOM_LOC <chr> "GOMEZ PALACIO", "GOMEZ PALACIO", "GOMEZ PALACIO", "GOME…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", …
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5,…
#> $ PUNTAJE <dbl> 452, 479, 417, 458, 475, 450, 450, 461, 434, 496, 476, 4…
```
...
#> $ ESCUELA    <chr> "LIC. MARINO CASTILLO NAJERA", "LIC. MARINO CASTILLO …
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL"…
#> $ CVE_MUN    <chr> "007", "007", "007", "007", "007", "007", "007", "007…
#> $ NOM_MUN    <chr> "GOMEZ PALACIO", "GOMEZ PALACIO", "GOMEZ PALACIO", "G…
#> $ CVE_LOC    <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001…
#> $ NOM_LOC    <chr> "GOMEZ PALACIO", "GOMEZ PALACIO", "GOMEZ PALACIO", "G…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4",…
#> $ PUNTAJE    <dbl> 452, 479, 417, 458, 475, 450, 450, 461, 434, 496, 476…
```
