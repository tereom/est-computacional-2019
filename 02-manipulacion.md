...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "25", "13", "05", "31", "30", "20", "13", "11", "05",…
#> $ NOM_ENT    <chr> "SINALOA", "HIDALGO", "COAHUILA", "YUCATAN", "VERACRU…
#> $ CCT        <chr> "25PPR0593L", "13DPB0373P", "05PPR0099X", "31DPR1706K…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "COLEGIO BEGSU", "NI\u0084OS HEROES", "COLEGIO SAN JO…
#> $ TIPO       <chr> "PARTICULAR", "INDêGENA", "PARTICULAR", "GENERAL", "G…
#> $ CVE_MUN    <chr> "012", "043", "030", "038", "101", "131", "060", "011…
#> $ NOM_MUN    <chr> "MAZATLAN", "NICOLAS FLORES", "SALTILLO", "HUNUCMA", …
#> $ CVE_LOC    <chr> "0001", "0003", "0001", "0001", "0025", "0011", "0022…
#> $ NOM_LOC    <chr> "MAZATLAN", "AGUA LIMPIA", "SALTILLO", "HUNUCMA", "EL…
#> $ PUNT_ESP_3 <dbl> 638, 463, 598, 531, 453, NA, 448, 561, 517, 606, 568,…
#> $ PUNT_MAT_3 <dbl> 728, 512, 646, 556, 495, NA, 490, 545, 547, 653, 581,…
#> $ PUNT_FCE_3 <dbl> 591, 413, 548, 489, 418, NA, 376, 525, 443, 552, 507,…
#> $ PUNT_ESP_4 <dbl> 677, 549, 627, 597, 374, 472, 435, 527, 526, 573, 535…
#> $ PUNT_MAT_4 <dbl> 737, 563, 630, 638, 390, 364, 515, 582, 571, 617, 524…
#> $ PUNT_FCE_4 <dbl> 595, 484, 550, 596, 403, 372, 405, 483, 439, 531, 457…
#> $ PUNT_ESP_5 <dbl> 648, 485, 648, 550, 360, NA, 414, 520, 530, 567, 556,…
#> $ PUNT_MAT_5 <dbl> 731, 518, 634, 699, 362, NA, 475, 541, 558, 537, 559,…
#> $ PUNT_FCE_5 <dbl> 573, 467, 578, 559, 353, NA, 392, 528, 505, 505, 510,…
#> $ PUNT_ESP_6 <dbl> 643, 527, 646, 503, 423, 407, 501, 551, 519, 580, 578…
#> $ PUNT_MAT_6 <dbl> 713, 532, 664, 534, 369, 371, 580, 626, 562, 696, 620…
#> $ PUNT_FCE_6 <dbl> 585, 511, 598, 492, 394, 389, 482, 539, 489, 539, 520…
```
...
#>  1 25      SINALOA 25PP… MATU… COLEGI… PART… 012     MAZATL… 0001   
#>  2 25      SINALOA 25PP… MATU… COLEGI… PART… 012     MAZATL… 0001   
#>  3 25      SINALOA 25PP… MATU… COLEGI… PART… 012     MAZATL… 0001   
#>  4 25      SINALOA 25PP… MATU… COLEGI… PART… 012     MAZATL… 0001   
#>  5 25      SINALOA 25PP… MATU… COLEGI… PART… 012     MAZATL… 0001   
#>  6 25      SINALOA 25PP… MATU… COLEGI… PART… 012     MAZATL… 0001   
#>  7 25      SINALOA 25PP… MATU… COLEGI… PART… 012     MAZATL… 0001   
#>  8 25      SINALOA 25PP… MATU… COLEGI… PART… 012     MAZATL… 0001   
#>  9 25      SINALOA 25PP… MATU… COLEGI… PART… 012     MAZATL… 0001   
#> 10 25      SINALOA 25PP… MATU… COLEGI… PART… 012     MAZATL… 0001   
...
#> $ CCT     <chr> "25PPR0593L", "25PPR0593L", "25PPR0593L", "25PPR0593L", …
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA <chr> "COLEGIO BEGSU", "COLEGIO BEGSU", "COLEGIO BEGSU", "COLE…
#> $ TIPO    <chr> "PARTICULAR", "PARTICULAR", "PARTICULAR", "PARTICULAR", …
#> $ CVE_MUN <chr> "012", "012", "012", "012", "012", "012", "012", "012", …
#> $ NOM_MUN <chr> "MAZATLAN", "MAZATLAN", "MAZATLAN", "MAZATLAN", "MAZATLA…
#> $ CVE_LOC <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001", …
#> $ NOM_LOC <chr> "MAZATLAN", "MAZATLAN", "MAZATLAN", "MAZATLAN", "MAZATLA…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", …
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5,…
#> $ PUNTAJE <dbl> 638, 728, 591, 677, 737, 595, 648, 731, 573, 643, 713, 5…
```
...
#> $ CCT        <chr> "25PPR0593L", "25PPR0593L", "25PPR0593L", "25PPR0593L…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "COLEGIO BEGSU", "COLEGIO BEGSU", "COLEGIO BEGSU", "C…
#> $ TIPO       <chr> "PARTICULAR", "PARTICULAR", "PARTICULAR", "PARTICULAR…
#> $ CVE_MUN    <chr> "012", "012", "012", "012", "012", "012", "012", "012…
#> $ NOM_MUN    <chr> "MAZATLAN", "MAZATLAN", "MAZATLAN", "MAZATLAN", "MAZA…
#> $ CVE_LOC    <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001…
#> $ NOM_LOC    <chr> "MAZATLAN", "MAZATLAN", "MAZATLAN", "MAZATLAN", "MAZA…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4",…
#> $ PUNTAJE    <dbl> 638, 728, 591, 677, 737, 595, 648, 731, 573, 643, 713…
```
