...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "30", "27", "15", "30", "11", "11", "30", "11", "24",…
#> $ NOM_ENT    <chr> "VERACRUZ", "TABASCO", "MEXICO", "VERACRUZ", "GUANAJU…
#> $ CCT        <chr> "30DPR4985G", "27DPR0506T", "15DPR0372P", "30DPR5283W…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "GUADALUPE VICTORIA", "CINCO DE MAYO", "16 DE SEPTIEM…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL"…
#> $ CVE_MUN    <chr> "182", "011", "113", "101", "007", "015", "126", "009…
#> $ NOM_MUN    <chr> "TLALNELHUAYOCAN", "JONUTA", "VILLA GUERRERO", "MARIA…
#> $ CVE_LOC    <chr> "0015", "0023", "0033", "0001", "0166", "0142", "0017…
#> $ NOM_LOC    <chr> "GUADALUPE VICTORIA", "PUEBLO NUEVO", "EJIDO DE LA FI…
#> $ PUNT_ESP_3 <dbl> 512, 523, 553, 519, 558, 512, 531, 582, 574, 418, 385…
#> $ PUNT_MAT_3 <dbl> 537, 537, 612, 565, 586, 570, 563, 646, 622, 417, 405…
#> $ PUNT_FCE_3 <dbl> 450, 428, 529, 491, 554, 459, 403, 509, 453, 399, 401…
#> $ PUNT_ESP_4 <dbl> 530, 510, 503, 525, 518, 437, 385, 571, 528, 402, 344…
#> $ PUNT_MAT_4 <dbl> 523, 559, 545, 522, 575, 581, 431, 599, 586, 414, 399…
#> $ PUNT_FCE_4 <dbl> 475, 401, 483, 449, 473, 384, 353, 509, 523, 344, 355…
#> $ PUNT_ESP_5 <dbl> 515, 514, 459, 505, 519, 570, 392, 553, 498, 343, 376…
#> $ PUNT_MAT_5 <dbl> 519, 510, 484, 492, 524, 610, 428, 554, 532, 410, 338…
#> $ PUNT_FCE_5 <dbl> 467, 479, 415, 460, 612, 539, 426, 484, 443, 365, 354…
#> $ PUNT_ESP_6 <dbl> 502, 508, 491, 537, 621, 414, 367, 642, 517, 352, 363…
#> $ PUNT_MAT_6 <dbl> 524, 641, 570, 484, 629, 405, 415, 673, 514, 446, 337…
#> $ PUNT_FCE_6 <dbl> 449, 514, 457, 486, 489, 413, 392, 517, 502, 332, 367…
```
...
#>  1 30      VERACR… 30DP… MATU… GUADAL… GENE… 182     TLALNE… 0015   
#>  2 30      VERACR… 30DP… MATU… GUADAL… GENE… 182     TLALNE… 0015   
#>  3 30      VERACR… 30DP… MATU… GUADAL… GENE… 182     TLALNE… 0015   
#>  4 30      VERACR… 30DP… MATU… GUADAL… GENE… 182     TLALNE… 0015   
#>  5 30      VERACR… 30DP… MATU… GUADAL… GENE… 182     TLALNE… 0015   
#>  6 30      VERACR… 30DP… MATU… GUADAL… GENE… 182     TLALNE… 0015   
#>  7 30      VERACR… 30DP… MATU… GUADAL… GENE… 182     TLALNE… 0015   
#>  8 30      VERACR… 30DP… MATU… GUADAL… GENE… 182     TLALNE… 0015   
#>  9 30      VERACR… 30DP… MATU… GUADAL… GENE… 182     TLALNE… 0015   
#> 10 30      VERACR… 30DP… MATU… GUADAL… GENE… 182     TLALNE… 0015   
...
#> $ CCT     <chr> "30DPR4985G", "30DPR4985G", "30DPR4985G", "30DPR4985G", …
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA <chr> "GUADALUPE VICTORIA", "GUADALUPE VICTORIA", "GUADALUPE V…
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "…
#> $ CVE_MUN <chr> "182", "182", "182", "182", "182", "182", "182", "182", …
#> $ NOM_MUN <chr> "TLALNELHUAYOCAN", "TLALNELHUAYOCAN", "TLALNELHUAYOCAN",…
#> $ CVE_LOC <chr> "0015", "0015", "0015", "0015", "0015", "0015", "0015", …
#> $ NOM_LOC <chr> "GUADALUPE VICTORIA", "GUADALUPE VICTORIA", "GUADALUPE V…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", …
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5,…
#> $ PUNTAJE <dbl> 512, 537, 450, 530, 523, 475, 515, 519, 467, 502, 524, 4…
```
...
#> $ CCT        <chr> "30DPR4985G", "30DPR4985G", "30DPR4985G", "30DPR4985G…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "GUADALUPE VICTORIA", "GUADALUPE VICTORIA", "GUADALUP…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL"…
#> $ CVE_MUN    <chr> "182", "182", "182", "182", "182", "182", "182", "182…
#> $ NOM_MUN    <chr> "TLALNELHUAYOCAN", "TLALNELHUAYOCAN", "TLALNELHUAYOCA…
#> $ CVE_LOC    <chr> "0015", "0015", "0015", "0015", "0015", "0015", "0015…
#> $ NOM_LOC    <chr> "GUADALUPE VICTORIA", "GUADALUPE VICTORIA", "GUADALUP…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4",…
#> $ PUNTAJE    <dbl> 512, 537, 450, 530, 523, 475, 515, 519, 467, 502, 524…
```
