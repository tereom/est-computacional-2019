...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "32", "04", "28", "14", "15", "29", "30", "07", "14", "12"…
#> $ NOM_ENT    <chr> "ZACATECAS", "CAMPECHE", "TAMAULIPAS", "JALISCO", "MEXICO"…
#> $ CCT        <chr> "32DPR1107O", "04DPR0421B", "28DPR1736R", "14DPR0261L", "1…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "VESPERTINO", "NOCTURN…
#> $ ESCUELA    <chr> "CARLOS A CARRILLO", "RICARDO FLORES MAGON", "PROF. MANUEL…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GE…
#> $ CVE_MUN    <chr> "007", "011", "006", "039", "070", "020", "155", "037", "1…
#> $ NOM_MUN    <chr> "CONCEPCION DEL ORO", "CANDELARIA", "BUSTAMANTE", "GUADALA…
#> $ CVE_LOC    <chr> "0019", "0566", "0024", "0001", "0001", "0004", "0349", "0…
#> $ NOM_LOC    <chr> "MORELOS (SAN RAFAEL)", "SAN MIGUEL", "SAN JOSE DE LAS FLO…
#> $ PUNT_ESP_3 <dbl> 543, 642, 780, 492, 412, 637, 680, 711, 469, 391, 468, 510…
#> $ PUNT_MAT_3 <dbl> 600, 685, 891, 495, 411, 693, 724, 770, 470, 400, 478, 560…
#> $ PUNT_FCE_3 <dbl> 482, 504, 705, 448, 384, 544, 648, 600, 416, 386, 415, 517…
#> $ PUNT_ESP_4 <dbl> 377, 588, 721, 476, 370, 607, 649, 571, 454, 669, 506, 621…
#> $ PUNT_MAT_4 <dbl> 448, 624, 883, 511, 390, 655, 708, 678, 483, 811, 556, 746…
#> $ PUNT_FCE_4 <dbl> 391, 510, 665, 413, 375, 543, 613, 504, 436, 637, 456, 590…
#> $ PUNT_ESP_5 <dbl> 342, 540, 675, 504, 406, 559, 516, 565, 474, 605, 536, 653…
#> $ PUNT_MAT_5 <dbl> 331, 610, 701, 547, 407, 569, 492, 582, 515, 676, 567, 649…
#> $ PUNT_FCE_5 <dbl> 391, 481, 723, 468, 377, 502, 481, 501, 423, 579, 493, 598…
#> $ PUNT_ESP_6 <dbl> 391, 565, 623, 483, 424, 600, 499, 467, 469, 613, 489, 690…
#> $ PUNT_MAT_6 <dbl> 432, 674, 679, 500, 488, 683, 617, 500, 493, 597, 523, 683…
#> $ PUNT_FCE_6 <dbl> 356, 520, 618, 455, 410, 538, 527, 412, 403, 482, 455, 528…
```
...
#>  1 32      ZACATE… 32DP… MATU… CARLOS… GENE… 007     CONCEP… 0019    MORELO…
#>  2 32      ZACATE… 32DP… MATU… CARLOS… GENE… 007     CONCEP… 0019    MORELO…
#>  3 32      ZACATE… 32DP… MATU… CARLOS… GENE… 007     CONCEP… 0019    MORELO…
#>  4 32      ZACATE… 32DP… MATU… CARLOS… GENE… 007     CONCEP… 0019    MORELO…
#>  5 32      ZACATE… 32DP… MATU… CARLOS… GENE… 007     CONCEP… 0019    MORELO…
#>  6 32      ZACATE… 32DP… MATU… CARLOS… GENE… 007     CONCEP… 0019    MORELO…
#>  7 32      ZACATE… 32DP… MATU… CARLOS… GENE… 007     CONCEP… 0019    MORELO…
#>  8 32      ZACATE… 32DP… MATU… CARLOS… GENE… 007     CONCEP… 0019    MORELO…
#>  9 32      ZACATE… 32DP… MATU… CARLOS… GENE… 007     CONCEP… 0019    MORELO…
#> 10 32      ZACATE… 32DP… MATU… CARLOS… GENE… 007     CONCEP… 0019    MORELO…
...
#> Observations: 12,000
#> Variables: 13
#> $ CVE_ENT <chr> "32", "32", "32", "32", "32", "32", "32", "32", "32", "32", "…
#> $ NOM_ENT <chr> "ZACATECAS", "ZACATECAS", "ZACATECAS", "ZACATECAS", "ZACATECA…
#> $ CCT     <chr> "32DPR1107O", "32DPR1107O", "32DPR1107O", "32DPR1107O", "32DP…
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "…
#> $ ESCUELA <chr> "CARLOS A CARRILLO", "CARLOS A CARRILLO", "CARLOS A CARRILLO"…
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENER…
#> $ CVE_MUN <chr> "007", "007", "007", "007", "007", "007", "007", "007", "007"…
#> $ NOM_MUN <chr> "CONCEPCION DEL ORO", "CONCEPCION DEL ORO", "CONCEPCION DEL O…
#> $ CVE_LOC <chr> "0019", "0019", "0019", "0019", "0019", "0019", "0019", "0019…
#> $ NOM_LOC <chr> "MORELOS (SAN RAFAEL)", "MORELOS (SAN RAFAEL)", "MORELOS (SAN…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", "FCE"…
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5, 5, 5…
#> $ PUNTAJE <dbl> 543, 600, 482, 377, 448, 391, 342, 331, 391, 391, 432, 356, 6…
```
...
#> Variables: 12
#> $ CVE_ENT    <chr> "32", "32", "32", "32", "32", "32", "32", "32", "32", "32"…
#> $ NOM_ENT    <chr> "ZACATECAS", "ZACATECAS", "ZACATECAS", "ZACATECAS", "ZACAT…
#> $ CCT        <chr> "32DPR1107O", "32DPR1107O", "32DPR1107O", "32DPR1107O", "3…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO"…
#> $ ESCUELA    <chr> "CARLOS A CARRILLO", "CARLOS A CARRILLO", "CARLOS A CARRIL…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GE…
#> $ CVE_MUN    <chr> "007", "007", "007", "007", "007", "007", "007", "007", "0…
#> $ NOM_MUN    <chr> "CONCEPCION DEL ORO", "CONCEPCION DEL ORO", "CONCEPCION DE…
#> $ CVE_LOC    <chr> "0019", "0019", "0019", "0019", "0019", "0019", "0019", "0…
#> $ NOM_LOC    <chr> "MORELOS (SAN RAFAEL)", "MORELOS (SAN RAFAEL)", "MORELOS (…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4", "ESP…
#> $ PUNTAJE    <dbl> 543, 600, 482, 377, 448, 391, 342, 331, 391, 391, 432, 356…
```
