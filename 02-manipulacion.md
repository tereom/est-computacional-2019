...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "14", "21", "31", "11", "08", "30", "19", "14", "11", "30"…
#> $ NOM_ENT    <chr> "JALISCO", "PUEBLA", "YUCATAN", "GUANAJUATO", "CHIHUAHUA",…
#> $ CCT        <chr> "14EPR0211C", "21DPB0119F", "31EPR0032H", "11DPR0483Y", "0…
#> $ TURNO      <chr> "VESPERTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA    <chr> "LEANDRO ARELLANO GARCIA", "BENITO JUAREZ", "AQUILES SERDA…
#> $ TIPO       <chr> "GENERAL", "INDêGENA", "GENERAL", "GENERAL", "CONAFE", "CO…
#> $ CVE_MUN    <chr> "033", "129", "040", "044", "051", "053", "039", "006", "0…
#> $ NOM_MUN    <chr> "DEGOLLADO", "SAN JOSE MIAHUATLAN", "IZAMAL", "VILLAGRAN",…
#> $ CVE_LOC    <chr> "0001", "0004", "0001", "0011", "0108", "0021", "0001", "0…
#> $ NOM_LOC    <chr> "DEGOLLADO", "SAN MATEO TLACOXCALCO", "IZAMAL", "CERRITO D…
#> $ PUNT_ESP_3 <dbl> 677, 569, 555, 505, 510, 520, 676, 565, 559, 439, 517, 481…
#> $ PUNT_MAT_3 <dbl> 671, 635, 591, 539, 483, 563, 820, 631, 595, 460, 623, 581…
#> $ PUNT_FCE_3 <dbl> 556, 473, 467, 503, 416, 457, 582, 511, 580, 366, 485, 470…
#> $ PUNT_ESP_4 <dbl> 548, 613, 548, 491, NA, 515, 647, 491, 622, 518, 612, 587,…
#> $ PUNT_MAT_4 <dbl> 637, 622, 531, 561, NA, 497, 736, 508, 616, 521, 616, 594,…
#> $ PUNT_FCE_4 <dbl> 461, 550, 481, 482, NA, 370, 589, 474, 553, 492, 602, 510,…
#> $ PUNT_ESP_5 <dbl> 508, 549, 540, NA, 399, NA, 512, 496, 537, 495, NA, 501, 4…
#> $ PUNT_MAT_5 <dbl> 584, 554, 527, NA, 497, NA, 588, 591, 578, 436, NA, 476, 5…
#> $ PUNT_FCE_5 <dbl> 508, 488, 489, NA, 396, NA, 487, 484, 484, 475, NA, 445, 4…
#> $ PUNT_ESP_6 <dbl> 679, 531, 512, 448, NA, 477, 642, 586, 541, 471, 536, 536,…
#> $ PUNT_MAT_6 <dbl> 769, 534, 506, 409, NA, 575, 590, 598, 608, 469, 499, 634,…
#> $ PUNT_FCE_6 <dbl> 527, 483, 459, 476, NA, 385, 576, 528, 487, 472, 509, 508,…
```
...
#>  1 14      JALISCO 14EP… VESP… LEANDR… GENE… 033     DEGOLL… 0001    DEGOLL…
#>  2 14      JALISCO 14EP… VESP… LEANDR… GENE… 033     DEGOLL… 0001    DEGOLL…
#>  3 14      JALISCO 14EP… VESP… LEANDR… GENE… 033     DEGOLL… 0001    DEGOLL…
#>  4 14      JALISCO 14EP… VESP… LEANDR… GENE… 033     DEGOLL… 0001    DEGOLL…
#>  5 14      JALISCO 14EP… VESP… LEANDR… GENE… 033     DEGOLL… 0001    DEGOLL…
#>  6 14      JALISCO 14EP… VESP… LEANDR… GENE… 033     DEGOLL… 0001    DEGOLL…
#>  7 14      JALISCO 14EP… VESP… LEANDR… GENE… 033     DEGOLL… 0001    DEGOLL…
#>  8 14      JALISCO 14EP… VESP… LEANDR… GENE… 033     DEGOLL… 0001    DEGOLL…
#>  9 14      JALISCO 14EP… VESP… LEANDR… GENE… 033     DEGOLL… 0001    DEGOLL…
#> 10 14      JALISCO 14EP… VESP… LEANDR… GENE… 033     DEGOLL… 0001    DEGOLL…
...
#> Observations: 12,000
#> Variables: 13
#> $ CVE_ENT <chr> "14", "14", "14", "14", "14", "14", "14", "14", "14", "14", "…
#> $ NOM_ENT <chr> "JALISCO", "JALISCO", "JALISCO", "JALISCO", "JALISCO", "JALIS…
#> $ CCT     <chr> "14EPR0211C", "14EPR0211C", "14EPR0211C", "14EPR0211C", "14EP…
#> $ TURNO   <chr> "VESPERTINO", "VESPERTINO", "VESPERTINO", "VESPERTINO", "VESP…
#> $ ESCUELA <chr> "LEANDRO ARELLANO GARCIA", "LEANDRO ARELLANO GARCIA", "LEANDR…
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENER…
#> $ CVE_MUN <chr> "033", "033", "033", "033", "033", "033", "033", "033", "033"…
#> $ NOM_MUN <chr> "DEGOLLADO", "DEGOLLADO", "DEGOLLADO", "DEGOLLADO", "DEGOLLAD…
#> $ CVE_LOC <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001", "0001…
#> $ NOM_LOC <chr> "DEGOLLADO", "DEGOLLADO", "DEGOLLADO", "DEGOLLADO", "DEGOLLAD…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", "FCE"…
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5, 5, 5…
#> $ PUNTAJE <dbl> 677, 671, 556, 548, 637, 461, 508, 584, 508, 679, 769, 527, 5…
```
...
#> Variables: 12
#> $ CVE_ENT    <chr> "14", "14", "14", "14", "14", "14", "14", "14", "14", "14"…
#> $ NOM_ENT    <chr> "JALISCO", "JALISCO", "JALISCO", "JALISCO", "JALISCO", "JA…
#> $ CCT        <chr> "14EPR0211C", "14EPR0211C", "14EPR0211C", "14EPR0211C", "1…
#> $ TURNO      <chr> "VESPERTINO", "VESPERTINO", "VESPERTINO", "VESPERTINO", "V…
#> $ ESCUELA    <chr> "LEANDRO ARELLANO GARCIA", "LEANDRO ARELLANO GARCIA", "LEA…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GE…
#> $ CVE_MUN    <chr> "033", "033", "033", "033", "033", "033", "033", "033", "0…
#> $ NOM_MUN    <chr> "DEGOLLADO", "DEGOLLADO", "DEGOLLADO", "DEGOLLADO", "DEGOL…
#> $ CVE_LOC    <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001", "0…
#> $ NOM_LOC    <chr> "DEGOLLADO", "DEGOLLADO", "DEGOLLADO", "DEGOLLADO", "DEGOL…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4", "ESP…
#> $ PUNTAJE    <dbl> 677, 671, 556, 548, 637, 461, 508, 584, 508, 679, 769, 527…
```
