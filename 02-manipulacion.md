...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "12", "30", "24", "08", "30", "04", "14", "17", "15",…
#> $ NOM_ENT    <chr> "GUERRERO", "VERACRUZ", "SAN LUIS POTOSI", "CHIHUAHUA…
#> $ CCT        <chr> "12DPB0120N", "30DPR3608Y", "24KPR0489F", "08DPR2566G…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "VESPERTINO", "MA…
#> $ ESCUELA    <chr> "CRISTOBAL COLON", "ING. ANTONIO MANUEL AMOR", "AGUA …
#> $ TIPO       <chr> "INDêGENA", "GENERAL", "CONAFE", "GENERAL", "INDêGENA…
#> $ CVE_MUN    <chr> "043", "013", "054", "037", "058", "005", "053", "006…
#> $ NOM_MUN    <chr> "METLATONOC", "NARANJOS AMATLAN", "XILITLA", "JUAREZ"…
#> $ CVE_LOC    <chr> "0029", "0001", "0126", "0001", "0146", "0001", "0001…
#> $ NOM_LOC    <chr> "VICENTE GUERRERO", "NARANJOS", "AGUA DE LA PE\u0084A…
#> $ PUNT_ESP_3 <dbl> 640, 564, 480, 597, NA, 617, 525, 647, 547, 410, 620,…
#> $ PUNT_MAT_3 <dbl> 746, 613, 461, 681, NA, 676, 543, 678, 608, 396, 666,…
#> $ PUNT_FCE_3 <dbl> 608, 486, 416, 566, NA, 537, 423, 557, 483, 413, 581,…
#> $ PUNT_ESP_4 <dbl> 686, 540, 556, 595, 637, 654, 539, 666, 509, 399, 660…
#> $ PUNT_MAT_4 <dbl> 742, 547, 505, 576, 655, 699, 539, 741, 518, 414, 696…
#> $ PUNT_FCE_4 <dbl> 626, 477, 481, 510, 577, 583, 462, 583, 451, 341, 588…
#> $ PUNT_ESP_5 <dbl> 700, 479, 481, 595, NA, 590, 510, 502, 524, 402, 639,…
#> $ PUNT_MAT_5 <dbl> 727, 477, 517, 723, NA, 674, 540, 516, 558, 395, 662,…
#> $ PUNT_FCE_5 <dbl> 623, 445, 530, 591, NA, 508, 474, 473, 501, 389, 563,…
#> $ PUNT_ESP_6 <dbl> 663, 515, 496, 568, 470, 614, 511, 574, 507, 431, 650…
#> $ PUNT_MAT_6 <dbl> 754, 555, 528, 613, 612, 690, 556, 685, 530, 396, 683…
#> $ PUNT_FCE_6 <dbl> 617, 456, 439, 478, 514, 527, 488, 533, 486, 344, 588…
```
...
#>  1 12      GUERRE… 12DP… MATU… CRISTO… INDê… 043     METLAT… 0029   
#>  2 12      GUERRE… 12DP… MATU… CRISTO… INDê… 043     METLAT… 0029   
#>  3 12      GUERRE… 12DP… MATU… CRISTO… INDê… 043     METLAT… 0029   
#>  4 12      GUERRE… 12DP… MATU… CRISTO… INDê… 043     METLAT… 0029   
#>  5 12      GUERRE… 12DP… MATU… CRISTO… INDê… 043     METLAT… 0029   
#>  6 12      GUERRE… 12DP… MATU… CRISTO… INDê… 043     METLAT… 0029   
#>  7 12      GUERRE… 12DP… MATU… CRISTO… INDê… 043     METLAT… 0029   
#>  8 12      GUERRE… 12DP… MATU… CRISTO… INDê… 043     METLAT… 0029   
#>  9 12      GUERRE… 12DP… MATU… CRISTO… INDê… 043     METLAT… 0029   
#> 10 12      GUERRE… 12DP… MATU… CRISTO… INDê… 043     METLAT… 0029   
...
#> $ CCT     <chr> "12DPB0120N", "12DPB0120N", "12DPB0120N", "12DPB0120N", …
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA <chr> "CRISTOBAL COLON", "CRISTOBAL COLON", "CRISTOBAL COLON",…
#> $ TIPO    <chr> "INDêGENA", "INDêGENA", "INDêGENA", "INDêGENA", "INDêGEN…
#> $ CVE_MUN <chr> "043", "043", "043", "043", "043", "043", "043", "043", …
#> $ NOM_MUN <chr> "METLATONOC", "METLATONOC", "METLATONOC", "METLATONOC", …
#> $ CVE_LOC <chr> "0029", "0029", "0029", "0029", "0029", "0029", "0029", …
#> $ NOM_LOC <chr> "VICENTE GUERRERO", "VICENTE GUERRERO", "VICENTE GUERRER…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", …
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5,…
#> $ PUNTAJE <dbl> 640, 746, 608, 686, 742, 626, 700, 727, 623, 663, 754, 6…
```
...
#> $ ESCUELA    <chr> "CRISTOBAL COLON", "CRISTOBAL COLON", "CRISTOBAL COLO…
#> $ TIPO       <chr> "INDêGENA", "INDêGENA", "INDêGENA", "INDêGENA", "INDê…
#> $ CVE_MUN    <chr> "043", "043", "043", "043", "043", "043", "043", "043…
#> $ NOM_MUN    <chr> "METLATONOC", "METLATONOC", "METLATONOC", "METLATONOC…
#> $ CVE_LOC    <chr> "0029", "0029", "0029", "0029", "0029", "0029", "0029…
#> $ NOM_LOC    <chr> "VICENTE GUERRERO", "VICENTE GUERRERO", "VICENTE GUER…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4",…
#> $ PUNTAJE    <dbl> 640, 746, 608, 686, 742, 626, 700, 727, 623, 663, 754…
```
...
edad 20-24 contra 25-29. ¿Qué transformación debes hacer?
