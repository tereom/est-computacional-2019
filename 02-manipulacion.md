...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "19", "12", "05", "15", "14", "14", "30", "30", "02", "07"…
#> $ NOM_ENT    <chr> "NUEVO LEON", "GUERRERO", "COAHUILA", "MEXICO", "JALISCO",…
#> $ CCT        <chr> "19DPR1062O", "12DPB0228E", "05DPR0625V", "15DPR2803B", "1…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "VESPERTINO", "MATUTIN…
#> $ ESCUELA    <chr> "GRAL. IGNACIO ZARAGOZA", "EMILIANO ZAPATA", "GUADALUPE VI…
#> $ TIPO       <chr> "GENERAL", "INDêGENA", "GENERAL", "GENERAL", "INDêGENA", "…
#> $ CVE_MUN    <chr> "014", "081", "030", "080", "019", "027", "069", "006", "0…
#> $ NOM_MUN    <chr> "DOCTOR ARROYO", "ILIATENCO", "SALTILLO", "SULTEPEC", "BOL…
#> $ CVE_LOC    <chr> "0400", "0017", "0126", "0033", "0133", "0032", "0002", "0…
#> $ NOM_LOC    <chr> "PUERTO DEL AIRE", "CRUZTOMAHUAC", "GUADALUPE VICTORIA", "…
#> $ PUNT_ESP_3 <dbl> 553, 564, 510, 434, 398, 452, 488, 376, 492, 529, 504, 573…
#> $ PUNT_MAT_3 <dbl> 584, 745, 500, 416, 394, 520, 512, 332, 508, 700, 590, 626…
#> $ PUNT_FCE_3 <dbl> 457, 546, 462, 409, 360, 403, 399, 477, 475, 552, 466, 523…
#> $ PUNT_ESP_4 <dbl> 459, 665, 544, 402, 374, 400, 473, 392, 579, 599, 482, 601…
#> $ PUNT_MAT_4 <dbl> 501, 809, 542, 453, 367, 483, 553, 440, 577, 600, 552, 597…
#> $ PUNT_FCE_4 <dbl> 434, 651, 471, 411, 391, 405, 462, 365, 496, 507, 433, 526…
#> $ PUNT_ESP_5 <dbl> 413, 440, 530, 449, NA, 486, 506, 327, 550, 489, 529, 602,…
#> $ PUNT_MAT_5 <dbl> 462, 570, 599, 477, NA, 498, 531, 348, 529, 589, 555, 600,…
#> $ PUNT_FCE_5 <dbl> 397, 406, 524, 456, NA, 441, 467, 431, 501, 477, 483, 549,…
#> $ PUNT_ESP_6 <dbl> 453, 453, 507, 373, NA, 475, 538, 353, 533, 521, 574, 693,…
#> $ PUNT_MAT_6 <dbl> 486, 551, 637, 379, NA, 605, 574, 349, 564, 562, 637, 718,…
#> $ PUNT_FCE_6 <dbl> 447, 418, 458, 356, NA, 444, 519, 304, 469, 461, 536, 616,…
```
...
#>  1 19      NUEVO … 19DP… MATU… GRAL. … GENE… 014     DOCTOR… 0400    PUERTO…
#>  2 19      NUEVO … 19DP… MATU… GRAL. … GENE… 014     DOCTOR… 0400    PUERTO…
#>  3 19      NUEVO … 19DP… MATU… GRAL. … GENE… 014     DOCTOR… 0400    PUERTO…
#>  4 19      NUEVO … 19DP… MATU… GRAL. … GENE… 014     DOCTOR… 0400    PUERTO…
#>  5 19      NUEVO … 19DP… MATU… GRAL. … GENE… 014     DOCTOR… 0400    PUERTO…
#>  6 19      NUEVO … 19DP… MATU… GRAL. … GENE… 014     DOCTOR… 0400    PUERTO…
#>  7 19      NUEVO … 19DP… MATU… GRAL. … GENE… 014     DOCTOR… 0400    PUERTO…
#>  8 19      NUEVO … 19DP… MATU… GRAL. … GENE… 014     DOCTOR… 0400    PUERTO…
#>  9 19      NUEVO … 19DP… MATU… GRAL. … GENE… 014     DOCTOR… 0400    PUERTO…
#> 10 19      NUEVO … 19DP… MATU… GRAL. … GENE… 014     DOCTOR… 0400    PUERTO…
...
#> $ NOM_ENT <chr> "NUEVO LEON", "NUEVO LEON", "NUEVO LEON", "NUEVO LEON", "NUEV…
#> $ CCT     <chr> "19DPR1062O", "19DPR1062O", "19DPR1062O", "19DPR1062O", "19DP…
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "…
#> $ ESCUELA <chr> "GRAL. IGNACIO ZARAGOZA", "GRAL. IGNACIO ZARAGOZA", "GRAL. IG…
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENER…
#> $ CVE_MUN <chr> "014", "014", "014", "014", "014", "014", "014", "014", "014"…
#> $ NOM_MUN <chr> "DOCTOR ARROYO", "DOCTOR ARROYO", "DOCTOR ARROYO", "DOCTOR AR…
#> $ CVE_LOC <chr> "0400", "0400", "0400", "0400", "0400", "0400", "0400", "0400…
#> $ NOM_LOC <chr> "PUERTO DEL AIRE", "PUERTO DEL AIRE", "PUERTO DEL AIRE", "PUE…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", "FCE"…
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5, 5, 5…
#> $ PUNTAJE <dbl> 553, 584, 457, 459, 501, 434, 413, 462, 397, 453, 486, 447, 5…
```
...
#> Variables: 12
#> $ CVE_ENT    <chr> "19", "19", "19", "19", "19", "19", "19", "19", "19", "19"…
#> $ NOM_ENT    <chr> "NUEVO LEON", "NUEVO LEON", "NUEVO LEON", "NUEVO LEON", "N…
#> $ CCT        <chr> "19DPR1062O", "19DPR1062O", "19DPR1062O", "19DPR1062O", "1…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO"…
#> $ ESCUELA    <chr> "GRAL. IGNACIO ZARAGOZA", "GRAL. IGNACIO ZARAGOZA", "GRAL.…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GE…
#> $ CVE_MUN    <chr> "014", "014", "014", "014", "014", "014", "014", "014", "0…
#> $ NOM_MUN    <chr> "DOCTOR ARROYO", "DOCTOR ARROYO", "DOCTOR ARROYO", "DOCTOR…
#> $ CVE_LOC    <chr> "0400", "0400", "0400", "0400", "0400", "0400", "0400", "0…
#> $ NOM_LOC    <chr> "PUERTO DEL AIRE", "PUERTO DEL AIRE", "PUERTO DEL AIRE", "…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4", "ESP…
#> $ PUNTAJE    <dbl> 553, 584, 457, 459, 501, 434, 413, 462, 397, 453, 486, 447…
```
