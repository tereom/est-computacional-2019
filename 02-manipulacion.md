...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "20", "25", "14", "05", "30", "13", "19", "30", "22",…
#> $ NOM_ENT    <chr> "OAXACA", "SINALOA", "JALISCO", "COAHUILA", "VERACRUZ…
#> $ CCT        <chr> "20KPR1208R", "25EPR0594E", "14KPR0332Z", "05DPR0392W…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "LA UNION ZARAGOZA", "GENERAL MACARIO GAXIOLA", "EL V…
#> $ TIPO       <chr> "CONAFE", "GENERAL", "CONAFE", "GENERAL", "INDêGENA",…
#> $ CVE_MUN    <chr> "377", "011", "087", "030", "173", "030", "021", "031…
#> $ NOM_MUN    <chr> "SANTA CRUZ ITUNDUJIA", "GUASAVE", "TECALITLAN", "SAL…
#> $ CVE_LOC    <chr> "0077", "0499", "0177", "0001", "0167", "0034", "0001…
#> $ NOM_LOC    <chr> "LA UNION ZARAGOZA", "SAN FRANCISCO DE CAPOMOS", "EL …
#> $ PUNT_ESP_3 <dbl> NA, 519, NA, 555, 378, 416, 529, 379, 480, 560, 527, …
#> $ PUNT_MAT_3 <dbl> NA, 572, NA, 580, 421, 339, 560, 382, 435, 617, 540, …
#> $ PUNT_FCE_3 <dbl> NA, 461, NA, 504, 366, 457, 490, 370, 475, 608, 471, …
#> $ PUNT_ESP_4 <dbl> NA, 524, 481, 559, 432, 648, 528, 471, 505, 717, 554,…
#> $ PUNT_MAT_4 <dbl> NA, 553, 455, 538, 388, 576, 571, 461, 566, 739, 599,…
#> $ PUNT_FCE_4 <dbl> NA, 471, 528, 488, 419, 626, 493, 416, 459, 652, 482,…
#> $ PUNT_ESP_5 <dbl> 468, 509, NA, 603, 394, 569, 529, 400, 445, 648, 531,…
#> $ PUNT_MAT_5 <dbl> 452, 630, NA, 601, 375, 586, 557, 367, 454, 719, 584,…
#> $ PUNT_FCE_5 <dbl> 475, 467, NA, 532, 390, 475, 497, 378, 416, 635, 481,…
#> $ PUNT_ESP_6 <dbl> 366, 503, 372, 603, 511, 610, 536, 487, 421, 657, 521…
#> $ PUNT_MAT_6 <dbl> 386, 586, 391, 618, 599, 592, 559, 427, 476, 691, 587…
#> $ PUNT_FCE_6 <dbl> 310, 513, 351, 534, 472, 583, 518, 406, 374, 548, 474…
```
...
#>  1 20      OAXACA  20KP… MATU… LA UNI… CONA… 377     SANTA … 0077   
#>  2 20      OAXACA  20KP… MATU… LA UNI… CONA… 377     SANTA … 0077   
#>  3 20      OAXACA  20KP… MATU… LA UNI… CONA… 377     SANTA … 0077   
#>  4 20      OAXACA  20KP… MATU… LA UNI… CONA… 377     SANTA … 0077   
#>  5 20      OAXACA  20KP… MATU… LA UNI… CONA… 377     SANTA … 0077   
#>  6 20      OAXACA  20KP… MATU… LA UNI… CONA… 377     SANTA … 0077   
#>  7 20      OAXACA  20KP… MATU… LA UNI… CONA… 377     SANTA … 0077   
#>  8 20      OAXACA  20KP… MATU… LA UNI… CONA… 377     SANTA … 0077   
#>  9 20      OAXACA  20KP… MATU… LA UNI… CONA… 377     SANTA … 0077   
#> 10 20      OAXACA  20KP… MATU… LA UNI… CONA… 377     SANTA … 0077   
...
#> Observations: 12,000
#> Variables: 13
#> $ CVE_ENT <chr> "20", "20", "20", "20", "20", "20", "20", "20", "20", "2…
#> $ NOM_ENT <chr> "OAXACA", "OAXACA", "OAXACA", "OAXACA", "OAXACA", "OAXAC…
#> $ CCT     <chr> "20KPR1208R", "20KPR1208R", "20KPR1208R", "20KPR1208R", …
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA <chr> "LA UNION ZARAGOZA", "LA UNION ZARAGOZA", "LA UNION ZARA…
#> $ TIPO    <chr> "CONAFE", "CONAFE", "CONAFE", "CONAFE", "CONAFE", "CONAF…
#> $ CVE_MUN <chr> "377", "377", "377", "377", "377", "377", "377", "377", …
#> $ NOM_MUN <chr> "SANTA CRUZ ITUNDUJIA", "SANTA CRUZ ITUNDUJIA", "SANTA C…
#> $ CVE_LOC <chr> "0077", "0077", "0077", "0077", "0077", "0077", "0077", …
#> $ NOM_LOC <chr> "LA UNION ZARAGOZA", "LA UNION ZARAGOZA", "LA UNION ZARA…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", …
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5,…
#> $ PUNTAJE <dbl> NA, NA, NA, NA, NA, NA, 468, 452, 475, 366, 386, 310, 51…
```
...
#> Observations: 12,000
#> Variables: 12
#> $ CVE_ENT    <chr> "20", "20", "20", "20", "20", "20", "20", "20", "20",…
#> $ NOM_ENT    <chr> "OAXACA", "OAXACA", "OAXACA", "OAXACA", "OAXACA", "OA…
#> $ CCT        <chr> "20KPR1208R", "20KPR1208R", "20KPR1208R", "20KPR1208R…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "LA UNION ZARAGOZA", "LA UNION ZARAGOZA", "LA UNION Z…
#> $ TIPO       <chr> "CONAFE", "CONAFE", "CONAFE", "CONAFE", "CONAFE", "CO…
#> $ CVE_MUN    <chr> "377", "377", "377", "377", "377", "377", "377", "377…
#> $ NOM_MUN    <chr> "SANTA CRUZ ITUNDUJIA", "SANTA CRUZ ITUNDUJIA", "SANT…
#> $ CVE_LOC    <chr> "0077", "0077", "0077", "0077", "0077", "0077", "0077…
#> $ NOM_LOC    <chr> "LA UNION ZARAGOZA", "LA UNION ZARAGOZA", "LA UNION Z…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4",…
#> $ PUNTAJE    <dbl> NA, NA, NA, NA, NA, NA, 468, 452, 475, 366, 386, 310,…
```
