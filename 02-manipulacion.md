...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "30", "27", "24", "28", "13", "31", "19", "22", "16",…
#> $ NOM_ENT    <chr> "VERACRUZ", "TABASCO", "SAN LUIS POTOSI", "TAMAULIPAS…
#> $ CCT        <chr> "30KPR2760W", "27DPR0786T", "24DPR2798O", "28DPR1009A…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "LOMA EL DIAMANTE", "FRANCISCO DOMINGUEZ GOMEZ", "20 …
#> $ TIPO       <chr> "CONAFE", "GENERAL", "GENERAL", "GENERAL", "GENERAL",…
#> $ CVE_MUN    <chr> "024", "014", "035", "039", "009", "059", "007", "016…
#> $ NOM_MUN    <chr> "TLALTETELA", "PARAISO", "SOLEDAD DE GRACIANO SANCHEZ…
#> $ CVE_LOC    <chr> "0012", "0029", "0001", "0066", "0009", "0009", "0010…
#> $ NOM_LOC    <chr> "POXTLA", "GUANO SOLO (EL COQUITO)", "SOLEDAD DE GRAC…
#> $ PUNT_ESP_3 <dbl> 513, 691, 541, 445, 530, 461, NA, 527, 486, 508, 495,…
#> $ PUNT_MAT_3 <dbl> 537, 777, 572, 511, 583, 440, NA, 538, 412, 396, 537,…
#> $ PUNT_FCE_3 <dbl> 454, 621, 481, 384, 472, 392, NA, 468, 390, 409, 428,…
#> $ PUNT_ESP_4 <dbl> NA, 560, 514, 508, 586, 470, 422, 555, NA, 590, 554, …
#> $ PUNT_MAT_4 <dbl> NA, 563, 523, 498, 526, 470, 421, 570, NA, 622, 603, …
#> $ PUNT_FCE_4 <dbl> NA, 455, 449, 355, 513, 416, 413, 481, NA, 527, 535, …
#> $ PUNT_ESP_5 <dbl> NA, 527, 552, 442, 458, 459, NA, 540, NA, 652, 547, N…
#> $ PUNT_MAT_5 <dbl> NA, 540, 557, 460, 459, 494, NA, 570, NA, 650, 592, N…
#> $ PUNT_FCE_5 <dbl> NA, 425, 497, 427, 418, 398, NA, 478, NA, 543, 503, N…
#> $ PUNT_ESP_6 <dbl> 402, 455, 551, 457, 496, 449, 546, 568, 427, 713, 569…
#> $ PUNT_MAT_6 <dbl> 436, 576, 553, 495, 528, 446, 582, 573, 516, 735, 605…
#> $ PUNT_FCE_6 <dbl> 399, 410, 510, 395, 403, 378, 476, 528, 562, 550, 542…
```
...
enlacep_tidy
#> # A tibble: 11,411 x 13
#>    CVE_ENT NOM_ENT CCT   TURNO ESCUELA TIPO  CVE_MUN NOM_MUN CVE_LOC
#>    <chr>   <chr>   <chr> <chr> <chr>   <chr> <chr>   <chr>   <chr>  
#>  1 30      VERACR… 30KP… MATU… LOMA E… CONA… 024     TLALTE… 0012   
#>  2 27      TABASCO 27DP… MATU… FRANCI… GENE… 014     PARAISO 0029   
#>  3 24      SAN LU… 24DP… MATU… 20 DE … GENE… 035     SOLEDA… 0001   
#>  4 28      TAMAUL… 28DP… MATU… EL NIG… GENE… 039     TULA    0066   
#>  5 13      HIDALGO 13DP… MATU… ESCUEL… GENE… 009     EL ARE… 0009   
#>  6 31      YUCATAN 31DP… MATU… AQUILE… GENE… 059     PROGRE… 0009   
#>  7 22      QUERET… 22DP… VESP… CATARI… GENE… 016     SAN JU… 0001   
#>  8 16      MICHOA… 16KP… MATU… CERRO … CONA… 080     SENGUIO 0073   
#>  9 13      HIDALGO 13DP… MATU… EMILIA… GENE… 011     ATLAPE… 0011   
#> 10 31      YUCATAN 31DP… VESP… JUAN E… GENE… 019     CHEMAX  0001   
#> # … with 11,401 more rows, and 4 more variables: NOM_LOC <chr>,
...
#> Observations: 11,411
#> Variables: 13
#> $ cve_ent <chr> "30", "27", "24", "28", "13", "31", "22", "16", "13", "3…
#> $ nom_ent <chr> "VERACRUZ", "TABASCO", "SAN LUIS POTOSI", "TAMAULIPAS", …
#> $ cct     <chr> "30KPR2760W", "27DPR0786T", "24DPR2798O", "28DPR1009A", …
#> $ turno   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ escuela <chr> "LOMA EL DIAMANTE", "FRANCISCO DOMINGUEZ GOMEZ", "20 DE …
#> $ tipo    <chr> "CONAFE", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "G…
#> $ cve_mun <chr> "024", "014", "035", "039", "009", "059", "016", "080", …
#> $ nom_mun <chr> "TLALTETELA", "PARAISO", "SOLEDAD DE GRACIANO SANCHEZ", …
#> $ cve_loc <chr> "0012", "0029", "0001", "0066", "0009", "0009", "0001", …
#> $ nom_loc <chr> "POXTLA", "GUANO SOLO (EL COQUITO)", "SOLEDAD DE GRACIAN…
#> $ area    <chr> "ESP", "ESP", "ESP", "ESP", "ESP", "ESP", "ESP", "ESP", …
#> $ grado   <dbl> 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3,…
#> $ puntaje <dbl> 513, 691, 541, 445, 530, 461, 527, 486, 508, 495, 535, 5…
```
