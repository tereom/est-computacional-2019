...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "11", "21", "12", "08", "08", "09", "14", "30", "02", "30"…
#> $ NOM_ENT    <chr> "GUANAJUATO", "PUEBLA", "GUERRERO", "CHIHUAHUA", "CHIHUAHU…
#> $ CCT        <chr> "11DPR0254E", "21DPR2510Z", "12EPR0622G", "08DPR0411R", "0…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO"…
#> $ ESCUELA    <chr> "GENERAL GILDARDO MAGA\u0084A", "MIGUEL HIDALGO", "ALBORAD…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GE…
#> $ CVE_MUN    <chr> "031", "083", "058", "048", "020", "013", "069", "044", "0…
#> $ NOM_MUN    <chr> "SAN FRANCISCO DEL RINCON", "IXTACAMAXTITLAN", "TELOLOAPAN…
#> $ CVE_LOC    <chr> "0075", "0034", "0094", "0043", "0070", "0034", "0153", "0…
#> $ NOM_LOC    <chr> "SAN ROQUE DE TORRES", "TECOLTEMIC", "TEPOZONALQUILLO", "E…
#> $ PUNT_ESP_3 <dbl> 546, 524, 538, 552, 683, 490, 432, 481, 556, 498, 447, 402…
#> $ PUNT_MAT_3 <dbl> 535, 615, 594, 598, 707, 506, 517, 469, 587, 478, 428, 394…
#> $ PUNT_FCE_3 <dbl> 538, 476, 438, 501, 575, 438, 380, 416, 523, 407, 390, 401…
#> $ PUNT_ESP_4 <dbl> 703, 410, 481, 664, 657, 514, 563, 526, 560, 464, 426, 417…
#> $ PUNT_MAT_4 <dbl> 788, 388, 489, 731, 772, 539, 562, 549, 557, 456, 464, 319…
#> $ PUNT_FCE_4 <dbl> 652, 376, 435, 585, 650, 455, 460, 475, 480, 432, 447, 362…
#> $ PUNT_ESP_5 <dbl> 511, 468, 510, 604, 582, 447, 417, 492, 552, 454, NA, 291,…
#> $ PUNT_MAT_5 <dbl> 540, 518, 540, 656, 680, 477, 433, 503, 563, 475, NA, 308,…
#> $ PUNT_FCE_5 <dbl> 448, 411, 447, 534, 555, 434, 381, 437, 523, 457, NA, 371,…
#> $ PUNT_ESP_6 <dbl> 506, 473, 491, 586, 606, 521, 481, 462, 547, 486, 452, 427…
#> $ PUNT_MAT_6 <dbl> 550, 495, 502, 737, 659, 549, 501, 451, 532, 487, 465, 334…
#> $ PUNT_FCE_6 <dbl> 446, 494, 478, 570, 554, 484, 455, 449, 479, 438, 411, 266…
```
...
#>  1 11      GUANAJ… 11DP… MATU… "GENER… GENE… 031     SAN FR… 0075    SAN RO…
#>  2 11      GUANAJ… 11DP… MATU… "GENER… GENE… 031     SAN FR… 0075    SAN RO…
#>  3 11      GUANAJ… 11DP… MATU… "GENER… GENE… 031     SAN FR… 0075    SAN RO…
#>  4 11      GUANAJ… 11DP… MATU… "GENER… GENE… 031     SAN FR… 0075    SAN RO…
#>  5 11      GUANAJ… 11DP… MATU… "GENER… GENE… 031     SAN FR… 0075    SAN RO…
#>  6 11      GUANAJ… 11DP… MATU… "GENER… GENE… 031     SAN FR… 0075    SAN RO…
#>  7 11      GUANAJ… 11DP… MATU… "GENER… GENE… 031     SAN FR… 0075    SAN RO…
#>  8 11      GUANAJ… 11DP… MATU… "GENER… GENE… 031     SAN FR… 0075    SAN RO…
#>  9 11      GUANAJ… 11DP… MATU… "GENER… GENE… 031     SAN FR… 0075    SAN RO…
#> 10 11      GUANAJ… 11DP… MATU… "GENER… GENE… 031     SAN FR… 0075    SAN RO…
...
#> Observations: 12,000
#> Variables: 13
#> $ CVE_ENT <chr> "11", "11", "11", "11", "11", "11", "11", "11", "11", "11", "…
#> $ NOM_ENT <chr> "GUANAJUATO", "GUANAJUATO", "GUANAJUATO", "GUANAJUATO", "GUAN…
#> $ CCT     <chr> "11DPR0254E", "11DPR0254E", "11DPR0254E", "11DPR0254E", "11DP…
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "…
#> $ ESCUELA <chr> "GENERAL GILDARDO MAGA\u0084A", "GENERAL GILDARDO MAGA\u0084A…
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENER…
#> $ CVE_MUN <chr> "031", "031", "031", "031", "031", "031", "031", "031", "031"…
#> $ NOM_MUN <chr> "SAN FRANCISCO DEL RINCON", "SAN FRANCISCO DEL RINCON", "SAN …
#> $ CVE_LOC <chr> "0075", "0075", "0075", "0075", "0075", "0075", "0075", "0075…
#> $ NOM_LOC <chr> "SAN ROQUE DE TORRES", "SAN ROQUE DE TORRES", "SAN ROQUE DE T…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", "FCE"…
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5, 5, 5…
#> $ PUNTAJE <dbl> 546, 535, 538, 703, 788, 652, 511, 540, 448, 506, 550, 446, 5…
```
...
#> Variables: 12
#> $ CVE_ENT    <chr> "11", "11", "11", "11", "11", "11", "11", "11", "11", "11"…
#> $ NOM_ENT    <chr> "GUANAJUATO", "GUANAJUATO", "GUANAJUATO", "GUANAJUATO", "G…
#> $ CCT        <chr> "11DPR0254E", "11DPR0254E", "11DPR0254E", "11DPR0254E", "1…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO"…
#> $ ESCUELA    <chr> "GENERAL GILDARDO MAGA\u0084A", "GENERAL GILDARDO MAGA\u00…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GE…
#> $ CVE_MUN    <chr> "031", "031", "031", "031", "031", "031", "031", "031", "0…
#> $ NOM_MUN    <chr> "SAN FRANCISCO DEL RINCON", "SAN FRANCISCO DEL RINCON", "S…
#> $ CVE_LOC    <chr> "0075", "0075", "0075", "0075", "0075", "0075", "0075", "0…
#> $ NOM_LOC    <chr> "SAN ROQUE DE TORRES", "SAN ROQUE DE TORRES", "SAN ROQUE D…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4", "ESP…
#> $ PUNTAJE    <dbl> 546, 535, 538, 703, 788, 652, 511, 540, 448, 506, 550, 446…
```
