...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "23", "15", "30", "04", "02", "15", "17", "11", "02",…
#> $ NOM_ENT    <chr> "QUINTANA ROO", "MEXICO", "VERACRUZ", "CAMPECHE", "BA…
#> $ CCT        <chr> "23DPR0595G", "15KPR1355P", "30EPR1866Y", "04DPR0546J…
#> $ TURNO      <chr> "VESPERTINO", "MATUTINO", "MATUTINO", "VESPERTINO", "…
#> $ ESCUELA    <chr> "JAIME NUNO", "LA LAGUNA", "NI\u0084OS HEROES", "JUST…
#> $ TIPO       <chr> "GENERAL", "CONAFE", "GENERAL", "GENERAL", "GENERAL",…
#> $ CVE_MUN    <chr> "007", "105", "094", "003", "001", "054", "007", "014…
#> $ NOM_MUN    <chr> "LAZARO CARDENAS", "TLATLAYA", "JUAN RODRIGUEZ CLARA"…
#> $ CVE_LOC    <chr> "0041", "0032", "0031", "0001", "2487", "0148", "0001…
#> $ NOM_LOC    <chr> "NUEVO VALLADOLID", "LA LAGUNILLA", "OJO DE AGUA", "C…
#> $ PUNT_ESP_3 <dbl> 543, 471, 429, 608, NA, NA, 511, 469, 686, NA, 473, 3…
#> $ PUNT_MAT_3 <dbl> 538, 464, 442, 610, NA, NA, 496, 471, 824, NA, 441, 4…
#> $ PUNT_FCE_3 <dbl> 458, 437, 361, 493, NA, NA, 412, 410, 613, NA, 386, 3…
#> $ PUNT_ESP_4 <dbl> 551, 503, 432, 621, 348, 457, 515, 415, 514, 418, 472…
#> $ PUNT_MAT_4 <dbl> 545, 635, 514, 703, 510, 582, 465, 428, 554, 461, 443…
#> $ PUNT_FCE_4 <dbl> 493, 478, 374, 598, 439, 414, 449, 400, 463, 451, 408…
#> $ PUNT_ESP_5 <dbl> NA, NA, NA, 565, 438, 588, 477, 449, 491, 368, 455, 3…
#> $ PUNT_MAT_5 <dbl> NA, NA, NA, 577, 339, 682, 520, 445, 563, 455, 469, 2…
#> $ PUNT_FCE_5 <dbl> NA, NA, NA, 507, 346, 545, 391, 394, 482, 459, 365, 3…
#> $ PUNT_ESP_6 <dbl> NA, 453, 472, 522, 476, NA, 519, 474, 670, 352, 415, …
#> $ PUNT_MAT_6 <dbl> NA, 361, 508, 569, 513, NA, 471, 499, 713, 392, 424, …
#> $ PUNT_FCE_6 <dbl> NA, 375, 521, 458, 466, NA, 461, 426, 580, 385, 401, …
```
...
#>  1 23      QUINTA… 23DP… VESP… JAIME … GENE… 007     LAZARO… 0041   
#>  2 23      QUINTA… 23DP… VESP… JAIME … GENE… 007     LAZARO… 0041   
#>  3 23      QUINTA… 23DP… VESP… JAIME … GENE… 007     LAZARO… 0041   
#>  4 23      QUINTA… 23DP… VESP… JAIME … GENE… 007     LAZARO… 0041   
#>  5 23      QUINTA… 23DP… VESP… JAIME … GENE… 007     LAZARO… 0041   
#>  6 23      QUINTA… 23DP… VESP… JAIME … GENE… 007     LAZARO… 0041   
#>  7 23      QUINTA… 23DP… VESP… JAIME … GENE… 007     LAZARO… 0041   
#>  8 23      QUINTA… 23DP… VESP… JAIME … GENE… 007     LAZARO… 0041   
#>  9 23      QUINTA… 23DP… VESP… JAIME … GENE… 007     LAZARO… 0041   
#> 10 23      QUINTA… 23DP… VESP… JAIME … GENE… 007     LAZARO… 0041   
...
#> Observations: 12,000
#> Variables: 13
#> $ CVE_ENT <chr> "23", "23", "23", "23", "23", "23", "23", "23", "23", "2…
#> $ NOM_ENT <chr> "QUINTANA ROO", "QUINTANA ROO", "QUINTANA ROO", "QUINTAN…
#> $ CCT     <chr> "23DPR0595G", "23DPR0595G", "23DPR0595G", "23DPR0595G", …
#> $ TURNO   <chr> "VESPERTINO", "VESPERTINO", "VESPERTINO", "VESPERTINO", …
#> $ ESCUELA <chr> "JAIME NUNO", "JAIME NUNO", "JAIME NUNO", "JAIME NUNO", …
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "…
#> $ CVE_MUN <chr> "007", "007", "007", "007", "007", "007", "007", "007", …
#> $ NOM_MUN <chr> "LAZARO CARDENAS", "LAZARO CARDENAS", "LAZARO CARDENAS",…
#> $ CVE_LOC <chr> "0041", "0041", "0041", "0041", "0041", "0041", "0041", …
#> $ NOM_LOC <chr> "NUEVO VALLADOLID", "NUEVO VALLADOLID", "NUEVO VALLADOLI…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", …
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5,…
#> $ PUNTAJE <dbl> 543, 538, 458, 551, 545, 493, NA, NA, NA, NA, NA, NA, 47…
```
...
#> Observations: 12,000
#> Variables: 12
#> $ CVE_ENT    <chr> "23", "23", "23", "23", "23", "23", "23", "23", "23",…
#> $ NOM_ENT    <chr> "QUINTANA ROO", "QUINTANA ROO", "QUINTANA ROO", "QUIN…
#> $ CCT        <chr> "23DPR0595G", "23DPR0595G", "23DPR0595G", "23DPR0595G…
#> $ TURNO      <chr> "VESPERTINO", "VESPERTINO", "VESPERTINO", "VESPERTINO…
#> $ ESCUELA    <chr> "JAIME NUNO", "JAIME NUNO", "JAIME NUNO", "JAIME NUNO…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL"…
#> $ CVE_MUN    <chr> "007", "007", "007", "007", "007", "007", "007", "007…
#> $ NOM_MUN    <chr> "LAZARO CARDENAS", "LAZARO CARDENAS", "LAZARO CARDENA…
#> $ CVE_LOC    <chr> "0041", "0041", "0041", "0041", "0041", "0041", "0041…
#> $ NOM_LOC    <chr> "NUEVO VALLADOLID", "NUEVO VALLADOLID", "NUEVO VALLAD…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4",…
#> $ PUNTAJE    <dbl> 543, 538, 458, 551, 545, 493, NA, NA, NA, NA, NA, NA,…
```
