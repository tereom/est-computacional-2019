...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "13", "05", "07", "21", "07", "10", "09", "09", "23",…
#> $ NOM_ENT    <chr> "HIDALGO", "COAHUILA", "CHIAPAS", "PUEBLA", "CHIAPAS"…
#> $ CCT        <chr> "13DPR1914B", "05EPR0093X", "07DPB0995K", "21EPR0492L…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "PROFR. JOSE PE\u0084A BAUTISTA", "ANEXA A LA NORMAL …
#> $ TIPO       <chr> "GENERAL", "GENERAL", "INDêGENA", "GENERAL", "CONAFE"…
#> $ CVE_MUN    <chr> "003", "030", "059", "086", "030", "028", "015", "002…
#> $ NOM_MUN    <chr> "ACTOPAN", "SALTILLO", "OCOSINGO", "JALPAN", "CHICOMU…
#> $ CVE_LOC    <chr> "0001", "0001", "1518", "0002", "0003", "0037", "0040…
#> $ NOM_LOC    <chr> "ACTOPAN", "SALTILLO", "NUEVO MONTE LIBANO", "ACOYOTI…
#> $ PUNT_ESP_3 <dbl> 645, 593, 541, 528, NA, 773, 494, 393, 716, 688, 589,…
#> $ PUNT_MAT_3 <dbl> 722, 629, 624, 645, NA, 810, 519, 340, 846, 823, 581,…
#> $ PUNT_FCE_3 <dbl> 577, 540, 433, 470, NA, 639, 472, 381, 640, 609, 557,…
#> $ PUNT_ESP_4 <dbl> 521, 605, 581, 502, 360, NA, 491, NA, 721, 596, 598, …
#> $ PUNT_MAT_4 <dbl> 561, 598, 716, 526, 445, NA, 535, NA, 739, 657, 584, …
#> $ PUNT_FCE_4 <dbl> 492, 547, 590, 439, 364, NA, 461, NA, 669, 581, 541, …
#> $ PUNT_ESP_5 <dbl> 637, 611, 605, 517, 370, NA, 482, 358, 592, 639, 490,…
#> $ PUNT_MAT_5 <dbl> 689, 621, 769, 594, 346, NA, 538, 330, 554, 660, 504,…
#> $ PUNT_FCE_5 <dbl> 574, 554, 574, 456, 411, NA, 484, 328, 571, 602, 459,…
#> $ PUNT_ESP_6 <dbl> 592, 625, 534, 535, NA, 616, 524, 608, 580, 544, 612,…
#> $ PUNT_MAT_6 <dbl> 617, 642, 689, 671, NA, 515, 539, 559, 635, 591, 573,…
#> $ PUNT_FCE_6 <dbl> 552, 566, 503, 522, NA, 534, 512, 516, 552, 481, 547,…
```
...
enlacep_tidy
#> # A tibble: 11,319 x 13
#>    CVE_ENT NOM_ENT CCT   TURNO ESCUELA TIPO  CVE_MUN NOM_MUN CVE_LOC
#>    <chr>   <chr>   <chr> <chr> <chr>   <chr> <chr>   <chr>   <chr>  
#>  1 13      HIDALGO 13DP… MATU… "PROFR… GENE… 003     ACTOPAN 0001   
#>  2 05      COAHUI… 05EP… MATU… ANEXA … GENE… 030     SALTIL… 0001   
#>  3 07      CHIAPAS 07DP… MATU… DR. AL… INDê… 059     OCOSIN… 1518   
#>  4 21      PUEBLA  21EP… MATU… JOSEFA… GENE… 086     JALPAN  0002   
#>  5 10      DURANGO 10DP… MATU… CUAUHT… GENE… 028     SAN JU… 0037   
#>  6 09      DISTRI… 09DP… MATU… ABRAHA… GENE… 015     CUAUHT… 0040   
#>  7 09      DISTRI… 09DB… NOCT… JOSE R… GENE… 002     AZCAPO… 0001   
#>  8 23      QUINTA… 23DP… MATU… JUSTO … GENE… 004     OTHON … 9990   
#>  9 30      VERACR… 30DP… MATU… CUAUHT… INDê… 058     CHICON… 0069   
#> 10 23      QUINTA… 23PP… MATU… COLEGI… PART… 005     BENITO… 0001   
#> # … with 11,309 more rows, and 4 more variables: NOM_LOC <chr>,
...
#> Observations: 11,319
#> Variables: 13
#> $ cve_ent <chr> "13", "05", "07", "21", "10", "09", "09", "23", "30", "2…
#> $ nom_ent <chr> "HIDALGO", "COAHUILA", "CHIAPAS", "PUEBLA", "DURANGO", "…
#> $ cct     <chr> "13DPR1914B", "05EPR0093X", "07DPB0995K", "21EPR0492L", …
#> $ turno   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ escuela <chr> "PROFR. JOSE PE\u0084A BAUTISTA", "ANEXA A LA NORMAL DEL…
#> $ tipo    <chr> "GENERAL", "GENERAL", "INDêGENA", "GENERAL", "GENERAL", …
#> $ cve_mun <chr> "003", "030", "059", "086", "028", "015", "002", "004", …
#> $ nom_mun <chr> "ACTOPAN", "SALTILLO", "OCOSINGO", "JALPAN", "SAN JUAN D…
#> $ cve_loc <chr> "0001", "0001", "1518", "0002", "0037", "0040", "0001", …
#> $ nom_loc <chr> "ACTOPAN", "SALTILLO", "NUEVO MONTE LIBANO", "ACOYOTITLA…
#> $ area    <chr> "ESP", "ESP", "ESP", "ESP", "ESP", "ESP", "ESP", "ESP", …
#> $ grado   <dbl> 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3,…
#> $ puntaje <dbl> 645, 593, 541, 528, 773, 494, 393, 716, 688, 589, 538, 6…
```
