...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "19", "24", "15", "07", "16", "23", "11", "10", "11", "18"…
#> $ NOM_ENT    <chr> "NUEVO LEON", "SAN LUIS POTOSI", "MEXICO", "CHIAPAS", "MIC…
#> $ CCT        <chr> "19DPR1746Q", "24DPR0634R", "15EPR4234N", "07KPR2912J", "1…
#> $ TURNO      <chr> "VESPERTINO", "MATUTINO", "VESPERTINO", "MATUTINO", "MATUT…
#> $ ESCUELA    <chr> "LIC. ADOLFO LOPEZ MATEOS", "VICENTE GUERRERO", "JOAQUIN A…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "CONAFE", "GENERAL", "GEN…
#> $ CVE_MUN    <chr> "021", "037", "110", "077", "052", "010", "022", "028", "0…
#> $ NOM_MUN    <chr> "GENERAL ESCOBEDO", "TAMAZUNCHALE", "VALLE DE BRAVO", "SAL…
#> $ CVE_LOC    <chr> "0001", "0085", "0001", "0492", "0137", "0024", "0036", "0…
#> $ NOM_LOC    <chr> "CIUDAD GENERAL ESCOBEDO", "TEMAMATLA", "VALLE DE BRAVO", …
#> $ PUNT_ESP_3 <dbl> 623, 499, 483, NA, 721, 435, 548, 565, 479, 406, 598, 749,…
#> $ PUNT_MAT_3 <dbl> 650, 554, 526, NA, 752, 450, 612, 627, 511, 386, 648, 808,…
#> $ PUNT_FCE_3 <dbl> 628, 463, 463, NA, 584, 431, 473, 533, 482, 410, 572, 650,…
#> $ PUNT_ESP_4 <dbl> 528, 516, 531, NA, 631, 404, 695, 608, 497, 447, 588, 718,…
#> $ PUNT_MAT_4 <dbl> 583, 537, 584, NA, 689, 442, 775, 638, 474, 450, 592, 809,…
#> $ PUNT_FCE_4 <dbl> 445, 447, 430, NA, 577, 365, 655, 569, 527, 424, 515, 654,…
#> $ PUNT_ESP_5 <dbl> 542, 571, 433, 542, 645, 514, 529, 438, 446, 401, 592, 735…
#> $ PUNT_MAT_5 <dbl> 575, 586, 414, 688, 694, 482, 621, 471, 413, 376, 602, 719…
#> $ PUNT_FCE_5 <dbl> 488, 501, 415, 556, 558, 534, 503, 383, 370, 379, 530, 654…
#> $ PUNT_ESP_6 <dbl> 505, 637, 445, NA, 645, 479, 508, 517, 382, 458, 590, 641,…
#> $ PUNT_MAT_6 <dbl> 495, 725, 434, NA, 768, 518, 555, 564, 386, 432, 638, 730,…
#> $ PUNT_FCE_6 <dbl> 476, 607, 442, NA, 590, 488, 476, 454, 299, 461, 554, 539,…
```
...
#>  1 19      NUEVO … 19DP… VESP… LIC. A… GENE… 021     GENERA… 0001    CIUDAD…
#>  2 19      NUEVO … 19DP… VESP… LIC. A… GENE… 021     GENERA… 0001    CIUDAD…
#>  3 19      NUEVO … 19DP… VESP… LIC. A… GENE… 021     GENERA… 0001    CIUDAD…
#>  4 19      NUEVO … 19DP… VESP… LIC. A… GENE… 021     GENERA… 0001    CIUDAD…
#>  5 19      NUEVO … 19DP… VESP… LIC. A… GENE… 021     GENERA… 0001    CIUDAD…
#>  6 19      NUEVO … 19DP… VESP… LIC. A… GENE… 021     GENERA… 0001    CIUDAD…
#>  7 19      NUEVO … 19DP… VESP… LIC. A… GENE… 021     GENERA… 0001    CIUDAD…
#>  8 19      NUEVO … 19DP… VESP… LIC. A… GENE… 021     GENERA… 0001    CIUDAD…
#>  9 19      NUEVO … 19DP… VESP… LIC. A… GENE… 021     GENERA… 0001    CIUDAD…
#> 10 19      NUEVO … 19DP… VESP… LIC. A… GENE… 021     GENERA… 0001    CIUDAD…
...
#> $ CCT     <chr> "19DPR1746Q", "19DPR1746Q", "19DPR1746Q", "19DPR1746Q", "19DP…
...
#> $ CVE_MUN <chr> "021", "021", "021", "021", "021", "021", "021", "021", "021"…
#> $ NOM_MUN <chr> "GENERAL ESCOBEDO", "GENERAL ESCOBEDO", "GENERAL ESCOBEDO", "…
#> $ CVE_LOC <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001", "0001…
#> $ NOM_LOC <chr> "CIUDAD GENERAL ESCOBEDO", "CIUDAD GENERAL ESCOBEDO", "CIUDAD…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", "FCE"…
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5, 5, 5…
#> $ PUNTAJE <dbl> 623, 650, 628, 528, 583, 445, 542, 575, 488, 505, 495, 476, 4…
```
...
#> $ CCT        <chr> "19DPR1746Q", "19DPR1746Q", "19DPR1746Q", "19DPR1746Q", "1…
...
#> $ CVE_MUN    <chr> "021", "021", "021", "021", "021", "021", "021", "021", "0…
#> $ NOM_MUN    <chr> "GENERAL ESCOBEDO", "GENERAL ESCOBEDO", "GENERAL ESCOBEDO"…
#> $ CVE_LOC    <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001", "0…
#> $ NOM_LOC    <chr> "CIUDAD GENERAL ESCOBEDO", "CIUDAD GENERAL ESCOBEDO", "CIU…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4", "ESP…
#> $ PUNTAJE    <dbl> 623, 650, 628, 528, 583, 445, 542, 575, 488, 505, 495, 476…
```
