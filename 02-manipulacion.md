...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "30", "09", "27", "15", "24", "31", "07", "11", "32",…
#> $ NOM_ENT    <chr> "VERACRUZ", "DISTRITO FEDERAL", "TABASCO", "MEXICO", …
#> $ CCT        <chr> "30EPR3560U", "09DPR2638I", "27DPR0224L", "15KCA0083D…
#> $ TURNO      <chr> "MATUTINO", "VESPERTINO", "MATUTINO", "MATUTINO", "MA…
#> $ ESCUELA    <chr> "IGNACIO LOPEZ RAYON", "LUCRECIA TORIZ", "TEZIUTLAN",…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "CONAFE", "GENERAL",…
#> $ CVE_MUN    <chr> "092", "006", "004", "054", "020", "096", "039", "030…
#> $ NOM_MUN    <chr> "XICO", "IZTACALCO", "CENTRO", "METEPEC", "MATEHUALA"…
#> $ CVE_LOC    <chr> "0031", "0056", "0120", "0125", "0001", "0440", "0031…
#> $ NOM_LOC    <chr> "LOS POCITOS", "CUCHILLA RAMOS MILLAN", "LAGARTERA 1R…
#> $ PUNT_ESP_3 <dbl> 616, 524, 396, 658, 491, 426, 473, 486, 434, 617, 412…
#> $ PUNT_MAT_3 <dbl> 702, 556, 392, 587, 532, 598, 567, 488, 495, 606, 440…
#> $ PUNT_FCE_3 <dbl> 563, 447, 380, 601, 435, 382, 576, 372, 487, 590, 419…
#> $ PUNT_ESP_4 <dbl> 634, 570, 444, 382, 477, 416, 485, 515, 445, 589, 377…
#> $ PUNT_MAT_4 <dbl> 708, 571, 440, 366, 562, 471, 629, 567, 452, 593, 425…
#> $ PUNT_FCE_4 <dbl> 596, 453, 389, 382, 433, 401, 630, 468, 411, 535, 385…
#> $ PUNT_ESP_5 <dbl> 657, 516, 436, NA, 490, 450, 536, 451, 526, 551, 280,…
#> $ PUNT_MAT_5 <dbl> 681, 555, 433, NA, 515, 444, 661, 509, 595, 568, 349,…
#> $ PUNT_FCE_5 <dbl> 572, 466, 423, NA, 439, 427, 551, 451, 476, 470, 328,…
#> $ PUNT_ESP_6 <dbl> 615, 550, 441, 461, 525, 408, 511, 453, 457, 631, NA,…
#> $ PUNT_MAT_6 <dbl> 727, 597, 402, 338, 566, 414, 544, 505, 490, 610, NA,…
#> $ PUNT_FCE_6 <dbl> 607, 517, 401, 358, 497, 499, 582, 428, 443, 582, NA,…
```
...
enlacep_tidy
#> # A tibble: 11,406 x 13
#>    CVE_ENT NOM_ENT CCT   TURNO ESCUELA TIPO  CVE_MUN NOM_MUN CVE_LOC
#>    <chr>   <chr>   <chr> <chr> <chr>   <chr> <chr>   <chr>   <chr>  
#>  1 30      VERACR… 30EP… MATU… IGNACI… GENE… 092     XICO    0031   
#>  2 09      DISTRI… 09DP… VESP… LUCREC… GENE… 006     IZTACA… 0056   
#>  3 27      TABASCO 27DP… MATU… TEZIUT… GENE… 004     CENTRO  0120   
#>  4 15      MEXICO  15KC… MATU… CIRCO … CONA… 054     METEPEC 0125   
#>  5 24      SAN LU… 24DP… MATU… ROSARI… GENE… 020     MATEHU… 0001   
#>  6 31      YUCATAN 31KP… MATU… TRASCO… CONA… 096     TIZIMIN 0440   
#>  7 07      CHIAPAS 07DP… MATU… FRANCI… INDê… 039     HUITIU… 0031   
#>  8 11      GUANAJ… 11DP… MATU… MARTIR… GENE… 030     SAN FE… 0141   
#>  9 32      ZACATE… 32DP… MATU… CUAUHT… GENE… 049     VALPAR… 0069   
#> 10 19      NUEVO … 19PP… MATU… INSTIT… PART… 038     MONTEM… 0001   
#> # … with 11,396 more rows, and 4 more variables: NOM_LOC <chr>,
...
#> Observations: 11,406
#> Variables: 13
#> $ cve_ent <chr> "30", "09", "27", "15", "24", "31", "07", "11", "32", "1…
#> $ nom_ent <chr> "VERACRUZ", "DISTRITO FEDERAL", "TABASCO", "MEXICO", "SA…
#> $ cct     <chr> "30EPR3560U", "09DPR2638I", "27DPR0224L", "15KCA0083D", …
#> $ turno   <chr> "MATUTINO", "VESPERTINO", "MATUTINO", "MATUTINO", "MATUT…
#> $ escuela <chr> "IGNACIO LOPEZ RAYON", "LUCRECIA TORIZ", "TEZIUTLAN", "C…
#> $ tipo    <chr> "GENERAL", "GENERAL", "GENERAL", "CONAFE", "GENERAL", "C…
#> $ cve_mun <chr> "092", "006", "004", "054", "020", "096", "039", "030", …
#> $ nom_mun <chr> "XICO", "IZTACALCO", "CENTRO", "METEPEC", "MATEHUALA", "…
#> $ cve_loc <chr> "0031", "0056", "0120", "0125", "0001", "0440", "0031", …
#> $ nom_loc <chr> "LOS POCITOS", "CUCHILLA RAMOS MILLAN", "LAGARTERA 1RA. …
#> $ area    <chr> "ESP", "ESP", "ESP", "ESP", "ESP", "ESP", "ESP", "ESP", …
#> $ grado   <dbl> 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3,…
#> $ puntaje <dbl> 616, 524, 396, 658, 491, 426, 473, 486, 434, 617, 412, 5…
```
