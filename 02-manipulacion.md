...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "14", "14", "12", "30", "25", "13", "29", "32", "24",…
#> $ NOM_ENT    <chr> "JALISCO", "JALISCO", "GUERRERO", "VERACRUZ", "SINALO…
#> $ CCT        <chr> "14EPR1155H", "14DPR1999Y", "12DPB0443V", "30DPR1492A…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "CLUB DE LEONES 7", "SAUL RODILES", "VICENTE GUERRERO…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "INDêGENA", "GENERAL", "GENERAL…
#> $ CVE_MUN    <chr> "039", "093", "043", "129", "006", "022", "015", "042…
#> $ NOM_MUN    <chr> "GUADALAJARA", "TEPATITLAN DE MORELOS", "METLATONOC",…
#> $ CVE_LOC    <chr> "0001", "0001", "0034", "0062", "0001", "0016", "0026…
#> $ NOM_LOC    <chr> "GUADALAJARA", "TEPATITLAN DE MORELOS", "ZITLALTEPEC"…
#> $ PUNT_ESP_3 <dbl> 639, 504, 645, 448, 552, 504, 471, 485, 378, 560, 640…
#> $ PUNT_MAT_3 <dbl> 708, 543, 768, 429, 576, 523, 438, 519, 430, 595, 755…
#> $ PUNT_FCE_3 <dbl> 627, 447, 645, 441, 499, 451, 438, 413, 423, 525, 611…
#> $ PUNT_ESP_4 <dbl> 638, 478, 607, 553, 576, 485, 402, 475, NA, 602, 683,…
#> $ PUNT_MAT_4 <dbl> 640, 521, 713, 643, 611, 426, 414, 477, NA, 654, 699,…
#> $ PUNT_FCE_4 <dbl> 574, 439, 602, 560, 521, 342, 421, 459, NA, 551, 586,…
#> $ PUNT_ESP_5 <dbl> 615, 535, 677, 680, 541, 605, 526, 511, 389, 729, 625…
#> $ PUNT_MAT_5 <dbl> 618, 592, 819, 653, 591, 713, 547, 563, 381, 835, 782…
#> $ PUNT_FCE_5 <dbl> 523, 483, 653, 554, 512, 581, 468, 420, 396, 676, 628…
#> $ PUNT_ESP_6 <dbl> 666, 507, 496, 692, 591, NA, 481, 470, NA, 670, 705, …
#> $ PUNT_MAT_6 <dbl> 741, 550, 579, 734, 645, NA, 525, 458, NA, 693, 803, …
#> $ PUNT_FCE_6 <dbl> 602, 479, 444, 520, 550, NA, 501, 427, NA, 546, 587, …
```
...
enlacep_tidy
#> # A tibble: 11,322 x 13
#>    CVE_ENT NOM_ENT CCT   TURNO ESCUELA TIPO  CVE_MUN NOM_MUN CVE_LOC
#>    <chr>   <chr>   <chr> <chr> <chr>   <chr> <chr>   <chr>   <chr>  
#>  1 14      JALISCO 14EP… MATU… CLUB D… GENE… 039     GUADAL… 0001   
#>  2 14      JALISCO 14DP… MATU… SAUL R… GENE… 093     TEPATI… 0001   
#>  3 12      GUERRE… 12DP… MATU… VICENT… INDê… 043     METLAT… 0034   
#>  4 30      VERACR… 30DP… MATU… DESPER… GENE… 129     PLATON… 0062   
#>  5 25      SINALOA 25DP… MATU… J. GUA… GENE… 006     CULIAC… 0001   
#>  6 13      HIDALGO 13KP… MATU… SAN JO… CONA… 022     EPAZOY… 0016   
#>  7 29      TLAXCA… 29EP… MATU… LAZARO… GENE… 015     IXTACU… 0026   
#>  8 32      ZACATE… 32DP… MATU… RAMON … GENE… 042     SOMBRE… 0176   
#>  9 24      SAN LU… 24KP… MATU… LA SOL… CONA… 042     TANQUI… 0018   
#> 10 07      CHIAPAS 07DP… MATU… BENITO… GENE… 102     TUXTLA… 0004   
#> # … with 11,312 more rows, and 4 more variables: NOM_LOC <chr>,
...
#> Observations: 11,322
#> Variables: 13
#> $ cve_ent <chr> "14", "14", "12", "30", "25", "13", "29", "32", "24", "0…
#> $ nom_ent <chr> "JALISCO", "JALISCO", "GUERRERO", "VERACRUZ", "SINALOA",…
#> $ cct     <chr> "14EPR1155H", "14DPR1999Y", "12DPB0443V", "30DPR1492A", …
#> $ turno   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ escuela <chr> "CLUB DE LEONES 7", "SAUL RODILES", "VICENTE GUERRERO", …
#> $ tipo    <chr> "GENERAL", "GENERAL", "INDêGENA", "GENERAL", "GENERAL", …
#> $ cve_mun <chr> "039", "093", "043", "129", "006", "022", "015", "042", …
#> $ nom_mun <chr> "GUADALAJARA", "TEPATITLAN DE MORELOS", "METLATONOC", "P…
#> $ cve_loc <chr> "0001", "0001", "0034", "0062", "0001", "0016", "0026", …
#> $ nom_loc <chr> "GUADALAJARA", "TEPATITLAN DE MORELOS", "ZITLALTEPEC", "…
#> $ area    <chr> "ESP", "ESP", "ESP", "ESP", "ESP", "ESP", "ESP", "ESP", …
#> $ grado   <dbl> 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3,…
#> $ puntaje <dbl> 639, 504, 645, 448, 552, 504, 471, 485, 378, 560, 640, 6…
```
