...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "12", "06", "30", "08", "26", "15", "23", "19", "18",…
#> $ NOM_ENT    <chr> "GUERRERO", "COLIMA", "VERACRUZ", "CHIHUAHUA", "SONOR…
#> $ CCT        <chr> "12DPR2174F", "06DPR0121C", "30DPR0468U", "08DPR0339Y…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "JUSTO SIERRA", "EMILIANO ZAPATA", "GRAL. ADALBERTO T…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL"…
#> $ CVE_MUN    <chr> "052", "007", "188", "019", "029", "115", "005", "039…
#> $ NOM_MUN    <chr> "SAN LUIS ACATLAN", "MANZANILLO", "TOTUTLA", "CHIHUAH…
#> $ CVE_LOC    <chr> "0015", "0033", "0018", "0001", "0142", "0001", "0001…
#> $ NOM_LOC    <chr> "MIAHUICHAN", "EMILIANO ZAPATA", "TLACUATZINTLA", "CH…
#> $ PUNT_ESP_3 <dbl> 606, 460, 389, 528, 605, 580, 574, 588, 507, 613, 577…
#> $ PUNT_MAT_3 <dbl> 645, 504, 395, 571, 663, 658, 633, 610, 478, 774, 654…
#> $ PUNT_FCE_3 <dbl> 584, 447, 372, 499, 428, 530, 507, 522, 409, 614, 529…
#> $ PUNT_ESP_4 <dbl> 788, 397, 404, 600, 576, 611, 664, 554, 449, 528, 500…
#> $ PUNT_MAT_4 <dbl> 840, 444, 383, 631, 629, 591, 702, 544, 458, 612, 567…
#> $ PUNT_FCE_4 <dbl> 602, 381, 447, 567, 423, 546, 620, 467, 426, 454, 500…
#> $ PUNT_ESP_5 <dbl> 488, 409, 509, 743, 445, 555, 540, 543, 374, 477, 512…
#> $ PUNT_MAT_5 <dbl> 477, 377, 485, 817, 472, 563, 574, 634, 426, 566, 594…
#> $ PUNT_FCE_5 <dbl> 412, 408, 499, 678, 370, 504, 542, 450, 405, 427, 476…
#> $ PUNT_ESP_6 <dbl> 536, 408, 381, 596, 468, 617, 589, 509, 532, 499, 501…
#> $ PUNT_MAT_6 <dbl> 604, 370, 400, 593, 481, 637, 690, 552, 494, 524, 605…
#> $ PUNT_FCE_6 <dbl> 441, 418, 358, 532, 409, 562, 540, 484, 437, 486, 452…
```
...
#>  1 12      GUERRE… 12DP… MATU… JUSTO … GENE… 052     SAN LU… 0015   
#>  2 12      GUERRE… 12DP… MATU… JUSTO … GENE… 052     SAN LU… 0015   
#>  3 12      GUERRE… 12DP… MATU… JUSTO … GENE… 052     SAN LU… 0015   
#>  4 12      GUERRE… 12DP… MATU… JUSTO … GENE… 052     SAN LU… 0015   
#>  5 12      GUERRE… 12DP… MATU… JUSTO … GENE… 052     SAN LU… 0015   
#>  6 12      GUERRE… 12DP… MATU… JUSTO … GENE… 052     SAN LU… 0015   
#>  7 12      GUERRE… 12DP… MATU… JUSTO … GENE… 052     SAN LU… 0015   
#>  8 12      GUERRE… 12DP… MATU… JUSTO … GENE… 052     SAN LU… 0015   
#>  9 12      GUERRE… 12DP… MATU… JUSTO … GENE… 052     SAN LU… 0015   
#> 10 12      GUERRE… 12DP… MATU… JUSTO … GENE… 052     SAN LU… 0015   
...
#> $ CCT     <chr> "12DPR2174F", "12DPR2174F", "12DPR2174F", "12DPR2174F", …
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA <chr> "JUSTO SIERRA", "JUSTO SIERRA", "JUSTO SIERRA", "JUSTO S…
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "…
#> $ CVE_MUN <chr> "052", "052", "052", "052", "052", "052", "052", "052", …
#> $ NOM_MUN <chr> "SAN LUIS ACATLAN", "SAN LUIS ACATLAN", "SAN LUIS ACATLA…
#> $ CVE_LOC <chr> "0015", "0015", "0015", "0015", "0015", "0015", "0015", …
#> $ NOM_LOC <chr> "MIAHUICHAN", "MIAHUICHAN", "MIAHUICHAN", "MIAHUICHAN", …
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", …
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5,…
#> $ PUNTAJE <dbl> 606, 645, 584, 788, 840, 602, 488, 477, 412, 536, 604, 4…
```
...
#> $ CCT        <chr> "12DPR2174F", "12DPR2174F", "12DPR2174F", "12DPR2174F…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "JUSTO SIERRA", "JUSTO SIERRA", "JUSTO SIERRA", "JUST…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL"…
#> $ CVE_MUN    <chr> "052", "052", "052", "052", "052", "052", "052", "052…
#> $ NOM_MUN    <chr> "SAN LUIS ACATLAN", "SAN LUIS ACATLAN", "SAN LUIS ACA…
#> $ CVE_LOC    <chr> "0015", "0015", "0015", "0015", "0015", "0015", "0015…
#> $ NOM_LOC    <chr> "MIAHUICHAN", "MIAHUICHAN", "MIAHUICHAN", "MIAHUICHAN…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4",…
#> $ PUNTAJE    <dbl> 606, 645, 584, 788, 840, 602, 488, 477, 412, 536, 604…
```
