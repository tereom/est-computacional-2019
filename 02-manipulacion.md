...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "12", "10", "14", "30", "16", "08", "11", "32", "30", "21"…
#> $ NOM_ENT    <chr> "GUERRERO", "DURANGO", "JALISCO", "VERACRUZ", "MICHOACAN",…
#> $ CCT        <chr> "12DPR1252M", "10PPR0041I", "14EPR0956S", "30EPR0842H", "1…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "VESPERTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA    <chr> "BENITO JUAREZ", "COLEGIO SANTA TERESA DE CALCUTA A.C.", "…
#> $ TIPO       <chr> "GENERAL", "PARTICULAR", "GENERAL", "GENERAL", "GENERAL", …
#> $ CVE_MUN    <chr> "011", "007", "039", "060", "020", "037", "035", "038", "0…
#> $ NOM_MUN    <chr> "ATOYAC DE ALVAREZ", "GOMEZ PALACIO", "GUADALAJARA", "CHIN…
#> $ CVE_LOC    <chr> "0130", "0001", "0001", "0006", "0003", "0001", "0059", "0…
#> $ NOM_LOC    <chr> "LA PINTADA", "GOMEZ PALACIO", "GUADALAJARA", "CHAPOPOTE",…
#> $ PUNT_ESP_3 <dbl> 566, 593, 598, 442, 703, 580, 607, 447, 562, 470, 472, 463…
#> $ PUNT_MAT_3 <dbl> 539, 634, 659, 428, 805, 582, 720, 443, 604, 464, 465, 429…
#> $ PUNT_FCE_3 <dbl> 502, 551, 540, 375, 661, 544, 571, 380, 434, 407, 430, 466…
#> $ PUNT_ESP_4 <dbl> 752, 586, 627, 468, NA, 560, 534, 425, 446, 425, 503, 451,…
#> $ PUNT_MAT_4 <dbl> 791, 561, 700, 509, NA, 556, 534, 467, 448, 444, 513, 524,…
#> $ PUNT_FCE_4 <dbl> 687, 518, 612, 487, NA, 488, 482, 423, 433, 410, 458, 443,…
#> $ PUNT_ESP_5 <dbl> 508, 610, 690, 571, NA, 662, 468, 442, 621, 503, 453, 455,…
#> $ PUNT_MAT_5 <dbl> 637, 625, 731, 564, NA, 665, 483, 511, 754, 508, 482, 576,…
#> $ PUNT_FCE_5 <dbl> 443, 527, 574, 542, NA, 595, 426, 448, 532, 495, 429, 409,…
#> $ PUNT_ESP_6 <dbl> 466, 543, 560, 506, NA, 595, 494, 461, 484, 472, 588, 424,…
#> $ PUNT_MAT_6 <dbl> 519, 540, 579, 467, NA, 580, 523, 504, 733, 541, 647, 380,…
#> $ PUNT_FCE_6 <dbl> 453, 493, 569, 535, NA, 471, 449, 378, 441, 476, 509, 332,…
```
...
#>  1 12      GUERRE… 12DP… MATU… BENITO… GENE… 011     ATOYAC… 0130    LA PIN…
#>  2 12      GUERRE… 12DP… MATU… BENITO… GENE… 011     ATOYAC… 0130    LA PIN…
#>  3 12      GUERRE… 12DP… MATU… BENITO… GENE… 011     ATOYAC… 0130    LA PIN…
#>  4 12      GUERRE… 12DP… MATU… BENITO… GENE… 011     ATOYAC… 0130    LA PIN…
#>  5 12      GUERRE… 12DP… MATU… BENITO… GENE… 011     ATOYAC… 0130    LA PIN…
#>  6 12      GUERRE… 12DP… MATU… BENITO… GENE… 011     ATOYAC… 0130    LA PIN…
#>  7 12      GUERRE… 12DP… MATU… BENITO… GENE… 011     ATOYAC… 0130    LA PIN…
#>  8 12      GUERRE… 12DP… MATU… BENITO… GENE… 011     ATOYAC… 0130    LA PIN…
#>  9 12      GUERRE… 12DP… MATU… BENITO… GENE… 011     ATOYAC… 0130    LA PIN…
#> 10 12      GUERRE… 12DP… MATU… BENITO… GENE… 011     ATOYAC… 0130    LA PIN…
...
#> Observations: 12,000
#> Variables: 13
#> $ CVE_ENT <chr> "12", "12", "12", "12", "12", "12", "12", "12", "12", "12", "…
#> $ NOM_ENT <chr> "GUERRERO", "GUERRERO", "GUERRERO", "GUERRERO", "GUERRERO", "…
#> $ CCT     <chr> "12DPR1252M", "12DPR1252M", "12DPR1252M", "12DPR1252M", "12DP…
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "…
#> $ ESCUELA <chr> "BENITO JUAREZ", "BENITO JUAREZ", "BENITO JUAREZ", "BENITO JU…
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENER…
#> $ CVE_MUN <chr> "011", "011", "011", "011", "011", "011", "011", "011", "011"…
#> $ NOM_MUN <chr> "ATOYAC DE ALVAREZ", "ATOYAC DE ALVAREZ", "ATOYAC DE ALVAREZ"…
#> $ CVE_LOC <chr> "0130", "0130", "0130", "0130", "0130", "0130", "0130", "0130…
#> $ NOM_LOC <chr> "LA PINTADA", "LA PINTADA", "LA PINTADA", "LA PINTADA", "LA P…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", "FCE"…
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5, 5, 5…
#> $ PUNTAJE <dbl> 566, 539, 502, 752, 791, 687, 508, 637, 443, 466, 519, 453, 5…
```
...
#> $ CVE_ENT    <chr> "12", "12", "12", "12", "12", "12", "12", "12", "12", "12"…
#> $ NOM_ENT    <chr> "GUERRERO", "GUERRERO", "GUERRERO", "GUERRERO", "GUERRERO"…
#> $ CCT        <chr> "12DPR1252M", "12DPR1252M", "12DPR1252M", "12DPR1252M", "1…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO"…
#> $ ESCUELA    <chr> "BENITO JUAREZ", "BENITO JUAREZ", "BENITO JUAREZ", "BENITO…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GE…
#> $ CVE_MUN    <chr> "011", "011", "011", "011", "011", "011", "011", "011", "0…
#> $ NOM_MUN    <chr> "ATOYAC DE ALVAREZ", "ATOYAC DE ALVAREZ", "ATOYAC DE ALVAR…
#> $ CVE_LOC    <chr> "0130", "0130", "0130", "0130", "0130", "0130", "0130", "0…
#> $ NOM_LOC    <chr> "LA PINTADA", "LA PINTADA", "LA PINTADA", "LA PINTADA", "L…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4", "ESP…
#> $ PUNTAJE    <dbl> 566, 539, 502, 752, 791, 687, 508, 637, 443, 466, 519, 453…
```
