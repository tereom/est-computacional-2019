...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "03", "21", "11", "19", "22", "13", "12", "07", "21",…
#> $ NOM_ENT    <chr> "BAJA CALIFORNIA SUR", "PUEBLA", "GUANAJUATO", "NUEVO…
#> $ CCT        <chr> "03DPR0011Z", "21KPR0018S", "11DPR0283Z", "19DPR1509O…
#> $ TURNO      <chr> "VESPERTINO", "MATUTINO", "MATUTINO", "MATUTINO", "VE…
#> $ ESCUELA    <chr> "EMILIANO ZAPATA", "PRIMARIA COMUNITARIA RURAL GUADAL…
#> $ TIPO       <chr> "GENERAL", "CONAFE", "GENERAL", "GENERAL", "GENERAL",…
#> $ CVE_MUN    <chr> "003", "015", "033", "021", "012", "048", "071", "012…
#> $ NOM_MUN    <chr> "LA PAZ", "AMOZOC", "SAN LUIS DE LA PAZ", "GENERAL ES…
#> $ CVE_LOC    <chr> "0684", "0054", "0097", "0001", "0029", "0001", "0070…
#> $ NOM_LOC    <chr> "EL PESCADERO", "GUADALUPE VICTORIA (GUADALUPE DEL MO…
#> $ PUNT_ESP_3 <dbl> 520, NA, 595, 549, 493, 626, 538, 372, 446, 545, NA, …
#> $ PUNT_MAT_3 <dbl> 521, NA, 689, 591, 485, 625, 621, 375, 484, 586, NA, …
#> $ PUNT_FCE_3 <dbl> 444, NA, 527, 536, 455, 579, 583, 366, 388, 512, NA, …
#> $ PUNT_ESP_4 <dbl> 511, 325, 503, 609, 422, 649, 515, 399, 435, 516, 499…
#> $ PUNT_MAT_4 <dbl> 545, 399, 550, 706, 467, 655, 479, 360, 496, 507, 570…
#> $ PUNT_FCE_4 <dbl> 489, 396, 448, 598, 410, 572, 443, 397, 454, 448, 520…
#> $ PUNT_ESP_5 <dbl> 446, 480, 531, 664, 440, 625, 647, 448, 495, 543, NA,…
#> $ PUNT_MAT_5 <dbl> 477, 534, 511, 706, 455, 620, 673, 400, 587, 559, NA,…
#> $ PUNT_FCE_5 <dbl> 468, 441, 475, 657, 402, 567, 687, 374, 480, 480, NA,…
#> $ PUNT_ESP_6 <dbl> 540, 421, 536, 595, 457, 628, 627, 346, 407, 553, NA,…
#> $ PUNT_MAT_6 <dbl> 562, 457, 671, 635, 498, 618, 645, 390, 490, 623, NA,…
#> $ PUNT_FCE_6 <dbl> 473, 412, 539, 502, 441, 564, 544, 331, 422, 503, NA,…
```
...
enlacep_tidy
#> # A tibble: 11,278 x 13
#>    CVE_ENT NOM_ENT CCT   TURNO ESCUELA TIPO  CVE_MUN NOM_MUN CVE_LOC
#>    <chr>   <chr>   <chr> <chr> <chr>   <chr> <chr>   <chr>   <chr>  
#>  1 03      BAJA C… 03DP… VESP… EMILIA… GENE… 003     LA PAZ  0684   
#>  2 11      GUANAJ… 11DP… MATU… EMILIA… GENE… 033     SAN LU… 0097   
#>  3 19      NUEVO … 19DP… MATU… SOLIDA… GENE… 021     GENERA… 0001   
#>  4 22      QUERET… 22DP… VESP… CUAUHT… GENE… 012     PEDRO … 0029   
#>  5 13      HIDALGO 13PP… MATU… HANS C… PART… 048     PACHUC… 0001   
#>  6 12      GUERRE… 12DP… MATU… BENITO… INDê… 071     XOCHIS… 0070   
#>  7 07      CHIAPAS 07DP… MATU… NETZAH… INDê… 012     BERRIO… 0146   
#>  8 21      PUEBLA  21DP… MATU… JACINT… INDê… 213     ZIHUAT… 0014   
#>  9 28      TAMAUL… 28DP… MATU… RAMON … GENE… 032     REYNOSA 0001   
#> 10 08      CHIHUA… 08DP… MATU… FRANCI… GENE… 017     CUAUHT… 0001   
#> # … with 11,268 more rows, and 4 more variables: NOM_LOC <chr>,
...
#> Observations: 11,278
#> Variables: 13
#> $ cve_ent <chr> "03", "11", "19", "22", "13", "12", "07", "21", "28", "0…
#> $ nom_ent <chr> "BAJA CALIFORNIA SUR", "GUANAJUATO", "NUEVO LEON", "QUER…
#> $ cct     <chr> "03DPR0011Z", "11DPR0283Z", "19DPR1509O", "22DPR0122T", …
#> $ turno   <chr> "VESPERTINO", "MATUTINO", "MATUTINO", "VESPERTINO", "MAT…
#> $ escuela <chr> "EMILIANO ZAPATA", "EMILIANO ZAPATA", "SOLIDARIDAD", "CU…
#> $ tipo    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "PARTICULAR"…
#> $ cve_mun <chr> "003", "033", "021", "012", "048", "071", "012", "213", …
#> $ nom_mun <chr> "LA PAZ", "SAN LUIS DE LA PAZ", "GENERAL ESCOBEDO", "PED…
#> $ cve_loc <chr> "0684", "0097", "0001", "0029", "0001", "0070", "0146", …
#> $ nom_loc <chr> "EL PESCADERO", "MANZANARES", "CIUDAD GENERAL ESCOBEDO",…
#> $ area    <chr> "ESP", "ESP", "ESP", "ESP", "ESP", "ESP", "ESP", "ESP", …
#> $ grado   <dbl> 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3,…
#> $ puntaje <dbl> 520, 595, 549, 493, 626, 538, 372, 446, 545, 554, 416, 4…
```
