...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "18", "25", "14", "11", "26", "14", "21", "07", "14", "25"…
#> $ NOM_ENT    <chr> "NAYARIT", "SINALOA", "JALISCO", "GUANAJUATO", "SONORA", "…
#> $ CCT        <chr> "18DPR0173N", "25DPR1086I", "14DPR0818R", "11DPR1984Z", "2…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO"…
#> $ ESCUELA    <chr> "GILBERTO FLORES MU\u0084OZ", "JUAN ESCUTIA", "HEROE DE NA…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GE…
#> $ CVE_MUN    <chr> "012", "003", "073", "003", "030", "006", "208", "059", "1…
#> $ NOM_MUN    <chr> "SAN BLAS", "BADIRAGUATO", "SAN JUAN DE LOS LAGOS", "SAN M…
#> $ CVE_LOC    <chr> "0042", "0665", "0117", "0006", "0001", "0001", "0001", "0…
#> $ NOM_LOC    <chr> "REFORMA AGRARIA (LA COLORADA)", "BATACOMITO", "SAN ANTONI…
#> $ PUNT_ESP_3 <dbl> 507, 517, 580, 412, 578, 615, 512, 393, 621, 675, 550, 600…
#> $ PUNT_MAT_3 <dbl> 555, 604, 627, 399, 610, 696, 518, 380, 684, 740, 619, 667…
#> $ PUNT_FCE_3 <dbl> 442, 487, 510, 378, 520, 611, 487, 412, 572, 632, 484, 504…
#> $ PUNT_ESP_4 <dbl> 519, 508, 543, 412, 689, 622, 574, 385, 567, 615, 528, 567…
#> $ PUNT_MAT_4 <dbl> 546, 587, 564, 434, 700, 677, 584, 356, 601, 642, 539, 661…
#> $ PUNT_FCE_4 <dbl> 483, 468, 510, 404, 561, 590, 602, 367, 533, 612, 463, 499…
#> $ PUNT_ESP_5 <dbl> 521, 601, 516, 409, 591, 681, 566, 351, 536, 567, 478, 467…
#> $ PUNT_MAT_5 <dbl> 564, 612, 611, 396, 615, 738, 535, 349, 564, 656, 505, 496…
#> $ PUNT_FCE_5 <dbl> 470, 547, 520, 378, 535, 649, 535, 344, 500, 574, 430, 413…
#> $ PUNT_ESP_6 <dbl> 549, 513, 599, 456, 552, 541, 565, 310, 566, 589, 484, 499…
#> $ PUNT_MAT_6 <dbl> 559, 533, 692, 449, 554, 642, 653, 318, 627, 645, 498, 508…
#> $ PUNT_FCE_6 <dbl> 491, 521, 592, 433, 469, 517, 533, 320, 513, 521, 431, 478…
```
...
#>  1 18      NAYARIT 18DP… MATU… "GILBE… GENE… 012     SAN BL… 0042    REFORM…
#>  2 18      NAYARIT 18DP… MATU… "GILBE… GENE… 012     SAN BL… 0042    REFORM…
#>  3 18      NAYARIT 18DP… MATU… "GILBE… GENE… 012     SAN BL… 0042    REFORM…
#>  4 18      NAYARIT 18DP… MATU… "GILBE… GENE… 012     SAN BL… 0042    REFORM…
#>  5 18      NAYARIT 18DP… MATU… "GILBE… GENE… 012     SAN BL… 0042    REFORM…
#>  6 18      NAYARIT 18DP… MATU… "GILBE… GENE… 012     SAN BL… 0042    REFORM…
#>  7 18      NAYARIT 18DP… MATU… "GILBE… GENE… 012     SAN BL… 0042    REFORM…
#>  8 18      NAYARIT 18DP… MATU… "GILBE… GENE… 012     SAN BL… 0042    REFORM…
#>  9 18      NAYARIT 18DP… MATU… "GILBE… GENE… 012     SAN BL… 0042    REFORM…
#> 10 18      NAYARIT 18DP… MATU… "GILBE… GENE… 012     SAN BL… 0042    REFORM…
...
#> Observations: 12,000
#> Variables: 13
#> $ CVE_ENT <chr> "18", "18", "18", "18", "18", "18", "18", "18", "18", "18", "…
#> $ NOM_ENT <chr> "NAYARIT", "NAYARIT", "NAYARIT", "NAYARIT", "NAYARIT", "NAYAR…
#> $ CCT     <chr> "18DPR0173N", "18DPR0173N", "18DPR0173N", "18DPR0173N", "18DP…
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "…
#> $ ESCUELA <chr> "GILBERTO FLORES MU\u0084OZ", "GILBERTO FLORES MU\u0084OZ", "…
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENER…
#> $ CVE_MUN <chr> "012", "012", "012", "012", "012", "012", "012", "012", "012"…
#> $ NOM_MUN <chr> "SAN BLAS", "SAN BLAS", "SAN BLAS", "SAN BLAS", "SAN BLAS", "…
#> $ CVE_LOC <chr> "0042", "0042", "0042", "0042", "0042", "0042", "0042", "0042…
#> $ NOM_LOC <chr> "REFORMA AGRARIA (LA COLORADA)", "REFORMA AGRARIA (LA COLORAD…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", "FCE"…
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5, 5, 5…
#> $ PUNTAJE <dbl> 507, 555, 442, 519, 546, 483, 521, 564, 470, 549, 559, 491, 5…
```
...
#> Variables: 12
#> $ CVE_ENT    <chr> "18", "18", "18", "18", "18", "18", "18", "18", "18", "18"…
#> $ NOM_ENT    <chr> "NAYARIT", "NAYARIT", "NAYARIT", "NAYARIT", "NAYARIT", "NA…
#> $ CCT        <chr> "18DPR0173N", "18DPR0173N", "18DPR0173N", "18DPR0173N", "1…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO"…
#> $ ESCUELA    <chr> "GILBERTO FLORES MU\u0084OZ", "GILBERTO FLORES MU\u0084OZ"…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GE…
#> $ CVE_MUN    <chr> "012", "012", "012", "012", "012", "012", "012", "012", "0…
#> $ NOM_MUN    <chr> "SAN BLAS", "SAN BLAS", "SAN BLAS", "SAN BLAS", "SAN BLAS"…
#> $ CVE_LOC    <chr> "0042", "0042", "0042", "0042", "0042", "0042", "0042", "0…
#> $ NOM_LOC    <chr> "REFORMA AGRARIA (LA COLORADA)", "REFORMA AGRARIA (LA COLO…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4", "ESP…
#> $ PUNTAJE    <dbl> 507, 555, 442, 519, 546, 483, 521, 564, 470, 549, 559, 491…
```
