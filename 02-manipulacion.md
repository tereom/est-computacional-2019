...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "23", "19", "02", "24", "11", "08", "24", "07", "15", "25"…
#> $ NOM_ENT    <chr> "QUINTANA ROO", "NUEVO LEON", "BAJA CALIFORNIA", "SAN LUIS…
#> $ CCT        <chr> "23DPR0581D", "19DPR0050C", "02DPR0589J", "24PPR0364T", "1…
#> $ TURNO      <chr> "VESPERTINO", "MATUTINO", "VESPERTINO", "MATUTINO", "MATUT…
#> $ ESCUELA    <chr> "CUITLAHUAC", "RAMON LOPEZ VELARDE", "MAESTRA CONCEPCION L…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "PARTICULAR", "GENERAL", …
#> $ CVE_MUN    <chr> "005", "048", "001", "035", "011", "029", "046", "057", "0…
#> $ NOM_MUN    <chr> "BENITO JUAREZ", "SANTA CATARINA", "ENSENADA", "SOLEDAD DE…
#> $ CVE_LOC    <chr> "0001", "0001", "0001", "0001", "0028", "2260", "0067", "0…
#> $ NOM_LOC    <chr> "CANCUN", "CIUDAD SANTA CATARINA", "ENSENADA", "SOLEDAD DE…
#> $ PUNT_ESP_3 <dbl> 567, 503, 566, 540, 465, 602, 504, 586, 516, 529, 604, 460…
#> $ PUNT_MAT_3 <dbl> 628, 517, 582, 559, 405, 693, 521, 632, 540, 550, 658, 471…
#> $ PUNT_FCE_3 <dbl> 532, 472, 549, 498, 387, 551, 432, 513, 465, 426, 511, 449…
#> $ PUNT_ESP_4 <dbl> 606, 510, 519, 587, 382, 347, 444, 521, 517, 590, 516, 536…
#> $ PUNT_MAT_4 <dbl> 669, 516, 521, 585, 396, 382, 452, 574, 515, 634, 533, 565…
#> $ PUNT_FCE_4 <dbl> 556, 483, 463, 534, 340, 370, 411, 499, 477, 517, 454, 453…
#> $ PUNT_ESP_5 <dbl> 570, 488, 504, 581, 330, 374, 492, 416, 541, 514, 586, 506…
#> $ PUNT_MAT_5 <dbl> 591, 493, 539, 589, 325, 420, 555, 462, 571, 539, 612, 550…
#> $ PUNT_FCE_5 <dbl> 536, 471, 476, 521, 390, 352, 464, 406, 524, 478, 521, 483…
#> $ PUNT_ESP_6 <dbl> 588, 556, 540, 656, 453, 361, 466, 534, 542, 538, 509, 498…
#> $ PUNT_MAT_6 <dbl> 664, 551, 571, 702, 609, 341, 501, 520, 598, 622, 514, 517…
#> $ PUNT_FCE_6 <dbl> 521, 519, 493, 565, 421, 298, 481, 496, 505, 481, 479, 459…
```
...
#>  1 23      QUINTA… 23DP… VESP… CUITLA… GENE… 005     BENITO… 0001    CANCUN 
#>  2 23      QUINTA… 23DP… VESP… CUITLA… GENE… 005     BENITO… 0001    CANCUN 
#>  3 23      QUINTA… 23DP… VESP… CUITLA… GENE… 005     BENITO… 0001    CANCUN 
#>  4 23      QUINTA… 23DP… VESP… CUITLA… GENE… 005     BENITO… 0001    CANCUN 
#>  5 23      QUINTA… 23DP… VESP… CUITLA… GENE… 005     BENITO… 0001    CANCUN 
#>  6 23      QUINTA… 23DP… VESP… CUITLA… GENE… 005     BENITO… 0001    CANCUN 
#>  7 23      QUINTA… 23DP… VESP… CUITLA… GENE… 005     BENITO… 0001    CANCUN 
#>  8 23      QUINTA… 23DP… VESP… CUITLA… GENE… 005     BENITO… 0001    CANCUN 
#>  9 23      QUINTA… 23DP… VESP… CUITLA… GENE… 005     BENITO… 0001    CANCUN 
#> 10 23      QUINTA… 23DP… VESP… CUITLA… GENE… 005     BENITO… 0001    CANCUN 
...
#> Observations: 12,000
#> Variables: 13
#> $ CVE_ENT <chr> "23", "23", "23", "23", "23", "23", "23", "23", "23", "23", "…
#> $ NOM_ENT <chr> "QUINTANA ROO", "QUINTANA ROO", "QUINTANA ROO", "QUINTANA ROO…
#> $ CCT     <chr> "23DPR0581D", "23DPR0581D", "23DPR0581D", "23DPR0581D", "23DP…
#> $ TURNO   <chr> "VESPERTINO", "VESPERTINO", "VESPERTINO", "VESPERTINO", "VESP…
#> $ ESCUELA <chr> "CUITLAHUAC", "CUITLAHUAC", "CUITLAHUAC", "CUITLAHUAC", "CUIT…
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENER…
#> $ CVE_MUN <chr> "005", "005", "005", "005", "005", "005", "005", "005", "005"…
#> $ NOM_MUN <chr> "BENITO JUAREZ", "BENITO JUAREZ", "BENITO JUAREZ", "BENITO JU…
#> $ CVE_LOC <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001", "0001…
#> $ NOM_LOC <chr> "CANCUN", "CANCUN", "CANCUN", "CANCUN", "CANCUN", "CANCUN", "…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", "FCE"…
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5, 5, 5…
#> $ PUNTAJE <dbl> 567, 628, 532, 606, 669, 556, 570, 591, 536, 588, 664, 521, 5…
```
...
#> Variables: 12
#> $ CVE_ENT    <chr> "23", "23", "23", "23", "23", "23", "23", "23", "23", "23"…
#> $ NOM_ENT    <chr> "QUINTANA ROO", "QUINTANA ROO", "QUINTANA ROO", "QUINTANA …
#> $ CCT        <chr> "23DPR0581D", "23DPR0581D", "23DPR0581D", "23DPR0581D", "2…
#> $ TURNO      <chr> "VESPERTINO", "VESPERTINO", "VESPERTINO", "VESPERTINO", "V…
#> $ ESCUELA    <chr> "CUITLAHUAC", "CUITLAHUAC", "CUITLAHUAC", "CUITLAHUAC", "C…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GE…
#> $ CVE_MUN    <chr> "005", "005", "005", "005", "005", "005", "005", "005", "0…
#> $ NOM_MUN    <chr> "BENITO JUAREZ", "BENITO JUAREZ", "BENITO JUAREZ", "BENITO…
#> $ CVE_LOC    <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001", "0…
#> $ NOM_LOC    <chr> "CANCUN", "CANCUN", "CANCUN", "CANCUN", "CANCUN", "CANCUN"…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4", "ESP…
#> $ PUNTAJE    <dbl> 567, 628, 532, 606, 669, 556, 570, 591, 536, 588, 664, 521…
```
