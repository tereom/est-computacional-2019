...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "21", "07", "30", "07", "12", "08", "15", "30", "16",…
#> $ NOM_ENT    <chr> "PUEBLA", "CHIAPAS", "VERACRUZ", "CHIAPAS", "GUERRERO…
#> $ CCT        <chr> "21EPR0519B", "07DPR0275E", "30DPR4796O", "07KPB1032Y…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "VESPERTINO", "MATUTINO", "MA…
#> $ ESCUELA    <chr> "ING. CARLOS ISMAEL BETANCOURT", "JOSEFA ORTIZ DE DOM…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "CONAFE", "GENERAL",…
#> $ CVE_MUN    <chr> "071", "080", "074", "033", "028", "001", "056", "109…
#> $ NOM_MUN    <chr> "HUAUCHINANGO", "SILTEPEC", "HUILOAPAN", "FRANCISCO L…
#> $ CVE_LOC    <chr> "0001", "0074", "0001", "0140", "0094", "0064", "0023…
#> $ NOM_LOC    <chr> "HUAUCHINANGO", "CERRO PEROTE", "HUILOAPAN DE CUAUHTE…
#> $ PUNT_ESP_3 <dbl> 527, 626, 677, NA, 616, 459, 516, 498, 568, 525, 573,…
#> $ PUNT_MAT_3 <dbl> 558, 624, 713, NA, 663, 415, 575, 563, 635, 568, 620,…
#> $ PUNT_FCE_3 <dbl> 471, 639, 599, NA, 571, 382, 430, 444, 508, 484, 520,…
#> $ PUNT_ESP_4 <dbl> 511, 704, 558, NA, NA, 349, 492, 463, 540, 516, 563, …
#> $ PUNT_MAT_4 <dbl> 518, 724, 566, NA, NA, 379, 556, 453, 587, 592, 590, …
#> $ PUNT_FCE_4 <dbl> 461, 675, 498, NA, NA, 358, 410, 434, 479, 465, 498, …
#> $ PUNT_ESP_5 <dbl> 632, 567, 467, NA, 401, 432, 454, 462, 580, 511, 518,…
#> $ PUNT_MAT_5 <dbl> 676, 641, 496, NA, 489, 314, 505, 450, 619, 530, 612,…
#> $ PUNT_FCE_5 <dbl> 568, 625, 444, NA, 399, 367, 399, 417, 512, 467, 475,…
#> $ PUNT_ESP_6 <dbl> 640, 616, 450, 581, 492, 343, 419, 457, 569, 499, 610…
#> $ PUNT_MAT_6 <dbl> 694, 660, 516, 565, 697, 381, 504, 553, 637, 552, 662…
#> $ PUNT_FCE_6 <dbl> 545, 541, 403, 591, 520, 360, 417, 469, 495, 492, 523…
```
...
#>  1 21      PUEBLA  21EP… MATU… ING. C… GENE… 071     HUAUCH… 0001   
#>  2 21      PUEBLA  21EP… MATU… ING. C… GENE… 071     HUAUCH… 0001   
#>  3 21      PUEBLA  21EP… MATU… ING. C… GENE… 071     HUAUCH… 0001   
#>  4 21      PUEBLA  21EP… MATU… ING. C… GENE… 071     HUAUCH… 0001   
#>  5 21      PUEBLA  21EP… MATU… ING. C… GENE… 071     HUAUCH… 0001   
#>  6 21      PUEBLA  21EP… MATU… ING. C… GENE… 071     HUAUCH… 0001   
#>  7 21      PUEBLA  21EP… MATU… ING. C… GENE… 071     HUAUCH… 0001   
#>  8 21      PUEBLA  21EP… MATU… ING. C… GENE… 071     HUAUCH… 0001   
#>  9 21      PUEBLA  21EP… MATU… ING. C… GENE… 071     HUAUCH… 0001   
#> 10 21      PUEBLA  21EP… MATU… ING. C… GENE… 071     HUAUCH… 0001   
...
#> $ CCT     <chr> "21EPR0519B", "21EPR0519B", "21EPR0519B", "21EPR0519B", …
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA <chr> "ING. CARLOS ISMAEL BETANCOURT", "ING. CARLOS ISMAEL BET…
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "…
#> $ CVE_MUN <chr> "071", "071", "071", "071", "071", "071", "071", "071", …
#> $ NOM_MUN <chr> "HUAUCHINANGO", "HUAUCHINANGO", "HUAUCHINANGO", "HUAUCHI…
#> $ CVE_LOC <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001", …
#> $ NOM_LOC <chr> "HUAUCHINANGO", "HUAUCHINANGO", "HUAUCHINANGO", "HUAUCHI…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", …
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5,…
#> $ PUNTAJE <dbl> 527, 558, 471, 511, 518, 461, 632, 676, 568, 640, 694, 5…
```
...
#> $ ESCUELA    <chr> "ING. CARLOS ISMAEL BETANCOURT", "ING. CARLOS ISMAEL …
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL"…
#> $ CVE_MUN    <chr> "071", "071", "071", "071", "071", "071", "071", "071…
#> $ NOM_MUN    <chr> "HUAUCHINANGO", "HUAUCHINANGO", "HUAUCHINANGO", "HUAU…
#> $ CVE_LOC    <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001…
#> $ NOM_LOC    <chr> "HUAUCHINANGO", "HUAUCHINANGO", "HUAUCHINANGO", "HUAU…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4",…
#> $ PUNTAJE    <dbl> 527, 558, 471, 511, 518, 461, 632, 676, 568, 640, 694…
```
