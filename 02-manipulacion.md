...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "30", "21", "32", "01", "07", "12", "11", "14", "14", "30"…
#> $ NOM_ENT    <chr> "VERACRUZ", "PUEBLA", "ZACATECAS", "AGUASCALIENTES", "CHIA…
#> $ CCT        <chr> "30EPR3717D", "21DPB0773U", "32DPR0770D", "01DPR0647K", "0…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO"…
#> $ ESCUELA    <chr> "NICOLAS BRAVO", "XOLOXOCHITL", "HEROES DE LA INDEPENDENCI…
#> $ TIPO       <chr> "GENERAL", "INDêGENA", "GENERAL", "GENERAL", "GENERAL", "C…
#> $ CVE_MUN    <chr> "193", "213", "036", "001", "003", "016", "008", "039", "0…
#> $ NOM_MUN    <chr> "VERACRUZ", "ZIHUATEUTLA", "OJOCALIENTE", "AGUASCALIENTES"…
#> $ CVE_LOC    <chr> "0001", "0006", "0040", "0001", "0430", "0134", "0068", "0…
#> $ NOM_LOC    <chr> "VERACRUZ", "CUATECHALOTLA", "SAN JOSE DE LOS LLANOS", "AG…
#> $ PUNT_ESP_3 <dbl> 530, 585, 445, 503, 601, 374, 439, 662, 426, 578, 545, 598…
#> $ PUNT_MAT_3 <dbl> 538, 606, 472, 536, 596, 538, 514, 693, 403, 581, 592, 713…
#> $ PUNT_FCE_3 <dbl> 465, 520, 435, 453, 516, 335, 383, 598, 405, 437, 497, 589…
#> $ PUNT_ESP_4 <dbl> 580, 436, 462, 557, 449, 410, 552, 650, 399, 508, 553, 611…
#> $ PUNT_MAT_4 <dbl> 564, 507, 519, 554, 538, 419, 621, 640, 394, 539, 589, 642…
#> $ PUNT_FCE_4 <dbl> 533, 457, 455, 493, 502, 428, 494, 593, 362, 459, 541, 560…
#> $ PUNT_ESP_5 <dbl> 526, 422, 407, 522, 422, 348, 521, 696, 335, 432, 459, 586…
#> $ PUNT_MAT_5 <dbl> 519, 488, 437, 538, 583, 424, 595, 736, 384, 441, 535, 611…
#> $ PUNT_FCE_5 <dbl> 486, 375, 364, 477, 436, 350, 495, 608, 399, 395, 489, 488…
#> $ PUNT_ESP_6 <dbl> 590, 413, 439, 586, 477, 347, 410, 701, 578, 706, 528, 540…
#> $ PUNT_MAT_6 <dbl> 622, 535, 546, 628, 448, 390, 599, 759, 518, 713, 566, 608…
#> $ PUNT_FCE_6 <dbl> 495, 442, 416, 531, 368, 354, 422, 625, 568, 584, 492, 451…
```
...
#>  1 30      VERACR… 30EP… MATU… NICOLA… GENE… 193     VERACR… 0001    VERACR…
#>  2 30      VERACR… 30EP… MATU… NICOLA… GENE… 193     VERACR… 0001    VERACR…
#>  3 30      VERACR… 30EP… MATU… NICOLA… GENE… 193     VERACR… 0001    VERACR…
#>  4 30      VERACR… 30EP… MATU… NICOLA… GENE… 193     VERACR… 0001    VERACR…
#>  5 30      VERACR… 30EP… MATU… NICOLA… GENE… 193     VERACR… 0001    VERACR…
#>  6 30      VERACR… 30EP… MATU… NICOLA… GENE… 193     VERACR… 0001    VERACR…
#>  7 30      VERACR… 30EP… MATU… NICOLA… GENE… 193     VERACR… 0001    VERACR…
#>  8 30      VERACR… 30EP… MATU… NICOLA… GENE… 193     VERACR… 0001    VERACR…
#>  9 30      VERACR… 30EP… MATU… NICOLA… GENE… 193     VERACR… 0001    VERACR…
#> 10 30      VERACR… 30EP… MATU… NICOLA… GENE… 193     VERACR… 0001    VERACR…
...
#> $ CCT     <chr> "30EPR3717D", "30EPR3717D", "30EPR3717D", "30EPR3717D", "30EP…
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "…
#> $ ESCUELA <chr> "NICOLAS BRAVO", "NICOLAS BRAVO", "NICOLAS BRAVO", "NICOLAS B…
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENER…
#> $ CVE_MUN <chr> "193", "193", "193", "193", "193", "193", "193", "193", "193"…
#> $ NOM_MUN <chr> "VERACRUZ", "VERACRUZ", "VERACRUZ", "VERACRUZ", "VERACRUZ", "…
#> $ CVE_LOC <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001", "0001…
#> $ NOM_LOC <chr> "VERACRUZ", "VERACRUZ", "VERACRUZ", "VERACRUZ", "VERACRUZ", "…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", "FCE"…
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5, 5, 5…
#> $ PUNTAJE <dbl> 530, 538, 465, 580, 564, 533, 526, 519, 486, 590, 622, 495, 5…
```
...
#> $ CVE_ENT    <chr> "30", "30", "30", "30", "30", "30", "30", "30", "30", "30"…
#> $ NOM_ENT    <chr> "VERACRUZ", "VERACRUZ", "VERACRUZ", "VERACRUZ", "VERACRUZ"…
#> $ CCT        <chr> "30EPR3717D", "30EPR3717D", "30EPR3717D", "30EPR3717D", "3…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO"…
#> $ ESCUELA    <chr> "NICOLAS BRAVO", "NICOLAS BRAVO", "NICOLAS BRAVO", "NICOLA…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GE…
#> $ CVE_MUN    <chr> "193", "193", "193", "193", "193", "193", "193", "193", "1…
#> $ NOM_MUN    <chr> "VERACRUZ", "VERACRUZ", "VERACRUZ", "VERACRUZ", "VERACRUZ"…
#> $ CVE_LOC    <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001", "0…
#> $ NOM_LOC    <chr> "VERACRUZ", "VERACRUZ", "VERACRUZ", "VERACRUZ", "VERACRUZ"…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4", "ESP…
#> $ PUNTAJE    <dbl> 530, 538, 465, 580, 564, 533, 526, 519, 486, 590, 622, 495…
```
