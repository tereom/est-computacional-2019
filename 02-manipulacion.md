...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "24", "16", "13", "24", "05", "31", "16", "02", "12",…
#> $ NOM_ENT    <chr> "SAN LUIS POTOSI", "MICHOACAN", "HIDALGO", "SAN LUIS …
#> $ CCT        <chr> "24DPR0841Z", "16KPR3682W", "13DPR1048A", "24PPR0329N…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "JULIAN DE LOS REYES", "SOLEDAD, LA", "ANTONIA RUBIO"…
#> $ TIPO       <chr> "GENERAL", "CONAFE", "GENERAL", "PARTICULAR", "GENERA…
#> $ CVE_MUN    <chr> "050", "111", "047", "028", "035", "052", "052", "004…
#> $ NOM_MUN    <chr> "VILLA DE REYES", "ZIRACUARETIRO", "PACULA", "SAN LUI…
#> $ CVE_LOC    <chr> "0035", "0025", "0023", "0001", "0001", "0001", "0137…
#> $ NOM_LOC    <chr> "PARDO", "SOLEDAD, LA", "VICENTE GUERRERO (PRESIDIO)"…
#> $ PUNT_ESP_3 <dbl> 523, 464, 489, 538, 536, 598, 760, 594, 536, 479, 620…
#> $ PUNT_MAT_3 <dbl> 540, 399, 494, 535, 538, 638, 770, 602, 568, 514, 658…
#> $ PUNT_FCE_3 <dbl> 440, 396, 456, 487, 463, 563, 640, 523, 477, 427, 557…
#> $ PUNT_ESP_4 <dbl> 467, 505, 549, 566, 489, 615, 670, 512, 628, 498, 581…
#> $ PUNT_MAT_4 <dbl> 480, 497, 585, 573, 510, 658, 679, 520, 691, 521, 564…
#> $ PUNT_FCE_4 <dbl> 436, 327, 520, 534, 457, 561, 568, 504, 543, 435, 540…
#> $ PUNT_ESP_5 <dbl> 511, 607, 513, 505, 482, 541, 545, 519, 558, 500, 580…
#> $ PUNT_MAT_5 <dbl> 542, 543, 542, 514, 478, 586, 625, 523, 617, 531, 610…
#> $ PUNT_FCE_5 <dbl> 466, 533, 482, 479, 457, 501, 494, 451, 511, 471, 554…
#> $ PUNT_ESP_6 <dbl> 448, 391, 487, 497, 481, 622, 691, 523, 633, 507, 565…
#> $ PUNT_MAT_6 <dbl> 502, 379, 469, 522, 549, 611, 737, 505, 676, 533, 562…
#> $ PUNT_FCE_6 <dbl> 443, 403, 488, 442, 453, 583, 623, 458, 557, 497, 558…
```
...
#>  1 24      SAN LU… 24DP… MATU… JULIAN… GENE… 050     VILLA … 0035   
#>  2 16      MICHOA… 16KP… MATU… SOLEDA… CONA… 111     ZIRACU… 0025   
#>  3 13      HIDALGO 13DP… MATU… ANTONI… GENE… 047     PACULA  0023   
#>  4 24      SAN LU… 24PP… MATU… FORMAC… PART… 028     SAN LU… 0001   
#>  5 05      COAHUI… 05EP… MATU… MEXICO  GENE… 035     TORREON 0001   
#>  6 31      YUCATAN 31DP… VESP… VICENT… GENE… 052     MOTUL   0001   
#>  7 16      MICHOA… 16DP… MATU… 12 DE … GENE… 052     LAZARO… 0137   
#>  8 02      BAJA C… 02EP… MATU… "LIC. … GENE… 004     TIJUANA 0001   
#>  9 12      GUERRE… 12DP… MATU… PROFA.… GENE… 057     TECPAN… 0079   
#> 10 14      JALISCO 14DP… MATU… ALVARO… GENE… 022     CIHUAT… 0001   
...
#> Observations: 11,267
#> Variables: 13
#> $ cve_ent <chr> "24", "16", "13", "24", "05", "31", "16", "02", "12", "1…
#> $ nom_ent <chr> "SAN LUIS POTOSI", "MICHOACAN", "HIDALGO", "SAN LUIS POT…
#> $ cct     <chr> "24DPR0841Z", "16KPR3682W", "13DPR1048A", "24PPR0329N", …
#> $ turno   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ escuela <chr> "JULIAN DE LOS REYES", "SOLEDAD, LA", "ANTONIA RUBIO", "…
#> $ tipo    <chr> "GENERAL", "CONAFE", "GENERAL", "PARTICULAR", "GENERAL",…
#> $ cve_mun <chr> "050", "111", "047", "028", "035", "052", "052", "004", …
#> $ nom_mun <chr> "VILLA DE REYES", "ZIRACUARETIRO", "PACULA", "SAN LUIS P…
#> $ cve_loc <chr> "0035", "0025", "0023", "0001", "0001", "0001", "0137", …
#> $ nom_loc <chr> "PARDO", "SOLEDAD, LA", "VICENTE GUERRERO (PRESIDIO)", "…
#> $ area    <chr> "ESP", "ESP", "ESP", "ESP", "ESP", "ESP", "ESP", "ESP", …
#> $ grado   <dbl> 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3,…
#> $ puntaje <dbl> 523, 464, 489, 538, 536, 598, 760, 594, 536, 479, 620, 6…
```
