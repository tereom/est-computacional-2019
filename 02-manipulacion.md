...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "02", "20", "31", "17", "14", "19", "19", "24", "25",…
#> $ NOM_ENT    <chr> "BAJA CALIFORNIA", "OAXACA", "YUCATAN", "MORELOS", "J…
#> $ CCT        <chr> "02DPR0599Q", "20KPR1577K", "31DPB0259M", "17DPR0012B…
#> $ TURNO      <chr> "VESPERTINO", "MATUTINO", "MATUTINO", "VESPERTINO", "…
#> $ ESCUELA    <chr> "MTRO FRANCISCO RODRIGUEZ CASTRO", "EL TERRERO (VENUS…
#> $ TIPO       <chr> "GENERAL", "CONAFE", "INDêGENA", "GENERAL", "GENERAL"…
#> $ CVE_MUN    <chr> "001", "397", "021", "033", "026", "022", "021", "047…
#> $ NOM_MUN    <chr> "ENSENADA", "HEROICA CIUDAD DE TLAXIACO", "CHICHIMILA…
#> $ CVE_LOC    <chr> "0001", "0094", "0024", "0003", "0228", "0703", "0001…
#> $ NOM_LOC    <chr> "ENSENADA", "EL TERRERO (VENUSTIANO CARRANZA)", "NUEV…
#> $ PUNT_ESP_3 <dbl> 568, 441, 359, 536, 515, 402, 536, 585, 423, 610, 588…
#> $ PUNT_MAT_3 <dbl> 649, 506, 319, 609, 642, 366, 578, 608, 418, 678, 604…
#> $ PUNT_FCE_3 <dbl> 503, 369, 461, 493, 518, 410, 490, 516, 409, 574, 531…
#> $ PUNT_ESP_4 <dbl> 622, 403, 476, 785, 482, 370, 546, 524, 369, 579, 637…
#> $ PUNT_MAT_4 <dbl> 628, 456, 512, 802, 547, 486, 545, 583, 388, 754, 664…
#> $ PUNT_FCE_4 <dbl> 551, 399, 453, 653, 500, 414, 482, 452, 393, 587, 624…
#> $ PUNT_ESP_5 <dbl> 526, 486, 437, 727, 404, 470, 525, 589, 385, 683, 446…
#> $ PUNT_MAT_5 <dbl> 558, 462, 501, 758, 515, 402, 529, 566, 361, 692, 483…
#> $ PUNT_FCE_5 <dbl> 479, 446, 448, 612, 330, 452, 498, 547, 419, 641, 541…
#> $ PUNT_ESP_6 <dbl> 555, 499, 353, 469, 378, 488, 573, 464, 401, 489, 583…
#> $ PUNT_MAT_6 <dbl> 554, 612, 367, 514, 404, 481, 589, 598, 437, 640, 673…
#> $ PUNT_FCE_6 <dbl> 495, 463, 402, 431, 335, 442, 538, 492, 373, 496, 441…
```
...
#>  1 02      BAJA C… 02DP… VESP… MTRO F… GENE… 001     ENSENA… 0001   
#>  2 02      BAJA C… 02DP… VESP… MTRO F… GENE… 001     ENSENA… 0001   
#>  3 02      BAJA C… 02DP… VESP… MTRO F… GENE… 001     ENSENA… 0001   
#>  4 02      BAJA C… 02DP… VESP… MTRO F… GENE… 001     ENSENA… 0001   
#>  5 02      BAJA C… 02DP… VESP… MTRO F… GENE… 001     ENSENA… 0001   
#>  6 02      BAJA C… 02DP… VESP… MTRO F… GENE… 001     ENSENA… 0001   
#>  7 02      BAJA C… 02DP… VESP… MTRO F… GENE… 001     ENSENA… 0001   
#>  8 02      BAJA C… 02DP… VESP… MTRO F… GENE… 001     ENSENA… 0001   
#>  9 02      BAJA C… 02DP… VESP… MTRO F… GENE… 001     ENSENA… 0001   
#> 10 02      BAJA C… 02DP… VESP… MTRO F… GENE… 001     ENSENA… 0001   
...
#> Observations: 12,000
#> Variables: 13
#> $ CVE_ENT <chr> "02", "02", "02", "02", "02", "02", "02", "02", "02", "0…
#> $ NOM_ENT <chr> "BAJA CALIFORNIA", "BAJA CALIFORNIA", "BAJA CALIFORNIA",…
#> $ CCT     <chr> "02DPR0599Q", "02DPR0599Q", "02DPR0599Q", "02DPR0599Q", …
#> $ TURNO   <chr> "VESPERTINO", "VESPERTINO", "VESPERTINO", "VESPERTINO", …
#> $ ESCUELA <chr> "MTRO FRANCISCO RODRIGUEZ CASTRO", "MTRO FRANCISCO RODRI…
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "…
#> $ CVE_MUN <chr> "001", "001", "001", "001", "001", "001", "001", "001", …
#> $ NOM_MUN <chr> "ENSENADA", "ENSENADA", "ENSENADA", "ENSENADA", "ENSENAD…
#> $ CVE_LOC <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001", …
#> $ NOM_LOC <chr> "ENSENADA", "ENSENADA", "ENSENADA", "ENSENADA", "ENSENAD…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", …
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5,…
#> $ PUNTAJE <dbl> 568, 649, 503, 622, 628, 551, 526, 558, 479, 555, 554, 4…
```
...
#> Observations: 12,000
#> Variables: 12
#> $ CVE_ENT    <chr> "02", "02", "02", "02", "02", "02", "02", "02", "02",…
#> $ NOM_ENT    <chr> "BAJA CALIFORNIA", "BAJA CALIFORNIA", "BAJA CALIFORNI…
#> $ CCT        <chr> "02DPR0599Q", "02DPR0599Q", "02DPR0599Q", "02DPR0599Q…
#> $ TURNO      <chr> "VESPERTINO", "VESPERTINO", "VESPERTINO", "VESPERTINO…
#> $ ESCUELA    <chr> "MTRO FRANCISCO RODRIGUEZ CASTRO", "MTRO FRANCISCO RO…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL"…
#> $ CVE_MUN    <chr> "001", "001", "001", "001", "001", "001", "001", "001…
#> $ NOM_MUN    <chr> "ENSENADA", "ENSENADA", "ENSENADA", "ENSENADA", "ENSE…
#> $ CVE_LOC    <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001…
#> $ NOM_LOC    <chr> "ENSENADA", "ENSENADA", "ENSENADA", "ENSENADA", "ENSE…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4",…
#> $ PUNTAJE    <dbl> 568, 649, 503, 622, 628, 551, 526, 558, 479, 555, 554…
```
