...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "15", "09", "18", "21", "11", "15", "11", "10", "28",…
#> $ NOM_ENT    <chr> "MEXICO", "DISTRITO FEDERAL", "NAYARIT", "PUEBLA", "G…
#> $ CCT        <chr> "15DPB0120K", "09DPR5044T", "18DPR0878B", "21DPR2765Z…
#> $ TURNO      <chr> "MATUTINO", "VESPERTINO", "MATUTINO", "MATUTINO", "VE…
#> $ ESCUELA    <chr> "JAIME NUNO ROCA", "RUFINO TAMAYO", "MINERVA", "BENIT…
#> $ TIPO       <chr> "INDêGENA", "GENERAL", "GENERAL", "GENERAL", "GENERAL…
#> $ CVE_MUN    <chr> "074", "007", "011", "177", "037", "123", "020", "023…
#> $ NOM_MUN    <chr> "SAN FELIPE DEL PROGRESO", "IZTAPALAPA", "RUIZ", "TLA…
#> $ CVE_LOC    <chr> "0056", "0405", "0032", "0011", "0191", "0001", "0001…
#> $ NOM_LOC    <chr> "PALMILLAS", "CONJUNTO HABITACIONAL SOLIDARIDAD I", "…
#> $ PUNT_ESP_3 <dbl> 411, 538, 460, 567, 520, 627, 497, 517, 496, 536, 476…
#> $ PUNT_MAT_3 <dbl> 396, 569, 485, 634, 533, 647, 499, 568, 535, 576, 503…
#> $ PUNT_FCE_3 <dbl> 386, 485, 430, 529, 519, 588, 437, 577, 436, 421, 409…
#> $ PUNT_ESP_4 <dbl> 355, 579, 454, 590, 456, 597, 511, 480, 519, 470, 348…
#> $ PUNT_MAT_4 <dbl> 413, 625, 518, 600, 480, 723, 516, 549, 580, 492, 382…
#> $ PUNT_FCE_4 <dbl> 355, 505, 427, 525, 472, 619, 460, 449, 454, 414, 349…
#> $ PUNT_ESP_5 <dbl> 422, 540, 507, 465, 482, 579, 507, 467, 525, 519, 537…
#> $ PUNT_MAT_5 <dbl> 496, 569, 572, 466, 477, 606, 542, 482, 576, 497, 495…
#> $ PUNT_FCE_5 <dbl> 377, 495, 540, 419, 469, 529, 483, 464, 491, 427, 581…
#> $ PUNT_ESP_6 <dbl> 452, 562, 369, 466, NA, 609, 519, 476, 486, 432, 474,…
#> $ PUNT_MAT_6 <dbl> 473, 606, 598, 486, NA, 689, 508, 563, 547, 467, 500,…
#> $ PUNT_FCE_6 <dbl> 404, 505, 488, 444, NA, 546, 467, 513, 471, 413, 525,…
```
...
#>  1 15      MEXICO  15DP… MATU… JAIME … INDê… 074     SAN FE… 0056   
#>  2 15      MEXICO  15DP… MATU… JAIME … INDê… 074     SAN FE… 0056   
#>  3 15      MEXICO  15DP… MATU… JAIME … INDê… 074     SAN FE… 0056   
#>  4 15      MEXICO  15DP… MATU… JAIME … INDê… 074     SAN FE… 0056   
#>  5 15      MEXICO  15DP… MATU… JAIME … INDê… 074     SAN FE… 0056   
#>  6 15      MEXICO  15DP… MATU… JAIME … INDê… 074     SAN FE… 0056   
#>  7 15      MEXICO  15DP… MATU… JAIME … INDê… 074     SAN FE… 0056   
#>  8 15      MEXICO  15DP… MATU… JAIME … INDê… 074     SAN FE… 0056   
#>  9 15      MEXICO  15DP… MATU… JAIME … INDê… 074     SAN FE… 0056   
#> 10 15      MEXICO  15DP… MATU… JAIME … INDê… 074     SAN FE… 0056   
...
#> Observations: 12,000
#> Variables: 13
#> $ CVE_ENT <chr> "15", "15", "15", "15", "15", "15", "15", "15", "15", "1…
#> $ NOM_ENT <chr> "MEXICO", "MEXICO", "MEXICO", "MEXICO", "MEXICO", "MEXIC…
#> $ CCT     <chr> "15DPB0120K", "15DPB0120K", "15DPB0120K", "15DPB0120K", …
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA <chr> "JAIME NUNO ROCA", "JAIME NUNO ROCA", "JAIME NUNO ROCA",…
#> $ TIPO    <chr> "INDêGENA", "INDêGENA", "INDêGENA", "INDêGENA", "INDêGEN…
#> $ CVE_MUN <chr> "074", "074", "074", "074", "074", "074", "074", "074", …
#> $ NOM_MUN <chr> "SAN FELIPE DEL PROGRESO", "SAN FELIPE DEL PROGRESO", "S…
#> $ CVE_LOC <chr> "0056", "0056", "0056", "0056", "0056", "0056", "0056", …
#> $ NOM_LOC <chr> "PALMILLAS", "PALMILLAS", "PALMILLAS", "PALMILLAS", "PAL…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", …
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5,…
#> $ PUNTAJE <dbl> 411, 396, 386, 355, 413, 355, 422, 496, 377, 452, 473, 4…
```
...
#> $ NOM_ENT    <chr> "MEXICO", "MEXICO", "MEXICO", "MEXICO", "MEXICO", "ME…
#> $ CCT        <chr> "15DPB0120K", "15DPB0120K", "15DPB0120K", "15DPB0120K…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "JAIME NUNO ROCA", "JAIME NUNO ROCA", "JAIME NUNO ROC…
#> $ TIPO       <chr> "INDêGENA", "INDêGENA", "INDêGENA", "INDêGENA", "INDê…
#> $ CVE_MUN    <chr> "074", "074", "074", "074", "074", "074", "074", "074…
#> $ NOM_MUN    <chr> "SAN FELIPE DEL PROGRESO", "SAN FELIPE DEL PROGRESO",…
#> $ CVE_LOC    <chr> "0056", "0056", "0056", "0056", "0056", "0056", "0056…
#> $ NOM_LOC    <chr> "PALMILLAS", "PALMILLAS", "PALMILLAS", "PALMILLAS", "…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4",…
#> $ PUNTAJE    <dbl> 411, 396, 386, 355, 413, 355, 422, 496, 377, 452, 473…
```
