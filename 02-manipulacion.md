...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "15", "27", "22", "09", "30", "15", "15", "28", "03",…
#> $ NOM_ENT    <chr> "MEXICO", "TABASCO", "QUERETARO", "DISTRITO FEDERAL",…
#> $ CCT        <chr> "15EPR2290S", "27DPR1979O", "22PPR0041N", "09DPR5069B…
#> $ TURNO      <chr> "MATUTINO", "VESPERTINO", "MATUTINO", "MATUTINO", "MA…
#> $ ESCUELA    <chr> "JOSEFA ORTIZ DE DOMINGUEZ", "GRAL. LAZARO CARDENAS I…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "PARTICULAR", "GENERAL", "PARTI…
#> $ CVE_MUN    <chr> "110", "002", "014", "003", "189", "120", "104", "038…
#> $ NOM_MUN    <chr> "VALLE DE BRAVO", "CARDENAS", "QUERETARO", "COYOACAN"…
#> $ CVE_LOC    <chr> "0018", "0034", "0001", "0102", "0001", "0001", "0001…
#> $ NOM_LOC    <chr> "EL FRESNO (EL FRESNO LA COMPA\u0084IA)", "POBLADO C-…
#> $ PUNT_ESP_3 <dbl> 505, 512, 591, 554, 570, 504, 485, 477, NA, 505, 434,…
#> $ PUNT_MAT_3 <dbl> 543, 566, 608, 583, 613, 526, 523, 478, NA, 539, 445,…
#> $ PUNT_FCE_3 <dbl> 452, 480, 561, 518, 504, 443, 424, 429, NA, 503, 416,…
#> $ PUNT_ESP_4 <dbl> 529, 546, 625, 596, 605, 511, 589, 450, 607, 491, 444…
#> $ PUNT_MAT_4 <dbl> 528, 598, 583, 608, 651, 518, 588, 452, 644, 561, 350…
#> $ PUNT_FCE_4 <dbl> 463, 495, 550, 517, 553, 460, 546, 446, 539, 482, 430…
#> $ PUNT_ESP_5 <dbl> 484, 647, 611, 569, 592, 493, 572, 436, 503, NA, 410,…
#> $ PUNT_MAT_5 <dbl> 495, 651, 619, 591, 616, 537, 571, 426, 614, NA, 450,…
#> $ PUNT_FCE_5 <dbl> 441, 603, 542, 505, 546, 462, 529, 416, 573, NA, 439,…
#> $ PUNT_ESP_6 <dbl> 426, 547, 560, 590, 578, 521, 548, 523, NA, 448, 399,…
#> $ PUNT_MAT_6 <dbl> 390, 651, 539, 602, 596, 517, 589, 573, NA, 409, 333,…
#> $ PUNT_FCE_6 <dbl> 397, 510, 485, 531, 522, 478, 538, 501, NA, 476, 376,…
```
...
#>  1 15      MEXICO  15EP… MATU… JOSEFA… GENE… 110     VALLE … 0018   
#>  2 15      MEXICO  15EP… MATU… JOSEFA… GENE… 110     VALLE … 0018   
#>  3 15      MEXICO  15EP… MATU… JOSEFA… GENE… 110     VALLE … 0018   
#>  4 15      MEXICO  15EP… MATU… JOSEFA… GENE… 110     VALLE … 0018   
#>  5 15      MEXICO  15EP… MATU… JOSEFA… GENE… 110     VALLE … 0018   
#>  6 15      MEXICO  15EP… MATU… JOSEFA… GENE… 110     VALLE … 0018   
#>  7 15      MEXICO  15EP… MATU… JOSEFA… GENE… 110     VALLE … 0018   
#>  8 15      MEXICO  15EP… MATU… JOSEFA… GENE… 110     VALLE … 0018   
#>  9 15      MEXICO  15EP… MATU… JOSEFA… GENE… 110     VALLE … 0018   
#> 10 15      MEXICO  15EP… MATU… JOSEFA… GENE… 110     VALLE … 0018   
...
#> $ CCT     <chr> "15EPR2290S", "15EPR2290S", "15EPR2290S", "15EPR2290S", …
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA <chr> "JOSEFA ORTIZ DE DOMINGUEZ", "JOSEFA ORTIZ DE DOMINGUEZ"…
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "…
#> $ CVE_MUN <chr> "110", "110", "110", "110", "110", "110", "110", "110", …
#> $ NOM_MUN <chr> "VALLE DE BRAVO", "VALLE DE BRAVO", "VALLE DE BRAVO", "V…
#> $ CVE_LOC <chr> "0018", "0018", "0018", "0018", "0018", "0018", "0018", …
#> $ NOM_LOC <chr> "EL FRESNO (EL FRESNO LA COMPA\u0084IA)", "EL FRESNO (EL…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", …
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5,…
#> $ PUNTAJE <dbl> 505, 543, 452, 529, 528, 463, 484, 495, 441, 426, 390, 3…
```
...
#> $ ESCUELA    <chr> "JOSEFA ORTIZ DE DOMINGUEZ", "JOSEFA ORTIZ DE DOMINGU…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL"…
#> $ CVE_MUN    <chr> "110", "110", "110", "110", "110", "110", "110", "110…
#> $ NOM_MUN    <chr> "VALLE DE BRAVO", "VALLE DE BRAVO", "VALLE DE BRAVO",…
#> $ CVE_LOC    <chr> "0018", "0018", "0018", "0018", "0018", "0018", "0018…
#> $ NOM_LOC    <chr> "EL FRESNO (EL FRESNO LA COMPA\u0084IA)", "EL FRESNO …
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4",…
#> $ PUNTAJE    <dbl> 505, 543, 452, 529, 528, 463, 484, 495, 441, 426, 390…
```
