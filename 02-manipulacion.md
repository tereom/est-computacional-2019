...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "07", "28", "07", "24", "12", "21", "21", "15", "12",…
#> $ NOM_ENT    <chr> "CHIAPAS", "TAMAULIPAS", "CHIAPAS", "SAN LUIS POTOSI"…
#> $ CCT        <chr> "07DPB3288B", "28DPR2313R", "07KPB0785P", "24DPR0198G…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "JUAN DE LA BARRERA", "PROF. CELESTINO ORTIZ CARDENAS…
#> $ TIPO       <chr> "INDêGENA", "GENERAL", "CONAFE", "GENERAL", "GENERAL"…
#> $ CVE_MUN    <chr> "024", "023", "059", "021", "022", "099", "076", "014…
#> $ NOM_MUN    <chr> "CHANAL", "MENDEZ", "OCOSINGO", "MEXQUITIC DE CARMONA…
#> $ CVE_LOC    <chr> "0011", "0274", "1852", "0051", "0017", "0015", "0094…
#> $ NOM_LOC    <chr> "LA MENDOZA", "AMERICO VILLARREAL GUERRA", "SANTA JUL…
#> $ PUNT_ESP_3 <dbl> 349, NA, 636, 498, 538, 434, 565, 470, 553, 506, 644,…
#> $ PUNT_MAT_3 <dbl> 370, NA, 492, 492, 595, 425, 603, 508, 598, 590, 735,…
#> $ PUNT_FCE_3 <dbl> 359, NA, 536, 424, 460, 394, 487, 452, 507, 547, 602,…
#> $ PUNT_ESP_4 <dbl> 356, 416, 392, 480, 414, 436, 529, 531, 632, 547, 624…
#> $ PUNT_MAT_4 <dbl> 352, 401, 545, 507, 428, 414, 535, 594, 678, 594, 693…
#> $ PUNT_FCE_4 <dbl> 326, 383, 527, 444, 356, 421, 445, 496, 627, 477, 602…
#> $ PUNT_ESP_5 <dbl> 350, 393, NA, 542, 437, 466, 486, 513, 690, 431, 583,…
#> $ PUNT_MAT_5 <dbl> 346, 368, NA, 540, 456, 424, 544, 621, 779, 502, 625,…
#> $ PUNT_FCE_5 <dbl> 367, 398, NA, 499, 433, 433, 462, 477, 665, 380, 542,…
#> $ PUNT_ESP_6 <dbl> 437, 430, 444, 557, 491, 399, 560, 541, 600, 514, 596…
#> $ PUNT_MAT_6 <dbl> 342, 421, 373, 627, 543, 364, 634, 553, 688, 536, 666…
#> $ PUNT_FCE_6 <dbl> 303, 380, 443, 511, 482, 386, 467, 451, 559, 458, 537…
```
...
enlacep_tidy
#> # A tibble: 11,237 x 13
#>    CVE_ENT NOM_ENT CCT   TURNO ESCUELA TIPO  CVE_MUN NOM_MUN CVE_LOC
#>    <chr>   <chr>   <chr> <chr> <chr>   <chr> <chr>   <chr>   <chr>  
#>  1 07      CHIAPAS 07DP… MATU… JUAN D… INDê… 024     CHANAL  0011   
#>  2 07      CHIAPAS 07KP… MATU… SANTA … CONA… 059     OCOSIN… 1852   
#>  3 24      SAN LU… 24DP… MATU… LAZARO… GENE… 021     MEXQUI… 0051   
#>  4 12      GUERRE… 12EP… MATU… JOSE M… GENE… 022     COYUCA… 0017   
#>  5 21      PUEBLA  21EP… MATU… AQUILE… GENE… 099     "CA\u0… 0015   
#>  6 21      PUEBLA  21DP… MATU… BENITO… GENE… 076     HUEYTA… 0094   
#>  7 15      MEXICO  15DP… VESP… 18 DE … GENE… 014     ATLACO… 0031   
#>  8 12      GUERRE… 12DP… MATU… MIGUEL… GENE… 001     ACAPUL… 0001   
#>  9 07      CHIAPAS 07DP… VESP… IGNACI… GENE… 108     VILLAF… 0001   
#> 10 19      NUEVO … 19DP… MATU… BELISA… GENE… 021     GENERA… 0001   
#> # … with 11,227 more rows, and 4 more variables: NOM_LOC <chr>,
...
#> Observations: 11,237
#> Variables: 13
#> $ cve_ent <chr> "07", "07", "24", "12", "21", "21", "15", "12", "07", "1…
#> $ nom_ent <chr> "CHIAPAS", "CHIAPAS", "SAN LUIS POTOSI", "GUERRERO", "PU…
#> $ cct     <chr> "07DPB3288B", "07KPB0785P", "24DPR0198G", "12EPR0394C", …
#> $ turno   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ escuela <chr> "JUAN DE LA BARRERA", "SANTA JULIA", "LAZARO CARDENAS", …
#> $ tipo    <chr> "INDêGENA", "CONAFE", "GENERAL", "GENERAL", "GENERAL", "…
#> $ cve_mun <chr> "024", "059", "021", "022", "099", "076", "014", "001", …
#> $ nom_mun <chr> "CHANAL", "OCOSINGO", "MEXQUITIC DE CARMONA", "COYUCA DE…
#> $ cve_loc <chr> "0011", "1852", "0051", "0017", "0015", "0094", "0031", …
#> $ nom_loc <chr> "LA MENDOZA", "SANTA JULIA", "LOS MORENO", "CA\u0084A (L…
#> $ area    <chr> "ESP", "ESP", "ESP", "ESP", "ESP", "ESP", "ESP", "ESP", …
#> $ grado   <dbl> 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3,…
#> $ puntaje <dbl> 349, 636, 498, 538, 434, 565, 470, 553, 506, 644, 511, 5…
```
