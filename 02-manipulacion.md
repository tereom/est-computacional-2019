...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "27", "21", "08", "25", "08", "18", "10", "07", "30",…
#> $ NOM_ENT    <chr> "TABASCO", "PUEBLA", "CHIHUAHUA", "SINALOA", "CHIHUAH…
#> $ CCT        <chr> "27DPR1959A", "21DPR3512D", "08EPR0335A", "25DPR1938Q…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "VESPERTINO", "MA…
#> $ ESCUELA    <chr> "CUAUHTEMOC", "JUAN ESCUTIA", "FAMILIA STEGE 2532", "…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL"…
#> $ CVE_MUN    <chr> "004", "074", "045", "006", "067", "015", "023", "103…
#> $ NOM_MUN    <chr> "CENTRO", "HUEJOTZINGO", "MEOQUI", "CULIACAN", "VALLE…
#> $ CVE_LOC    <chr> "0312", "0029", "0001", "0001", "0043", "0069", "0077…
#> $ NOM_LOC    <chr> "TIERRA AMARILLA 3RA. SECCION", "SANTA ANA XALMIMILUL…
#> $ PUNT_ESP_3 <dbl> 452, 549, 523, 524, 548, 542, 439, 531, 613, 553, 399…
#> $ PUNT_MAT_3 <dbl> 499, 609, 556, 609, 528, 614, 469, 627, 757, 594, 419…
#> $ PUNT_FCE_3 <dbl> 430, 564, 450, 447, 486, 481, 424, 529, 631, 507, 402…
#> $ PUNT_ESP_4 <dbl> 466, 602, 566, 472, 549, 542, 469, 539, 606, 584, 373…
#> $ PUNT_MAT_4 <dbl> 455, 607, 604, 537, 551, 631, 484, 615, 720, 585, 444…
#> $ PUNT_FCE_4 <dbl> 439, 533, 473, 440, 545, 468, 437, 519, 590, 512, 376…
#> $ PUNT_ESP_5 <dbl> 495, 595, 474, 571, 424, 455, 583, 417, 586, 566, 413…
#> $ PUNT_MAT_5 <dbl> 528, 674, 532, 603, 413, 497, 588, 441, 635, 597, 400…
#> $ PUNT_FCE_5 <dbl> 452, 576, 456, 508, 511, 443, 464, 400, 549, 507, 427…
#> $ PUNT_ESP_6 <dbl> 431, 587, 505, 516, NA, 508, 484, 567, 410, 525, 357,…
#> $ PUNT_MAT_6 <dbl> 472, 611, 614, 565, NA, 611, 604, 612, 452, 590, 389,…
#> $ PUNT_FCE_6 <dbl> 411, 512, 455, 493, NA, 465, 499, 567, 461, 498, 400,…
```
...
#>  1 27      TABASCO 27DP… MATU… CUAUHT… GENE… 004     CENTRO  0312   
#>  2 27      TABASCO 27DP… MATU… CUAUHT… GENE… 004     CENTRO  0312   
#>  3 27      TABASCO 27DP… MATU… CUAUHT… GENE… 004     CENTRO  0312   
#>  4 27      TABASCO 27DP… MATU… CUAUHT… GENE… 004     CENTRO  0312   
#>  5 27      TABASCO 27DP… MATU… CUAUHT… GENE… 004     CENTRO  0312   
#>  6 27      TABASCO 27DP… MATU… CUAUHT… GENE… 004     CENTRO  0312   
#>  7 27      TABASCO 27DP… MATU… CUAUHT… GENE… 004     CENTRO  0312   
#>  8 27      TABASCO 27DP… MATU… CUAUHT… GENE… 004     CENTRO  0312   
#>  9 27      TABASCO 27DP… MATU… CUAUHT… GENE… 004     CENTRO  0312   
#> 10 27      TABASCO 27DP… MATU… CUAUHT… GENE… 004     CENTRO  0312   
...
#> $ CCT     <chr> "27DPR1959A", "27DPR1959A", "27DPR1959A", "27DPR1959A", …
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA <chr> "CUAUHTEMOC", "CUAUHTEMOC", "CUAUHTEMOC", "CUAUHTEMOC", …
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "…
#> $ CVE_MUN <chr> "004", "004", "004", "004", "004", "004", "004", "004", …
#> $ NOM_MUN <chr> "CENTRO", "CENTRO", "CENTRO", "CENTRO", "CENTRO", "CENTR…
#> $ CVE_LOC <chr> "0312", "0312", "0312", "0312", "0312", "0312", "0312", …
#> $ NOM_LOC <chr> "TIERRA AMARILLA 3RA. SECCION", "TIERRA AMARILLA 3RA. SE…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", …
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5,…
#> $ PUNTAJE <dbl> 452, 499, 430, 466, 455, 439, 495, 528, 452, 431, 472, 4…
```
...
#> $ CVE_LOC    <chr> "0312", "0312", "0312", "0312", "0312", "0312", "0312…
#> $ NOM_LOC    <chr> "TIERRA AMARILLA 3RA. SECCION", "TIERRA AMARILLA 3RA.…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4",…
#> $ PUNTAJE    <dbl> 452, 499, 430, 466, 455, 439, 495, 528, 452, 431, 472…
```
