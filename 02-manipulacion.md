...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "08", "15", "13", "08", "12", "10", "24", "15", "07",…
#> $ NOM_ENT    <chr> "CHIHUAHUA", "MEXICO", "HIDALGO", "CHIHUAHUA", "GUERR…
#> $ CCT        <chr> "08DPR0428R", "15PPR3733I", "13DPR1439P", "08EPR0275C…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "VESP…
#> $ ESCUELA    <chr> "EFREN C GONZALEZ", "INSTITUTO LEONARDO DA VINCI", "3…
#> $ TIPO       <chr> "GENERAL", "PARTICULAR", "GENERAL", "GENERAL", "GENER…
#> $ CVE_MUN    <chr> "050", "109", "050", "037", "023", "014", "027", "074…
#> $ NOM_MUN    <chr> "NUEVO CASAS GRANDES", "TULTITLAN", "PROGRESO DE OBRE…
#> $ CVE_LOC    <chr> "0001", "0001", "0010", "0001", "0026", "0004", "0026…
#> $ NOM_LOC    <chr> "NUEVO CASAS GRANDES", "TULTITLAN DE MARIANO ESCOBEDO…
#> $ PUNT_ESP_3 <dbl> 568, 621, 557, 508, 547, 482, 560, 631, 516, 541, 499…
#> $ PUNT_MAT_3 <dbl> 634, 657, 493, 517, 613, 528, 579, 733, 457, 553, 502…
#> $ PUNT_FCE_3 <dbl> 525, 555, 448, 449, 565, 460, 419, 604, 425, 469, 449…
#> $ PUNT_ESP_4 <dbl> 579, 650, 525, 509, 483, 455, NA, 574, 423, 599, 473,…
#> $ PUNT_MAT_4 <dbl> 639, 655, 448, 519, 580, 476, NA, 645, 544, 633, 490,…
#> $ PUNT_FCE_4 <dbl> 525, 568, 370, 462, 496, 393, NA, 580, 453, 513, 443,…
#> $ PUNT_ESP_5 <dbl> 588, 635, 455, 524, 537, 552, NA, 651, NA, 551, 494, …
#> $ PUNT_MAT_5 <dbl> 636, 700, 436, 558, 548, 623, NA, 712, NA, 580, 494, …
#> $ PUNT_FCE_5 <dbl> 530, 579, 402, 478, 458, 455, NA, 601, NA, 518, 463, …
#> $ PUNT_ESP_6 <dbl> 592, 679, 455, 482, 469, 569, NA, 637, 475, 546, 461,…
#> $ PUNT_MAT_6 <dbl> 657, 685, 424, 519, 540, 654, NA, 710, 514, 544, 498,…
#> $ PUNT_FCE_6 <dbl> 523, 592, 471, 460, 443, 507, NA, 575, 451, 511, 440,…
```
...
#>  1 08      CHIHUA… 08DP… MATU… EFREN … GENE… 050     NUEVO … 0001   
#>  2 08      CHIHUA… 08DP… MATU… EFREN … GENE… 050     NUEVO … 0001   
#>  3 08      CHIHUA… 08DP… MATU… EFREN … GENE… 050     NUEVO … 0001   
#>  4 08      CHIHUA… 08DP… MATU… EFREN … GENE… 050     NUEVO … 0001   
#>  5 08      CHIHUA… 08DP… MATU… EFREN … GENE… 050     NUEVO … 0001   
#>  6 08      CHIHUA… 08DP… MATU… EFREN … GENE… 050     NUEVO … 0001   
#>  7 08      CHIHUA… 08DP… MATU… EFREN … GENE… 050     NUEVO … 0001   
#>  8 08      CHIHUA… 08DP… MATU… EFREN … GENE… 050     NUEVO … 0001   
#>  9 08      CHIHUA… 08DP… MATU… EFREN … GENE… 050     NUEVO … 0001   
#> 10 08      CHIHUA… 08DP… MATU… EFREN … GENE… 050     NUEVO … 0001   
...
#> Observations: 12,000
#> Variables: 13
#> $ CVE_ENT <chr> "08", "08", "08", "08", "08", "08", "08", "08", "08", "0…
#> $ NOM_ENT <chr> "CHIHUAHUA", "CHIHUAHUA", "CHIHUAHUA", "CHIHUAHUA", "CHI…
#> $ CCT     <chr> "08DPR0428R", "08DPR0428R", "08DPR0428R", "08DPR0428R", …
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA <chr> "EFREN C GONZALEZ", "EFREN C GONZALEZ", "EFREN C GONZALE…
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "…
#> $ CVE_MUN <chr> "050", "050", "050", "050", "050", "050", "050", "050", …
#> $ NOM_MUN <chr> "NUEVO CASAS GRANDES", "NUEVO CASAS GRANDES", "NUEVO CAS…
#> $ CVE_LOC <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001", …
#> $ NOM_LOC <chr> "NUEVO CASAS GRANDES", "NUEVO CASAS GRANDES", "NUEVO CAS…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", …
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5,…
#> $ PUNTAJE <dbl> 568, 634, 525, 579, 639, 525, 588, 636, 530, 592, 657, 5…
```
...
#> Observations: 12,000
#> Variables: 12
#> $ CVE_ENT    <chr> "08", "08", "08", "08", "08", "08", "08", "08", "08",…
#> $ NOM_ENT    <chr> "CHIHUAHUA", "CHIHUAHUA", "CHIHUAHUA", "CHIHUAHUA", "…
#> $ CCT        <chr> "08DPR0428R", "08DPR0428R", "08DPR0428R", "08DPR0428R…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "EFREN C GONZALEZ", "EFREN C GONZALEZ", "EFREN C GONZ…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL"…
#> $ CVE_MUN    <chr> "050", "050", "050", "050", "050", "050", "050", "050…
#> $ NOM_MUN    <chr> "NUEVO CASAS GRANDES", "NUEVO CASAS GRANDES", "NUEVO …
#> $ CVE_LOC    <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001…
#> $ NOM_LOC    <chr> "NUEVO CASAS GRANDES", "NUEVO CASAS GRANDES", "NUEVO …
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4",…
#> $ PUNTAJE    <dbl> 568, 634, 525, 579, 639, 525, 588, 636, 530, 592, 657…
```
