...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "09", "14", "14", "15", "08", "15", "30", "07", "27", "15"…
#> $ NOM_ENT    <chr> "DISTRITO FEDERAL", "JALISCO", "JALISCO", "MEXICO", "CHIHU…
#> $ CCT        <chr> "09DBN0119M", "14DPR1661O", "14EPR1409T", "15EPR4970L", "0…
#> $ TURNO      <chr> "NOCTURNO", "MATUTINO", "MATUTINO", "VESPERTINO", "MATUTIN…
#> $ ESCUELA    <chr> "MTRO. LUIS CHAVEZ OROZCO", "REPUBLICA MEXICANA", "JOSE VA…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "PARTICULAR", …
#> $ CVE_MUN    <chr> "006", "120", "101", "033", "043", "054", "191", "017", "0…
#> $ NOM_MUN    <chr> "IZTACALCO", "ZAPOPAN", "TONALA", "ECATEPEC DE MORELOS", "…
#> $ CVE_LOC    <chr> "0060", "0001", "0189", "0001", "0001", "0001", "0010", "0…
#> $ NOM_LOC    <chr> "GABRIEL RAMOS MILLAN", "ZAPOPAN", "PASEO DE LAS CA\u0084A…
#> $ PUNT_ESP_3 <dbl> 685, 568, 519, 573, 477, 577, 630, 429, 570, 543, 513, 524…
#> $ PUNT_MAT_3 <dbl> 791, 603, 546, 615, 502, 609, 638, 413, 618, 580, 569, 627…
#> $ PUNT_FCE_3 <dbl> 649, 532, 457, 563, 401, 532, 561, 347, 476, 510, 449, 458…
#> $ PUNT_ESP_4 <dbl> 694, 552, 525, 603, 466, 563, 412, 403, 452, 510, 573, 398…
#> $ PUNT_MAT_4 <dbl> 738, 575, 524, 581, 471, 584, 411, 425, 516, 500, 572, 515…
#> $ PUNT_FCE_4 <dbl> 692, 506, 478, 529, 446, 499, 358, 357, 385, 450, 519, 542…
#> $ PUNT_ESP_5 <dbl> 596, 509, 483, 541, 562, 568, 389, 436, 509, 572, 581, 389…
#> $ PUNT_MAT_5 <dbl> 663, 526, 486, 539, 551, 561, 356, 425, 581, 580, 631, 357…
#> $ PUNT_FCE_5 <dbl> 524, 467, 469, 487, 530, 519, 384, 387, 446, 492, 498, 361…
#> $ PUNT_ESP_6 <dbl> 554, 617, 512, 498, 410, 526, 517, 406, 514, 564, 552, 356…
#> $ PUNT_MAT_6 <dbl> 610, 608, 557, 520, 450, 550, 454, 509, 674, 593, 627, 347…
#> $ PUNT_FCE_6 <dbl> 536, 572, 518, 471, 374, 480, 474, 443, 501, 502, 583, 338…
```
...
#>  1 09      DISTRI… 09DB… NOCT… MTRO. … GENE… 006     IZTACA… 0060    GABRIE…
#>  2 09      DISTRI… 09DB… NOCT… MTRO. … GENE… 006     IZTACA… 0060    GABRIE…
#>  3 09      DISTRI… 09DB… NOCT… MTRO. … GENE… 006     IZTACA… 0060    GABRIE…
#>  4 09      DISTRI… 09DB… NOCT… MTRO. … GENE… 006     IZTACA… 0060    GABRIE…
#>  5 09      DISTRI… 09DB… NOCT… MTRO. … GENE… 006     IZTACA… 0060    GABRIE…
#>  6 09      DISTRI… 09DB… NOCT… MTRO. … GENE… 006     IZTACA… 0060    GABRIE…
#>  7 09      DISTRI… 09DB… NOCT… MTRO. … GENE… 006     IZTACA… 0060    GABRIE…
#>  8 09      DISTRI… 09DB… NOCT… MTRO. … GENE… 006     IZTACA… 0060    GABRIE…
#>  9 09      DISTRI… 09DB… NOCT… MTRO. … GENE… 006     IZTACA… 0060    GABRIE…
#> 10 09      DISTRI… 09DB… NOCT… MTRO. … GENE… 006     IZTACA… 0060    GABRIE…
...
#> $ NOM_ENT <chr> "DISTRITO FEDERAL", "DISTRITO FEDERAL", "DISTRITO FEDERAL", "…
#> $ CCT     <chr> "09DBN0119M", "09DBN0119M", "09DBN0119M", "09DBN0119M", "09DB…
#> $ TURNO   <chr> "NOCTURNO", "NOCTURNO", "NOCTURNO", "NOCTURNO", "NOCTURNO", "…
#> $ ESCUELA <chr> "MTRO. LUIS CHAVEZ OROZCO", "MTRO. LUIS CHAVEZ OROZCO", "MTRO…
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENER…
#> $ CVE_MUN <chr> "006", "006", "006", "006", "006", "006", "006", "006", "006"…
#> $ NOM_MUN <chr> "IZTACALCO", "IZTACALCO", "IZTACALCO", "IZTACALCO", "IZTACALC…
#> $ CVE_LOC <chr> "0060", "0060", "0060", "0060", "0060", "0060", "0060", "0060…
#> $ NOM_LOC <chr> "GABRIEL RAMOS MILLAN", "GABRIEL RAMOS MILLAN", "GABRIEL RAMO…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", "FCE"…
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5, 5, 5…
#> $ PUNTAJE <dbl> 685, 791, 649, 694, 738, 692, 596, 663, 524, 554, 610, 536, 5…
```
...
#> $ CVE_ENT    <chr> "09", "09", "09", "09", "09", "09", "09", "09", "09", "09"…
#> $ NOM_ENT    <chr> "DISTRITO FEDERAL", "DISTRITO FEDERAL", "DISTRITO FEDERAL"…
#> $ CCT        <chr> "09DBN0119M", "09DBN0119M", "09DBN0119M", "09DBN0119M", "0…
#> $ TURNO      <chr> "NOCTURNO", "NOCTURNO", "NOCTURNO", "NOCTURNO", "NOCTURNO"…
#> $ ESCUELA    <chr> "MTRO. LUIS CHAVEZ OROZCO", "MTRO. LUIS CHAVEZ OROZCO", "M…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GE…
#> $ CVE_MUN    <chr> "006", "006", "006", "006", "006", "006", "006", "006", "0…
#> $ NOM_MUN    <chr> "IZTACALCO", "IZTACALCO", "IZTACALCO", "IZTACALCO", "IZTAC…
#> $ CVE_LOC    <chr> "0060", "0060", "0060", "0060", "0060", "0060", "0060", "0…
#> $ NOM_LOC    <chr> "GABRIEL RAMOS MILLAN", "GABRIEL RAMOS MILLAN", "GABRIEL R…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4", "ESP…
#> $ PUNTAJE    <dbl> 685, 791, 649, 694, 738, 692, 596, 663, 524, 554, 610, 536…
```
