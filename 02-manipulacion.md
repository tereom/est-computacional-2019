...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "08", "25", "30", "18", "10", "10", "14", "07", "15", "15"…
#> $ NOM_ENT    <chr> "CHIHUAHUA", "SINALOA", "VERACRUZ", "NAYARIT", "DURANGO", …
#> $ CCT        <chr> "08KPR2060A", "25DPR1097O", "30DPB0019O", "18DPR0380V", "1…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO"…
#> $ ESCUELA    <chr> "AGUA CALIENTE DE ARISIACHI", "DOMINGO COLON", "IGNACIO ZA…
#> $ TIPO       <chr> "CONAFE", "GENERAL", "INDêGENA", "GENERAL", "CONAFE", "GEN…
#> $ CVE_MUN    <chr> "031", "003", "058", "016", "014", "012", "042", "107", "1…
#> $ NOM_MUN    <chr> "GUERRERO", "BADIRAGUATO", "CHICONTEPEC", "TECUALA", "MEZQ…
#> $ CVE_LOC    <chr> "0006", "0281", "0103", "0046", "0009", "0034", "0026", "0…
#> $ NOM_LOC    <chr> "AGUA CALIENTE DE ARISIACHI", "SOYATITA", "TEPENAHUAC", "S…
#> $ PUNT_ESP_3 <dbl> NA, 527, 537, 496, 471, 469, 690, NA, 680, 496, 614, 706, …
#> $ PUNT_MAT_3 <dbl> NA, 512, 445, 518, 440, 497, 825, NA, 649, 570, 653, 786, …
#> $ PUNT_FCE_3 <dbl> NA, 470, 385, 437, 433, 388, 603, NA, 548, 453, 580, 618, …
#> $ PUNT_ESP_4 <dbl> NA, 449, 324, 459, 482, 452, 684, NA, NA, 470, 516, 669, 4…
#> $ PUNT_MAT_4 <dbl> NA, 498, 408, 509, 639, 460, 725, NA, NA, 508, 567, 720, 3…
#> $ PUNT_FCE_4 <dbl> NA, 416, 363, 516, 493, 435, 602, NA, NA, 427, 474, 579, 3…
#> $ PUNT_ESP_5 <dbl> 445, 518, NA, 514, NA, 396, 583, 440, NA, 559, 593, 640, 3…
#> $ PUNT_MAT_5 <dbl> 544, 518, NA, 546, NA, 404, 645, 552, NA, 581, 651, 730, 3…
#> $ PUNT_FCE_5 <dbl> 470, 460, NA, 502, NA, 391, 496, 509, NA, 507, 559, 588, 3…
#> $ PUNT_ESP_6 <dbl> 537, 504, NA, 479, NA, 463, NA, NA, NA, 522, 614, 650, 432…
#> $ PUNT_MAT_6 <dbl> 554, 501, NA, 488, NA, 526, NA, NA, NA, 567, 740, 685, 476…
#> $ PUNT_FCE_6 <dbl> 608, 489, NA, 414, NA, 461, NA, NA, NA, 482, 599, 502, 497…
```
...
#>  1 08      CHIHUA… 08KP… MATU… AGUA C… CONA… 031     GUERRE… 0006    AGUA C…
#>  2 08      CHIHUA… 08KP… MATU… AGUA C… CONA… 031     GUERRE… 0006    AGUA C…
#>  3 08      CHIHUA… 08KP… MATU… AGUA C… CONA… 031     GUERRE… 0006    AGUA C…
#>  4 08      CHIHUA… 08KP… MATU… AGUA C… CONA… 031     GUERRE… 0006    AGUA C…
#>  5 08      CHIHUA… 08KP… MATU… AGUA C… CONA… 031     GUERRE… 0006    AGUA C…
#>  6 08      CHIHUA… 08KP… MATU… AGUA C… CONA… 031     GUERRE… 0006    AGUA C…
#>  7 08      CHIHUA… 08KP… MATU… AGUA C… CONA… 031     GUERRE… 0006    AGUA C…
#>  8 08      CHIHUA… 08KP… MATU… AGUA C… CONA… 031     GUERRE… 0006    AGUA C…
#>  9 08      CHIHUA… 08KP… MATU… AGUA C… CONA… 031     GUERRE… 0006    AGUA C…
#> 10 08      CHIHUA… 08KP… MATU… AGUA C… CONA… 031     GUERRE… 0006    AGUA C…
...
#> Observations: 12,000
#> Variables: 13
#> $ CVE_ENT <chr> "08", "08", "08", "08", "08", "08", "08", "08", "08", "08", "…
#> $ NOM_ENT <chr> "CHIHUAHUA", "CHIHUAHUA", "CHIHUAHUA", "CHIHUAHUA", "CHIHUAHU…
#> $ CCT     <chr> "08KPR2060A", "08KPR2060A", "08KPR2060A", "08KPR2060A", "08KP…
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "…
#> $ ESCUELA <chr> "AGUA CALIENTE DE ARISIACHI", "AGUA CALIENTE DE ARISIACHI", "…
#> $ TIPO    <chr> "CONAFE", "CONAFE", "CONAFE", "CONAFE", "CONAFE", "CONAFE", "…
#> $ CVE_MUN <chr> "031", "031", "031", "031", "031", "031", "031", "031", "031"…
#> $ NOM_MUN <chr> "GUERRERO", "GUERRERO", "GUERRERO", "GUERRERO", "GUERRERO", "…
#> $ CVE_LOC <chr> "0006", "0006", "0006", "0006", "0006", "0006", "0006", "0006…
#> $ NOM_LOC <chr> "AGUA CALIENTE DE ARISIACHI", "AGUA CALIENTE DE ARISIACHI", "…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", "FCE"…
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5, 5, 5…
#> $ PUNTAJE <dbl> NA, NA, NA, NA, NA, NA, 445, 544, 470, 537, 554, 608, 527, 51…
```
...
#> Variables: 12
#> $ CVE_ENT    <chr> "08", "08", "08", "08", "08", "08", "08", "08", "08", "08"…
#> $ NOM_ENT    <chr> "CHIHUAHUA", "CHIHUAHUA", "CHIHUAHUA", "CHIHUAHUA", "CHIHU…
#> $ CCT        <chr> "08KPR2060A", "08KPR2060A", "08KPR2060A", "08KPR2060A", "0…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO"…
#> $ ESCUELA    <chr> "AGUA CALIENTE DE ARISIACHI", "AGUA CALIENTE DE ARISIACHI"…
#> $ TIPO       <chr> "CONAFE", "CONAFE", "CONAFE", "CONAFE", "CONAFE", "CONAFE"…
#> $ CVE_MUN    <chr> "031", "031", "031", "031", "031", "031", "031", "031", "0…
#> $ NOM_MUN    <chr> "GUERRERO", "GUERRERO", "GUERRERO", "GUERRERO", "GUERRERO"…
#> $ CVE_LOC    <chr> "0006", "0006", "0006", "0006", "0006", "0006", "0006", "0…
#> $ NOM_LOC    <chr> "AGUA CALIENTE DE ARISIACHI", "AGUA CALIENTE DE ARISIACHI"…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4", "ESP…
#> $ PUNTAJE    <dbl> NA, NA, NA, NA, NA, NA, 445, 544, 470, 537, 554, 608, 527,…
```
