...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "01", "23", "07", "16", "10", "15", "15", "13", "02",…
#> $ NOM_ENT    <chr> "AGUASCALIENTES", "QUINTANA ROO", "CHIAPAS", "MICHOAC…
#> $ CCT        <chr> "01DPR0118U", "23PPR0062Z", "07DPR2334R", "16DPR0727Y…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "VESPERTINO", "MATUTINO", "MA…
#> $ ESCUELA    <chr> "EMILIANO ZAPATA", "BOSTON", "JOSE MARTI", "CUAUHTEMO…
#> $ TIPO       <chr> "GENERAL", "PARTICULAR", "GENERAL", "GENERAL", "GENER…
#> $ CVE_MUN    <chr> "001", "005", "059", "044", "005", "033", "053", "062…
#> $ NOM_MUN    <chr> "AGUASCALIENTES", "BENITO JUAREZ", "OCOSINGO", "JIMEN…
#> $ CVE_LOC    <chr> "0001", "0001", "0001", "0014", "0168", "0001", "0001…
#> $ NOM_LOC    <chr> "AGUASCALIENTES", "CANCUN", "OCOSINGO", "EL RANCHITO"…
#> $ PUNT_ESP_3 <dbl> 502, 545, 434, 728, 459, 496, 614, 486, 499, 588, 535…
#> $ PUNT_MAT_3 <dbl> 526, 562, 423, 742, 489, 497, 672, 569, 683, 591, 607…
#> $ PUNT_FCE_3 <dbl> 449, 505, 380, 644, 402, 440, 558, 411, 415, 487, 470…
#> $ PUNT_ESP_4 <dbl> 508, 589, 571, NA, 491, 462, 535, 653, 593, 533, 490,…
#> $ PUNT_MAT_4 <dbl> 532, 607, 638, NA, 539, 506, 573, 694, 701, 602, 513,…
#> $ PUNT_FCE_4 <dbl> 438, 520, 563, NA, 421, 440, 485, 541, 450, 514, 490,…
#> $ PUNT_ESP_5 <dbl> 476, 623, NA, NA, 404, 587, 518, 425, 516, 527, 527, …
#> $ PUNT_MAT_5 <dbl> 525, 652, NA, NA, 428, 616, 569, 411, 584, 645, 603, …
#> $ PUNT_FCE_5 <dbl> 444, 585, NA, NA, 414, 537, 475, 416, 569, 519, 509, …
#> $ PUNT_ESP_6 <dbl> 516, 632, 462, NA, 437, 508, 601, 448, 431, 584, 506,…
#> $ PUNT_MAT_6 <dbl> 557, 649, 502, NA, 472, 518, 668, 489, 586, 567, 614,…
#> $ PUNT_FCE_6 <dbl> 445, 573, 422, NA, 420, 471, 533, 416, 479, 476, 520,…
```
...
#>  1 01      AGUASC… 01DP… MATU… EMILIA… GENE… 001     AGUASC… 0001   
#>  2 01      AGUASC… 01DP… MATU… EMILIA… GENE… 001     AGUASC… 0001   
#>  3 01      AGUASC… 01DP… MATU… EMILIA… GENE… 001     AGUASC… 0001   
#>  4 01      AGUASC… 01DP… MATU… EMILIA… GENE… 001     AGUASC… 0001   
#>  5 01      AGUASC… 01DP… MATU… EMILIA… GENE… 001     AGUASC… 0001   
#>  6 01      AGUASC… 01DP… MATU… EMILIA… GENE… 001     AGUASC… 0001   
#>  7 01      AGUASC… 01DP… MATU… EMILIA… GENE… 001     AGUASC… 0001   
#>  8 01      AGUASC… 01DP… MATU… EMILIA… GENE… 001     AGUASC… 0001   
#>  9 01      AGUASC… 01DP… MATU… EMILIA… GENE… 001     AGUASC… 0001   
#> 10 01      AGUASC… 01DP… MATU… EMILIA… GENE… 001     AGUASC… 0001   
...
#> $ NOM_ENT <chr> "AGUASCALIENTES", "AGUASCALIENTES", "AGUASCALIENTES", "A…
#> $ CCT     <chr> "01DPR0118U", "01DPR0118U", "01DPR0118U", "01DPR0118U", …
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA <chr> "EMILIANO ZAPATA", "EMILIANO ZAPATA", "EMILIANO ZAPATA",…
#> $ TIPO    <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "…
#> $ CVE_MUN <chr> "001", "001", "001", "001", "001", "001", "001", "001", …
#> $ NOM_MUN <chr> "AGUASCALIENTES", "AGUASCALIENTES", "AGUASCALIENTES", "A…
#> $ CVE_LOC <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001", …
#> $ NOM_LOC <chr> "AGUASCALIENTES", "AGUASCALIENTES", "AGUASCALIENTES", "A…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", …
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5,…
#> $ PUNTAJE <dbl> 502, 526, 449, 508, 532, 438, 476, 525, 444, 516, 557, 4…
```
...
#> $ NOM_ENT    <chr> "AGUASCALIENTES", "AGUASCALIENTES", "AGUASCALIENTES",…
#> $ CCT        <chr> "01DPR0118U", "01DPR0118U", "01DPR0118U", "01DPR0118U…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "EMILIANO ZAPATA", "EMILIANO ZAPATA", "EMILIANO ZAPAT…
#> $ TIPO       <chr> "GENERAL", "GENERAL", "GENERAL", "GENERAL", "GENERAL"…
#> $ CVE_MUN    <chr> "001", "001", "001", "001", "001", "001", "001", "001…
#> $ NOM_MUN    <chr> "AGUASCALIENTES", "AGUASCALIENTES", "AGUASCALIENTES",…
#> $ CVE_LOC    <chr> "0001", "0001", "0001", "0001", "0001", "0001", "0001…
#> $ NOM_LOC    <chr> "AGUASCALIENTES", "AGUASCALIENTES", "AGUASCALIENTES",…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4",…
#> $ PUNTAJE    <dbl> 502, 526, 449, 508, 532, 438, 476, 525, 444, 516, 557…
```
