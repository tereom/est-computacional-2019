...
<img src="02-manipulacion_files/figure-html/unnamed-chunk-42-1.png" width="672" style="display: block; margin: auto;" />
...
<img src="02-manipulacion_files/figure-html/unnamed-chunk-43-1.png" width="45%" style="display: block; margin: auto;" /><img src="02-manipulacion_files/figure-html/unnamed-chunk-43-2.png" width="45%" style="display: block; margin: auto;" />
...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "14", "32", "01", "13", "10", "05", "14", "09", "30",…
#> $ NOM_ENT    <chr> "JALISCO", "ZACATECAS", "AGUASCALIENTES", "HIDALGO", …
#> $ CCT        <chr> "14KPR0196L", "32DPR0738V", "01DPR0395X", "13DPR1906T…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "AQUILES SERDAN", "LEONA VICARIO", "LAZARO CARDENAS",…
#> $ TIPO       <chr> "CONAFE", "GENERAL", "GENERAL", "GENERAL", "GENERAL",…
#> $ CVE_MUN    <chr> "053", "010", "011", "030", "020", "036", "019", "007…
#> $ NOM_MUN    <chr> "LAGOS DE MORENO", "FRESNILLO", "EL LLANO", "IXMIQUIL…
#> $ CVE_LOC    <chr> "0177", "0185", "0001", "0001", "0020", "0079", "0193…
#> $ NOM_LOC    <chr> "PORTEZUELOS DE GONZALEZ (EL ZAPOTE)", "REDENCION", "…
#> $ PUNT_ESP_3 <dbl> 490, 466, 505, 531, 520, 539, 401, 488, 624, 527, 635…
#> $ PUNT_MAT_3 <dbl> 569, 545, 530, 573, 569, 489, 447, 507, 750, 547, 800…
#> $ PUNT_FCE_3 <dbl> 515, 407, 443, 480, 473, 487, 417, 462, 615, 466, 578…
#> $ PUNT_ESP_4 <dbl> 390, 455, 500, 587, 522, 491, 379, 538, 537, 573, 392…
#> $ PUNT_MAT_4 <dbl> 508, 452, 540, 620, 520, 613, 463, 589, 562, 593, 525…
#> $ PUNT_FCE_4 <dbl> 432, 460, 458, 509, 487, 462, 425, 480, 518, 507, 413…
#> $ PUNT_ESP_5 <dbl> 335, 430, 480, 512, 496, 512, 360, 528, 446, 497, NA,…
#> $ PUNT_MAT_5 <dbl> 285, 470, 514, 524, 500, 516, 422, 562, 478, 536, NA,…
#> $ PUNT_FCE_5 <dbl> 384, 432, 466, 432, 461, 327, 346, 498, 421, 477, NA,…
#> $ PUNT_ESP_6 <dbl> 481, 486, 514, 532, 499, 437, NA, 577, 499, 464, 524,…
#> $ PUNT_MAT_6 <dbl> 507, 524, 560, 595, 549, 503, NA, 611, 580, 519, 644,…
#> $ PUNT_FCE_6 <dbl> 471, 472, 476, 525, 455, 435, NA, 505, 518, 444, 420,…
```
...
enlacep_tidy
#> # A tibble: 11,250 x 13
#>    CVE_ENT NOM_ENT CCT   TURNO ESCUELA TIPO  CVE_MUN NOM_MUN CVE_LOC
#>    <chr>   <chr>   <chr> <chr> <chr>   <chr> <chr>   <chr>   <chr>  
#>  1 14      JALISCO 14KP… MATU… AQUILE… CONA… 053     LAGOS … 0177   
#>  2 32      ZACATE… 32DP… MATU… LEONA … GENE… 010     FRESNI… 0185   
#>  3 01      AGUASC… 01DP… MATU… LAZARO… GENE… 011     EL LLA… 0001   
#>  4 13      HIDALGO 13DP… MATU… LIC. L… GENE… 030     IXMIQU… 0001   
#>  5 10      DURANGO 10DP… MATU… GUILLE… GENE… 020     PANUCO… 0020   
#>  6 05      COAHUI… 05DP… MATU… RICARD… GENE… 036     VIESCA  0079   
#>  7 14      JALISCO 14DP… MATU… NOMBRE… INDê… 019     "BOLA\… 0193   
#>  8 09      DISTRI… 09DP… VESP… MIGUEL… GENE… 007     IZTAPA… 0402   
#>  9 30      VERACR… 30DP… MATU… 12 DE … GENE… 173     TEZONA… 0063   
#> 10 15      MEXICO  15DP… VESP… JUSTO … GENE… 011     ATENCO  0004   
#> # … with 11,240 more rows, and 4 more variables: NOM_LOC <chr>,
...
#> Observations: 11,250
#> Variables: 13
#> $ cve_ent <chr> "14", "32", "01", "13", "10", "05", "14", "09", "30", "1…
#> $ nom_ent <chr> "JALISCO", "ZACATECAS", "AGUASCALIENTES", "HIDALGO", "DU…
#> $ cct     <chr> "14KPR0196L", "32DPR0738V", "01DPR0395X", "13DPR1906T", …
#> $ turno   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ escuela <chr> "AQUILES SERDAN", "LEONA VICARIO", "LAZARO CARDENAS", "L…
#> $ tipo    <chr> "CONAFE", "GENERAL", "GENERAL", "GENERAL", "GENERAL", "G…
#> $ cve_mun <chr> "053", "010", "011", "030", "020", "036", "019", "007", …
#> $ nom_mun <chr> "LAGOS DE MORENO", "FRESNILLO", "EL LLANO", "IXMIQUILPAN…
#> $ cve_loc <chr> "0177", "0185", "0001", "0001", "0020", "0079", "0193", …
#> $ nom_loc <chr> "PORTEZUELOS DE GONZALEZ (EL ZAPOTE)", "REDENCION", "LLA…
#> $ area    <chr> "ESP", "ESP", "ESP", "ESP", "ESP", "ESP", "ESP", "ESP", …
#> $ grado   <dbl> 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3, 3,…
#> $ puntaje <dbl> 490, 466, 505, 531, 520, 539, 401, 488, 624, 527, 635, 4…
```
