...
#> Observations: 1,000
#> Variables: 22
#> $ CVE_ENT    <chr> "18", "14", "16", "29", "08", "11", "07", "07", "12",…
#> $ NOM_ENT    <chr> "NAYARIT", "JALISCO", "MICHOACAN", "TLAXCALA", "CHIHU…
#> $ CCT        <chr> "18KPR0111K", "14DPR2709Y", "16DPR4923A", "29DPR0391G…
#> $ TURNO      <chr> "MATUTINO", "VESPERTINO", "MATUTINO", "MATUTINO", "MA…
#> $ ESCUELA    <chr> "SALTO DEL COLORADO", "AMADO NERVO", "NI\u0084OS HERO…
#> $ TIPO       <chr> "CONAFE", "GENERAL", "GENERAL", "GENERAL", "GENERAL",…
#> $ CVE_MUN    <chr> "005", "012", "073", "041", "009", "007", "089", "027…
#> $ NOM_MUN    <chr> "HUAJICORI", "ATENGUILLO", "QUIROGA", "PAPALOTLA DE X…
#> $ CVE_LOC    <chr> "0157", "0061", "0001", "0001", "9995", "0001", "0589…
#> $ NOM_LOC    <chr> "SALTO DEL COLORADO", "SAN JOSE DE LOS ANDRADE", "QUI…
#> $ PUNT_ESP_3 <dbl> NA, 659, 637, 632, 639, 636, 454, NA, 453, 526, 496, …
#> $ PUNT_MAT_3 <dbl> NA, 770, 687, 699, 757, 741, 523, NA, 421, 558, 530, …
#> $ PUNT_FCE_3 <dbl> NA, 632, 555, 604, 604, 539, 440, NA, 378, 472, 452, …
#> $ PUNT_ESP_4 <dbl> 743, 668, 489, 570, 648, 513, 419, 373, 482, 643, 532…
#> $ PUNT_MAT_4 <dbl> 745, 826, 469, 629, 747, 518, 513, 395, 499, 673, 540…
#> $ PUNT_FCE_4 <dbl> 679, 619, 419, 524, 615, 424, 440, 374, 457, 585, 481…
#> $ PUNT_ESP_5 <dbl> 659, 561, 478, 674, 567, 680, 451, 375, 424, 669, 521…
#> $ PUNT_MAT_5 <dbl> 638, 736, 518, 704, 670, 630, 439, 375, 421, 671, 527…
#> $ PUNT_FCE_5 <dbl> 498, 628, 429, 610, 552, 514, 463, 402, 386, 575, 492…
#> $ PUNT_ESP_6 <dbl> NA, 565, 451, 500, 496, 440, 432, 400, 466, 595, 519,…
#> $ PUNT_MAT_6 <dbl> NA, 708, 458, 511, 732, 474, 433, 406, 490, 639, 533,…
#> $ PUNT_FCE_6 <dbl> NA, 582, 398, 448, 572, 430, 463, 418, 473, 512, 480,…
```
...
#>  1 18      NAYARIT 18KP… MATU… SALTO … CONA… 005     HUAJIC… 0157   
#>  2 18      NAYARIT 18KP… MATU… SALTO … CONA… 005     HUAJIC… 0157   
#>  3 18      NAYARIT 18KP… MATU… SALTO … CONA… 005     HUAJIC… 0157   
#>  4 18      NAYARIT 18KP… MATU… SALTO … CONA… 005     HUAJIC… 0157   
#>  5 18      NAYARIT 18KP… MATU… SALTO … CONA… 005     HUAJIC… 0157   
#>  6 18      NAYARIT 18KP… MATU… SALTO … CONA… 005     HUAJIC… 0157   
#>  7 18      NAYARIT 18KP… MATU… SALTO … CONA… 005     HUAJIC… 0157   
#>  8 18      NAYARIT 18KP… MATU… SALTO … CONA… 005     HUAJIC… 0157   
#>  9 18      NAYARIT 18KP… MATU… SALTO … CONA… 005     HUAJIC… 0157   
#> 10 18      NAYARIT 18KP… MATU… SALTO … CONA… 005     HUAJIC… 0157   
...
#> Observations: 12,000
#> Variables: 13
#> $ CVE_ENT <chr> "18", "18", "18", "18", "18", "18", "18", "18", "18", "1…
#> $ NOM_ENT <chr> "NAYARIT", "NAYARIT", "NAYARIT", "NAYARIT", "NAYARIT", "…
#> $ CCT     <chr> "18KPR0111K", "18KPR0111K", "18KPR0111K", "18KPR0111K", …
#> $ TURNO   <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATUTIN…
#> $ ESCUELA <chr> "SALTO DEL COLORADO", "SALTO DEL COLORADO", "SALTO DEL C…
#> $ TIPO    <chr> "CONAFE", "CONAFE", "CONAFE", "CONAFE", "CONAFE", "CONAF…
#> $ CVE_MUN <chr> "005", "005", "005", "005", "005", "005", "005", "005", …
#> $ NOM_MUN <chr> "HUAJICORI", "HUAJICORI", "HUAJICORI", "HUAJICORI", "HUA…
#> $ CVE_LOC <chr> "0157", "0157", "0157", "0157", "0157", "0157", "0157", …
#> $ NOM_LOC <chr> "SALTO DEL COLORADO", "SALTO DEL COLORADO", "SALTO DEL C…
#> $ AREA    <chr> "ESP", "MAT", "FCE", "ESP", "MAT", "FCE", "ESP", "MAT", …
#> $ GRADO   <dbl> 3, 3, 3, 4, 4, 4, 5, 5, 5, 6, 6, 6, 3, 3, 3, 4, 4, 4, 5,…
#> $ PUNTAJE <dbl> NA, NA, NA, 743, 745, 679, 659, 638, 498, NA, NA, NA, 65…
```
...
#> Observations: 12,000
#> Variables: 12
#> $ CVE_ENT    <chr> "18", "18", "18", "18", "18", "18", "18", "18", "18",…
#> $ NOM_ENT    <chr> "NAYARIT", "NAYARIT", "NAYARIT", "NAYARIT", "NAYARIT"…
#> $ CCT        <chr> "18KPR0111K", "18KPR0111K", "18KPR0111K", "18KPR0111K…
#> $ TURNO      <chr> "MATUTINO", "MATUTINO", "MATUTINO", "MATUTINO", "MATU…
#> $ ESCUELA    <chr> "SALTO DEL COLORADO", "SALTO DEL COLORADO", "SALTO DE…
#> $ TIPO       <chr> "CONAFE", "CONAFE", "CONAFE", "CONAFE", "CONAFE", "CO…
#> $ CVE_MUN    <chr> "005", "005", "005", "005", "005", "005", "005", "005…
#> $ NOM_MUN    <chr> "HUAJICORI", "HUAJICORI", "HUAJICORI", "HUAJICORI", "…
#> $ CVE_LOC    <chr> "0157", "0157", "0157", "0157", "0157", "0157", "0157…
#> $ NOM_LOC    <chr> "SALTO DEL COLORADO", "SALTO DEL COLORADO", "SALTO DE…
#> $ AREA_GRADO <chr> "ESP_3", "MAT_3", "FCE_3", "ESP_4", "MAT_4", "FCE_4",…
#> $ PUNTAJE    <dbl> NA, NA, NA, 743, 745, 679, 659, 638, 498, NA, NA, NA,…
```
