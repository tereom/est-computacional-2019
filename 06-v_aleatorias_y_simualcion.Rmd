...
![](img/manicule2.jpg)  Utiliza la función runif de R y el método de 
...
![](img/manicule2.jpg) Escribe una función en R que genere simulaciones
...
![](img/manicule2.jpg). Supongamos que queremos simular el valor de una 
...
![](img/manicule2.jpg) Usa el método de aceptación y rechazo para generar 1000 observaciones de una variable aleatoria con distribución gamma(3/2,1).
