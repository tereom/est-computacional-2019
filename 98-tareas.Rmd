...
* Dudas y artículo para pregunta 3 [aquí](https://drive.google.com/drive/folders/1IadZgMhrTAsll8YLLwcnBhk17UcwOdtK?usp=sharing).
  ...
  vector[N] p_bound;
    ...
    for (i in 1:N)
        Xbeta[i] = beta[1] + beta[2]*female[i] + beta[3]*black[i] +
            beta[4]*female[i]*black[i] + b_age[age[i]] + b_edu[edu[i]] +
            b_age_edu[age_edu[i]] + b_state[state[i]];
